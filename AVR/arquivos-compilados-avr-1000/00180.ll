...
while_cond42.preheader:                           ; preds = %body, %while_cond42.preheader
  %l_2.0225.off0 = phi i8 [ %spec.select.i, %while_cond42.preheader ], [ 0, %body ]
  %cmpi.i = icmp slt i8 %l_2.0225.off0, 0
  %binop.i = add i8 %l_2.0225.off0, -5
  %spec.select.i = select i1 %cmpi.i, i8 %l_2.0225.off0, i8 %binop.i
  %cmpi31 = icmp sgt i8 %spec.select.i, -26
  br i1 %cmpi31, label %while_cond42.preheader, label %while_body129

while_body129:                                    ; preds = %while_cond42.preheader
  ret i32 -79
}
...
while_cond42.preheader.i:                         ; preds = %while_cond42.preheader.i, %body
  %l_2.0225.off0.i = phi i8 [ %spec.select.i.i, %while_cond42.preheader.i ], [ 0, %body ]
  %cmpi.i.i = icmp slt i8 %l_2.0225.off0.i, 0
  %binop.i.i = add i8 %l_2.0225.off0.i, -5
  %spec.select.i.i = select i1 %cmpi.i.i, i8 %l_2.0225.off0.i, i8 %binop.i.i
  %cmpi31.i = icmp sgt i8 %spec.select.i.i, -26
  br i1 %cmpi31.i, label %while_cond42.preheader.i, label %func_1.exit

func_1.exit:                                      ; preds = %while_cond42.preheader.i
