; ModuleID = 'out/00935.rob'
source_filename = "out/00935.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 31)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %_this, i8 0, i64 31, i1 false)
  ret void
}
...
define noundef zeroext range(i64 -128, 128) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  br label %while_cond
...
while_cond.i:                                     ; preds = %while_cond.i, %body
  br label %while_cond.i
}
