; ModuleID = 'out/00954.rob'
source_filename = "out/00954.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 5)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i11 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i20 0, ptr %gepf1, align 1
  ret void
}
...
define range(i32 0, 2048) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_2.sroa.0 = alloca ptr, align 1
  store i11 29, ptr %l_2.sroa.0, align 1
  %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref58 = load ptr, ptr %l_2.sroa.0, align 1
  %l_2.f0 = load i11, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref58, align 1
  %zext = zext i11 %l_2.f0 to i32
  ret i32 %zext
}
