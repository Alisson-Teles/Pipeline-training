; ModuleID = 'out/00476.rob'
source_filename = "out/00476.rob"
...
define void @"S3:init"(ptr nocapture writeonly initializes((0, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
define %S3 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret %S3 { i32 59085238, i32 -555607302, i32 -1236280706 }
}
