; ModuleID = 'out/00808.rob'
source_filename = "out/00808.rob"
...
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) %_this, i8 0, i64 9, i1 false)
  ret void
}
...
define range(i32 0, 256) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_4.sroa.0 = alloca { i2, i15 }, align 1
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %l_4.sroa.0, i8 0, i64 3, i1 false)
  %l_4.sroa.0.1.sroa_idx16 = getelementptr inbounds nuw i8, ptr %l_4.sroa.0, i16 1
  store i15 36, ptr %l_4.sroa.0.1.sroa_idx16, align 1
  %l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.deref = load ptr, ptr %l_4.sroa.0, align 1
  %f414 = getelementptr inbounds nuw i8, ptr %l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.deref, i16 8
  %l_4.f4 = load i8, ptr %f414, align 1
  %zext = zext i8 %l_4.f4 to i32
  ret i32 %zext
}
