; ModuleID = 'out/00944.rob'
source_filename = "out/00944.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 14)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  ret %S0 { i32 -1, i64 4654616224706863502, i16 -27829 }
}
