; ModuleID = 'out/00610.rob'
source_filename = "out/00610.rob"
target datalayout = "e-P1-p:16:8-i8:8-i16:8-i32:8-i64:8-f32:8-f64:8-n8-a:8"
target triple = "avr"

%S0 = type { i32, i8, i8, i32, i22, i32 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S0:init"(ptr nocapture writeonly initializes((0, 17)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(17) %_this, i8 0, i64 17, i1 false)
  ret void
}
...
body:
  ret %S0 { i32 0, i8 -1, i8 -87, i32 -1927689951, i22 116, i32 1 }
}
