...
while_body74:                                     ; preds = %body, %while_body74
  %l_8.0886.off0 = phi i8 [ 0, %body ], [ %spec.select.i707, %while_body74 ]
  %cmpi.i705 = icmp sgt i8 %l_8.0886.off0, -1
  %binop.i706 = sext i1 %cmpi.i705 to i8
  %spec.select.i707 = add i8 %l_8.0886.off0, %binop.i706
  %cmpi73.not = icmp eq i8 %spec.select.i707, -2
  br i1 %cmpi73.not, label %while_body88.preheader, label %while_body74

while_body88.preheader:                           ; preds = %while_body74
  ret i16 -7
}
...
while_body74.i:                                   ; preds = %while_body74.i, %body
  %l_8.0886.off0.i = phi i8 [ 0, %body ], [ %spec.select.i707.i, %while_body74.i ]
  %cmpi.i705.i = icmp sgt i8 %l_8.0886.off0.i, -1
  %binop.i706.i = sext i1 %cmpi.i705.i to i8
  %spec.select.i707.i = add i8 %l_8.0886.off0.i, %binop.i706.i
  %cmpi73.not.i = icmp eq i8 %spec.select.i707.i, -2
  br i1 %cmpi73.not.i, label %func_1.exit, label %while_body74.i

func_1.exit:                                      ; preds = %while_body74.i
