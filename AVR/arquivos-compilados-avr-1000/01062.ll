; ModuleID = 'out/01062.rob'
source_filename = "out/01062.rob"
target datalayout = "e-P1-p:16:8-i8:8-i16:8-i32:8-i64:8-f32:8-f64:8-n8-a:8"
target triple = "avr"

%S0 = type { i16, i18, i8, i64, i8, i32, i16, i8, i8, i8 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S0:init"(ptr nocapture writeonly initializes((0, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %_this, i8 0, i64 24, i1 false)
  ret void
}
...
define noundef %S0 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  br label %while_cond33

while_cond33:                                     ; preds = %body, %while_cond33
  br label %while_cond33
}

; Function Attrs: noreturn
define noundef i32 @main() local_unnamed_addr addrspace(1) #4 {
body:
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  br label %while_cond33.i

while_cond33.i:                                   ; preds = %while_cond33.i, %body
  br label %while_cond33.i
}

; Function Attrs: nocallback nofree nounwind willreturn memory(argmem: write)
declare void @llvm.memset.p0.i64(ptr nocapture writeonly, i8, i64, i1 immarg) addrspace(1) #5
...
attributes #3 = { nofree norecurse noreturn nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
attributes #4 = { noreturn "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
