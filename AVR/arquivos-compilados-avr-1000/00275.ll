; ModuleID = 'out/00275.rob'
source_filename = "out/00275.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 19)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(19) %_this, i8 0, i64 19, i1 false)
  ret void
}
...
define zeroext i16 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_25.f4 = load i32, ptr inttoptr (i16 13 to ptr), align 1
  %trunc139 = trunc i32 %l_25.f4 to i16
  ret i16 %trunc139
}
