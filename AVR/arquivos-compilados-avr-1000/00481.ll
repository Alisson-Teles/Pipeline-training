; ModuleID = 'out/00481.rob'
source_filename = "out/00481.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 22)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(22) %_this, i8 0, i64 22, i1 false)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S2:init"(ptr nocapture writeonly initializes((0, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i28 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i19 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 7
  store i25 0, ptr %gepf2, align 1
  ret void
}
...
define noundef zeroext range(i32 -32768, 32768) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i32 -1
}
