; ModuleID = 'out/00627.rob'
source_filename = "out/00627.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 6)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i11 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i27 0, ptr %gepf1, align 1
  ret void
}
...
body:
  %l_17.sroa.0 = alloca ptr, align 1
  store i11 -21, ptr %l_17.sroa.0, align 1
  %l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.deref = load ptr, ptr %l_17.sroa.0, align 1
  %l_17.f0 = load i11, ptr %l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.deref, align 1
  %trunc31 = trunc i11 %l_17.f0 to i8
  ret i8 %trunc31
}
