; ModuleID = 'out/00306.rob'
source_filename = "out/00306.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %_this, i8 0, i64 12, i1 false)
  ret void
}
...
define noundef zeroext range(i64 0, 4294967296) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  br label %while_cond17

while_cond17:                                     ; preds = %body, %while_cond17
  br label %while_cond17
}
...
body:
  ...
  br label %while_cond17.i

while_cond17.i:                                   ; preds = %while_cond17.i, %body
  br label %while_cond17.i
}
