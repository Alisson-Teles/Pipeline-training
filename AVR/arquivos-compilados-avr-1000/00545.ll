; ModuleID = 'out/00545.rob'
source_filename = "out/00545.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 4)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
