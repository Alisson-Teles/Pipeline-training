; ModuleID = 'out/00422.rob'
source_filename = "out/00422.rob"
...
define zeroext range(i16 0, 16) i16 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_2.sroa.0 = alloca ptr, align 1
  store i4 1, ptr %l_2.sroa.0, align 1
  %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref = load ptr, ptr %l_2.sroa.0, align 1
  %l_2.f0 = load i4, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref, align 1
  %zext = zext i4 %l_2.f0 to i16
  ret i16 %zext
}
