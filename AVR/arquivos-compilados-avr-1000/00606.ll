...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 22)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  store i10 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i64 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 10
  store i24 0, ptr %gepf2, align 1
  ret void
}
