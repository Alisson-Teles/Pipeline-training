...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 23)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(23) %_this, i8 0, i64 23, i1 false)
  ret void
}
...
body:
  %l_7.sroa.0 = alloca ptr, align 1
  store ptr null, ptr %l_7.sroa.0, align 1
  store i15 -122, ptr %l_7.sroa.0, align 1
  %l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.deref208 = load ptr, ptr %l_7.sroa.0, align 1
  %f6209 = getelementptr inbounds nuw i8, ptr %l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.deref208, i16 16
