; ModuleID = 'out/00743.rob'
source_filename = "out/00743.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i18 0, ptr %_this, align 1
  ret void
}
...
body:
  %l_19 = alloca %S0, align 1
  %l_18 = alloca %S0, align 1
  store i18 -128, ptr %l_19, align 1
  %l_19.0.l_19.0.l_19.promoted = load ptr, ptr %l_19, align 1
  %l_18.0.l_18.0.l_18.promoted = load i18, ptr %l_18, align 1
  store ptr %l_19.0.l_19.0.l_19.promoted, ptr %l_19, align 1
  store i18 %l_18.0.l_18.0.l_18.promoted, ptr %l_18, align 1
  store i18 0, ptr %l_19.0.l_19.0.l_19.promoted, align 1
  ret i32 0
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_19.i = alloca %S0, align 1
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call addrspace(1) void @llvm.lifetime.start.p0(i64 3, ptr nonnull %l_19.i)
  store i18 -128, ptr %l_19.i, align 1
  %l_19.i.0.l_19.i.0.l_19.i.0.l_19.0.l_19.promoted.i = load ptr, ptr %l_19.i, align 1
  store i18 0, ptr %l_19.i.0.l_19.i.0.l_19.i.0.l_19.0.l_19.promoted.i, align 1
  call addrspace(1) void @llvm.lifetime.end.p0(i64 3, ptr nonnull %l_19.i)
