; ModuleID = 'out/00941.rob'
source_filename = "out/00941.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 13)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(13) %_this, i8 0, i64 13, i1 false)
  ret void
}
...
define noundef zeroext range(i32 -32768, 65536) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_28.sroa.0.sroa.0 = alloca i32, align 1
  store i32 0, ptr %l_28.sroa.0.sroa.0, align 1
  store i31 29832, ptr %l_28.sroa.0.sroa.0, align 1
  %l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103 = load ptr, ptr %l_28.sroa.0.sroa.0, align 1
  %f1104 = getelementptr inbounds nuw i8, ptr %l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103, i16 4
  store i30 -451890476, ptr %f1104, align 1
  ret i32 -20609
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_28.sroa.0.sroa.0.i = alloca i32, align 1
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_28.sroa.0.sroa.0.i)
  store i32 0, ptr %l_28.sroa.0.sroa.0.i, align 1
  store i31 29832, ptr %l_28.sroa.0.sroa.0.i, align 1
  %l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103.i = load ptr, ptr %l_28.sroa.0.sroa.0.i, align 1
  %f1104.i = getelementptr inbounds nuw i8, ptr %l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.i.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103.i, i16 4
  store i30 -451890476, ptr %f1104.i, align 1
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_28.sroa.0.sroa.0.i)
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(write, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
