; ModuleID = 'out/00549.rob'
source_filename = "out/00549.rob"
...
define void @"S2:init"(ptr nocapture writeonly initializes((0, 15)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
