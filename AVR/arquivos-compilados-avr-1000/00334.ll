; ModuleID = 'out/00334.rob'
source_filename = "out/00334.rob"
...
define range(i64 -128, 128) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  store i32 1, ptr inttoptr (i16 29189 to ptr), align 1
  %l_4.f7 = load i8, ptr inttoptr (i16 29204 to ptr), align 4
  %sext = sext i8 %l_4.f7 to i64
  ret i64 %sext
}
