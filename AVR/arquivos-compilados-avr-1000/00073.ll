; ModuleID = 'out/00073.rob'
source_filename = "out/00073.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 5)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i4 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 1
  store i6 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i17 0, ptr %gepf2, align 1
  ret void
}
...
define noundef range(i64 -2147483648, 2147483648) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i64 1
}
