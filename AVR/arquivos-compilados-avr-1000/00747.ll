; ModuleID = 'out/00747.rob'
source_filename = "out/00747.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i2 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 1
  store i4 0, ptr %gepf1, align 1
  ret void
}
