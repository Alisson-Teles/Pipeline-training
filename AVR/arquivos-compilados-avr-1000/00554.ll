...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 50)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(50) %_this, i8 0, i64 50, i1 false)
  ret void
}
