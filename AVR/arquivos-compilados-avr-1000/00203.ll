; ModuleID = 'out/00203.rob'
source_filename = "out/00203.rob"
...
body:
  %l_14 = alloca [7 x i32], align 1
  store i32 -8, ptr %l_14, align 1
  %elem3 = getelementptr inbounds nuw i8, ptr %l_14, i16 4
  store i32 -8, ptr %elem3, align 1
  %elem4 = getelementptr inbounds nuw i8, ptr %l_14, i16 8
  store i32 -8, ptr %elem4, align 1
  %elem5 = getelementptr inbounds nuw i8, ptr %l_14, i16 12
  store i32 -8, ptr %elem5, align 1
  %elem6 = getelementptr inbounds nuw i8, ptr %l_14, i16 16
  store i32 -8, ptr %elem6, align 1
  %elem7 = getelementptr inbounds nuw i8, ptr %l_14, i16 20
  store i32 -8, ptr %elem7, align 1
  %elem8 = getelementptr inbounds nuw i8, ptr %l_14, i16 24
  store i32 -8, ptr %elem8, align 1
  br label %while_cond142.preheader

while_cond142.preheader:                          ; preds = %body, %if_cont.5
  %l_2.0755 = phi i32 [ %binop228, %if_cont.5 ], [ 0, %body ]
  %0 = trunc i32 %l_2.0755 to i16
  %gep167 = getelementptr [7 x i32], ptr %l_14, i16 0, i16 %0
  %1 = add i16 %0, 4
  %gep174 = getelementptr [7 x i32], ptr %l_14, i16 0, i16 %1
  %gep178 = getelementptr [0 x i32], ptr %l_14, i16 0, i16 %1
  %gep222 = getelementptr [0 x i32], ptr %l_14, i16 0, i16 %0
  store i32 1, ptr %elem8, align 1
  %l_14168 = load i32, ptr %gep167, align 1
  %cmpi169.not = icmp eq i32 %l_14168, 0
  br i1 %cmpi169.not, label %if_cont, label %if_then

while_cond457.preheader:                          ; preds = %if_cont.5
  store i32 119, ptr %l_14, align 1
  ret i32 -1

if_then:                                          ; preds = %while_cond142.preheader
  %l_14175 = load i32, ptr %gep174, align 1
  store i32 %l_14175, ptr %gep178, align 1
  %cmpi220 = icmp slt i32 %l_14168, 2
  %binop10.i743 = select i1 %cmpi220, i32 1048576, i32 0
  store i32 %binop10.i743, ptr %gep222, align 1
  br label %if_cont

if_cont:                                          ; preds = %while_cond142.preheader, %if_then
  store i32 1, ptr %elem8, align 1
  %l_14168.1 = load i32, ptr %gep167, align 1
  %cmpi169.not.1 = icmp eq i32 %l_14168.1, 0
  br i1 %cmpi169.not.1, label %if_cont.1, label %if_then.1

if_then.1:                                        ; preds = %if_cont
  %l_14175.1 = load i32, ptr %gep174, align 1
  store i32 %l_14175.1, ptr %gep178, align 1
  %cmpi220.1 = icmp slt i32 %l_14168.1, 2
  %binop10.i743.1 = select i1 %cmpi220.1, i32 1048576, i32 0
  store i32 %binop10.i743.1, ptr %gep222, align 1
  br label %if_cont.1

if_cont.1:                                        ; preds = %if_then.1, %if_cont
  store i32 1, ptr %elem8, align 1
  %l_14168.2 = load i32, ptr %gep167, align 1
  %cmpi169.not.2 = icmp eq i32 %l_14168.2, 0
  br i1 %cmpi169.not.2, label %if_cont.2, label %if_then.2

if_then.2:                                        ; preds = %if_cont.1
  %l_14175.2 = load i32, ptr %gep174, align 1
  store i32 %l_14175.2, ptr %gep178, align 1
  %cmpi220.2 = icmp slt i32 %l_14168.2, 2
  %binop10.i743.2 = select i1 %cmpi220.2, i32 1048576, i32 0
  store i32 %binop10.i743.2, ptr %gep222, align 1
  br label %if_cont.2

if_cont.2:                                        ; preds = %if_then.2, %if_cont.1
  store i32 1, ptr %elem8, align 1
  %l_14168.3 = load i32, ptr %gep167, align 1
  %cmpi169.not.3 = icmp eq i32 %l_14168.3, 0
  br i1 %cmpi169.not.3, label %if_cont.3, label %if_then.3

if_then.3:                                        ; preds = %if_cont.2
  %l_14175.3 = load i32, ptr %gep174, align 1
  store i32 %l_14175.3, ptr %gep178, align 1
  %cmpi220.3 = icmp slt i32 %l_14168.3, 2
  %binop10.i743.3 = select i1 %cmpi220.3, i32 1048576, i32 0
  store i32 %binop10.i743.3, ptr %gep222, align 1
  br label %if_cont.3

if_cont.3:                                        ; preds = %if_then.3, %if_cont.2
  store i32 1, ptr %elem8, align 1
  %l_14168.4 = load i32, ptr %gep167, align 1
  %cmpi169.not.4 = icmp eq i32 %l_14168.4, 0
  br i1 %cmpi169.not.4, label %if_cont.4, label %if_then.4

if_then.4:                                        ; preds = %if_cont.3
  %l_14175.4 = load i32, ptr %gep174, align 1
  store i32 %l_14175.4, ptr %gep178, align 1
  %cmpi220.4 = icmp slt i32 %l_14168.4, 2
  %binop10.i743.4 = select i1 %cmpi220.4, i32 1048576, i32 0
  store i32 %binop10.i743.4, ptr %gep222, align 1
  br label %if_cont.4

if_cont.4:                                        ; preds = %if_then.4, %if_cont.3
  store i32 1, ptr %elem8, align 1
  %l_14168.5 = load i32, ptr %gep167, align 1
  %cmpi169.not.5 = icmp eq i32 %l_14168.5, 0
  br i1 %cmpi169.not.5, label %if_cont.5, label %if_then.5

if_then.5:                                        ; preds = %if_cont.4
  %l_14175.5 = load i32, ptr %gep174, align 1
  store i32 %l_14175.5, ptr %gep178, align 1
  %cmpi220.5 = icmp slt i32 %l_14168.5, 2
  %binop10.i743.5 = select i1 %cmpi220.5, i32 1048576, i32 0
  store i32 %binop10.i743.5, ptr %gep222, align 1
  br label %if_cont.5

if_cont.5:                                        ; preds = %if_then.5, %if_cont.4
  %binop228 = add nuw nsw i32 %l_2.0755, 1
  %cmpi131 = icmp eq i32 %l_2.0755, 0
  br i1 %cmpi131, label %while_cond142.preheader, label %while_cond457.preheader
}
