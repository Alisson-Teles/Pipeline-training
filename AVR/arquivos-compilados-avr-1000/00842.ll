; ModuleID = 'out/00842.rob'
source_filename = "out/00842.rob"
target datalayout = "e-P1-p:16:8-i8:8-i16:8-i32:8-i64:8-f32:8-f64:8-n8-a:8"
target triple = "avr"

%S1 = type { i8, i64, i8, i8, i16, i64 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 21)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  ret %S1 { i8 0, i64 0, i8 0, i8 -6, i16 2791, i64 6450318299901847083 }
}
