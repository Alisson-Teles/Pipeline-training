; ModuleID = 'out/00891.rob'
source_filename = "out/00891.rob"
...
body:
  ...
  store i16 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 3
  store i64 0, ptr %gepf2, align 1
  ret void
}
...
define i8 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_28 = alloca [7 x i32], align 1
  %elem20 = getelementptr inbounds nuw i8, ptr %l_28, i16 4
  %elem21 = getelementptr inbounds nuw i8, ptr %l_28, i16 8
  %elem22 = getelementptr inbounds nuw i8, ptr %l_28, i16 12
  %elem23 = getelementptr inbounds nuw i8, ptr %l_28, i16 16
  %elem24 = getelementptr inbounds nuw i8, ptr %l_28, i16 20
  %elem25 = getelementptr inbounds nuw i8, ptr %l_28, i16 24
  br label %while_body

while_body:                                       ; preds = %body, %while_end169
  %l_3.0637 = phi i32 [ 8, %body ], [ %binop247, %while_end169 ]
  store i32 0, ptr %l_28, align 1
  store i32 -3, ptr %elem20, align 1
  store i32 0, ptr %elem21, align 1
  store i32 0, ptr %elem22, align 1
  store i32 -3, ptr %elem23, align 1
  store i32 0, ptr %elem24, align 1
  store i32 0, ptr %elem25, align 1
  br label %while_body168

while_end:                                        ; preds = %while_end169
  ret i8 87

while_body168:                                    ; preds = %while_body, %while_body168
  %storemerge633 = phi i8 [ 0, %while_body ], [ %binop245, %while_body168 ]
  %0 = zext nneg i8 %storemerge633 to i16
  %gep174 = getelementptr [7 x i32], ptr %l_28, i16 0, i16 %0
  %l_28175 = load i32, ptr %gep174, align 1
  %binop176 = and i32 %l_28175, 27293538
  %gep177 = getelementptr [0 x i32], ptr %l_28, i16 0, i16 %0
  store i32 %binop176, ptr %gep177, align 1
  %gep174.promoted = load i32, ptr %gep174, align 1
  %binop223 = and i32 %gep174.promoted, -1123853225
  store i32 %binop223, ptr %gep177, align 1
  %binop245 = add nuw nsw i8 %storemerge633, 1
  %exitcond.not = icmp eq i8 %binop245, 7
  br i1 %exitcond.not, label %while_end169, label %while_body168

while_end169:                                     ; preds = %while_body168
  %binop247 = add nsw i32 %l_3.0637, -1
  %cmpi = icmp ugt i32 %l_3.0637, 1
...
body:
  ...
  %0 = tail call addrspace(1) i8 @func_1()
...
attributes #3 = { nofree norecurse nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
