; ModuleID = 'out/00538.rob'
source_filename = "out/00538.rob"
...
define void @"S3:init"(ptr nocapture writeonly initializes((0, 9)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
