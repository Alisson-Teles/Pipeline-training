; ModuleID = 'out/00645.rob'
source_filename = "out/00645.rob"
...
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %_this, i8 0, i64 7, i1 false)
  ret void
}
