; ModuleID = 'out/00185.rob'
source_filename = "out/00185.rob"
target datalayout = "e-P1-p:16:8-i8:8-i16:8-i32:8-i64:8-f32:8-f64:8-n8-a:8"
target triple = "avr"

%S0 = type { i32, i32, i32, i8, i8, i32 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S0:init"(ptr nocapture writeonly initializes((0, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
