; ModuleID = 'out/00911.rob'
source_filename = "out/00911.rob"
...
body:
  store i6 0, ptr %_this, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %_this, i8 0, i64 16, i1 false)
  ret void
}
