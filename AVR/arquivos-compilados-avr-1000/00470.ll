...
body:
  %l_13 = alloca [8 x i32], align 1
  store i32 -1, ptr %l_13, align 1
  %elem1 = getelementptr inbounds nuw i8, ptr %l_13, i16 4
  store i32 1685635982, ptr %elem1, align 1
  %elem2 = getelementptr inbounds nuw i8, ptr %l_13, i16 8
  store i32 -1, ptr %elem2, align 1
  %elem3 = getelementptr inbounds nuw i8, ptr %l_13, i16 12
  store i32 -1, ptr %elem3, align 1
  %elem4 = getelementptr inbounds nuw i8, ptr %l_13, i16 16
  store i32 1685635982, ptr %elem4, align 1
  %elem5 = getelementptr inbounds nuw i8, ptr %l_13, i16 20
  store i32 -1, ptr %elem5, align 1
  %elem6 = getelementptr inbounds nuw i8, ptr %l_13, i16 24
  store i32 -1, ptr %elem6, align 1
  %elem7 = getelementptr inbounds nuw i8, ptr %l_13, i16 28
  store i32 1685635982, ptr %elem7, align 1
  store i32 227, ptr %elem6, align 1
  %gep38 = getelementptr inbounds nuw i8, ptr %l_13, i16 4
  %l_1339.peel = load i32, ptr %gep38, align 1
  %zext58.peel = and i32 %l_1339.peel, 65535
  %gep63.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 4
  store i32 %zext58.peel, ptr %gep63.peel, align 1
  %gep38.1.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 8
  %l_1339.1.peel = load i32, ptr %gep38.1.peel, align 1
  %zext58.1.peel = and i32 %l_1339.1.peel, 65535
  %gep63.1.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 8
  store i32 %zext58.1.peel, ptr %gep63.1.peel, align 1
  %gep38.2.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 12
  %l_1339.2.peel = load i32, ptr %gep38.2.peel, align 1
  %zext58.2.peel = and i32 %l_1339.2.peel, 65535
  %gep63.2.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 12
  store i32 %zext58.2.peel, ptr %gep63.2.peel, align 1
  %gep38.3.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 16
  %l_1339.3.peel = load i32, ptr %gep38.3.peel, align 1
  %zext58.3.peel = and i32 %l_1339.3.peel, 65535
  %gep63.3.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 16
  store i32 %zext58.3.peel, ptr %gep63.3.peel, align 1
  %gep38.4.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 20
  %l_1339.4.peel = load i32, ptr %gep38.4.peel, align 1
  %zext58.4.peel = and i32 %l_1339.4.peel, 65535
  %gep63.4.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 20
  store i32 %zext58.4.peel, ptr %gep63.4.peel, align 1
  %gep38.5.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 24
  %l_1339.5.peel = load i32, ptr %gep38.5.peel, align 1
  %zext58.5.peel = and i32 %l_1339.5.peel, 65535
  %gep63.5.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 24
  store i32 %zext58.5.peel, ptr %gep63.5.peel, align 1
  %gep38.6.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 28
  %l_1339.6.peel = load i32, ptr %gep38.6.peel, align 1
  %zext58.6.peel = and i32 %l_1339.6.peel, 65535
  %gep63.6.peel = getelementptr inbounds nuw i8, ptr %l_13, i16 28
  store i32 %zext58.6.peel, ptr %gep63.6.peel, align 1
  %l_1369.peel = load i32, ptr %l_13, align 1
  ...
  %l_1386.peel = load i32, ptr %elem6, align 1
  %cmpi87.not.peel = icmp sgt i32 %l_1386.peel, %intcast84.peel
  %sext89.peel = select i1 %cmpi87.not.peel, i32 0, i32 512
  store i32 %sext89.peel, ptr %l_13, align 1
  %gep63 = getelementptr inbounds nuw i8, ptr %l_13, i16 4
  %gep38.1 = getelementptr inbounds nuw i8, ptr %l_13, i16 8
  %gep63.1 = getelementptr inbounds nuw i8, ptr %l_13, i16 8
  %gep38.2 = getelementptr inbounds nuw i8, ptr %l_13, i16 12
  %gep63.2 = getelementptr inbounds nuw i8, ptr %l_13, i16 12
  %gep38.3 = getelementptr inbounds nuw i8, ptr %l_13, i16 16
  %gep63.3 = getelementptr inbounds nuw i8, ptr %l_13, i16 16
  %gep38.4 = getelementptr inbounds nuw i8, ptr %l_13, i16 20
  %gep63.4 = getelementptr inbounds nuw i8, ptr %l_13, i16 20
  %gep38.5 = getelementptr inbounds nuw i8, ptr %l_13, i16 24
  %gep63.5 = getelementptr inbounds nuw i8, ptr %l_13, i16 24
  %gep38.6 = getelementptr inbounds nuw i8, ptr %l_13, i16 28
  %gep63.6 = getelementptr inbounds nuw i8, ptr %l_13, i16 28
  br label %while_cond31.preheader

while_cond31.preheader:                           ; preds = %body, %while_cond31.preheader
  %l_3.1115 = phi i32 [ 1, %body ], [ %binop92, %while_cond31.preheader ]
  %l_1339 = load i32, ptr %gep38, align 1
  %zext58 = and i32 %l_1339, 65535
  store i32 %zext58, ptr %gep63, align 1
  %l_1339.1 = load i32, ptr %gep38.1, align 1
  %zext58.1 = and i32 %l_1339.1, 65535
  store i32 %zext58.1, ptr %gep63.1, align 1
  %l_1339.2 = load i32, ptr %gep38.2, align 1
  %zext58.2 = and i32 %l_1339.2, 65535
  store i32 %zext58.2, ptr %gep63.2, align 1
  %l_1339.3 = load i32, ptr %gep38.3, align 1
  %zext58.3 = and i32 %l_1339.3, 65535
  store i32 %zext58.3, ptr %gep63.3, align 1
  %l_1339.4 = load i32, ptr %gep38.4, align 1
  %zext58.4 = and i32 %l_1339.4, 65535
  store i32 %zext58.4, ptr %gep63.4, align 1
  %l_1339.5 = load i32, ptr %gep38.5, align 1
  %zext58.5 = and i32 %l_1339.5, 65535
  store i32 %zext58.5, ptr %gep63.5, align 1
  %l_1339.6 = load i32, ptr %gep38.6, align 1
  %zext58.6 = and i32 %l_1339.6, 65535
  store i32 %zext58.6, ptr %gep63.6, align 1
  %0 = trunc i32 %l_3.1115 to i16
  %binop.i108 = zext nneg i32 %l_3.1115 to i64
  ...
  %l_1386 = load i32, ptr %elem6, align 1
  %cmpi87.not = icmp sgt i32 %l_1386, %intcast84
  %sext89 = select i1 %cmpi87.not, i32 0, i32 512
  %gep90 = getelementptr [0 x i32], ptr %l_13, i16 0, i16 %0
  store i32 %sext89, ptr %gep90, align 1
  %binop92 = add nuw nsw i32 %l_3.1115, 1
  %cmpi28 = icmp samesign ult i32 %l_3.1115, 7
  br i1 %cmpi28, label %while_cond31.preheader, label %while_end30, !llvm.loop !1

while_end30:                                      ; preds = %while_cond31.preheader
  %l_1394 = load i32, ptr %elem2, align 1
