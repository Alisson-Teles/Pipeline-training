; ModuleID = 'out/00656.rob'
source_filename = "out/00656.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  store i64 0, ptr inttoptr (i16 -1 to ptr), align 1
  ret i32 0
}
