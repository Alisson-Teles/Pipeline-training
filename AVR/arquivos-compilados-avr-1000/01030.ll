; ModuleID = 'out/01030.rob'
source_filename = "out/01030.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
