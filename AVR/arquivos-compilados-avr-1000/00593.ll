; ModuleID = 'out/00593.rob'
source_filename = "out/00593.rob"
...
define void @"S2:init"(ptr nocapture writeonly initializes((0, 4)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i27 0, ptr %_this, align 1
  ret void
}
