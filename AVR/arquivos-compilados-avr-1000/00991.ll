; ModuleID = 'out/00991.rob'
source_filename = "out/00991.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i14 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i13 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i28 0, ptr %gepf2, align 1
  ret void
}
...
define noundef range(i32 -128, 8192) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i32 53
}
