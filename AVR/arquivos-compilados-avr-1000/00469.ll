; ModuleID = 'out/00469.rob'
source_filename = "out/00469.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 21)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(21) %_this, i8 0, i64 21, i1 false)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S2:init"(ptr nocapture writeonly initializes((0, 1)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S3:init"(ptr nocapture writeonly initializes((0, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i26 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i29 0, ptr %gepf1, align 1
  ret void
}
...
define zeroext i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_2 = alloca [7 x i64], align 1
  %l_22 = alloca [3 x i32], align 1
  %l_67.sroa.20 = alloca i30, align 1
  %l_72.sroa.0 = alloca i8, align 1
  %elem6 = getelementptr inbounds nuw i8, ptr %l_2, i16 48
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(56) %l_2, i8 0, i64 56, i1 false)
  store i32 0, ptr %l_22, align 1
  %elem8 = getelementptr inbounds nuw i8, ptr %l_22, i16 4
  store i32 0, ptr %elem8, align 1
  %elem9 = getelementptr inbounds nuw i8, ptr %l_22, i16 8
  store i32 0, ptr %elem9, align 1
  store i64 -9, ptr %l_2, align 1
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_2, i16 8
  store i64 -9, ptr %gep.1, align 1
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_2, i16 16
  store i64 -9, ptr %gep.2, align 1
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_2, i16 24
  store i64 -9, ptr %gep.3, align 1
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_2, i16 32
  store i64 -9, ptr %gep.4, align 1
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_2, i16 40
  store i64 -9, ptr %gep.5, align 1
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_2, i16 48
  store i64 -9, ptr %gep.6, align 1
  store i32 -7, ptr %l_22, align 1
  %gep36.1 = getelementptr inbounds nuw i8, ptr %l_22, i16 4
  store i32 -7, ptr %gep36.1, align 1
  %gep36.2 = getelementptr inbounds nuw i8, ptr %l_22, i16 8
  store i32 -7, ptr %gep36.2, align 1
  %gep155 = getelementptr inbounds nuw i8, ptr %l_22, i16 8
  %gep155.1 = getelementptr inbounds nuw i8, ptr %l_22, i16 4
  %gep155.promoted = load i32, ptr %gep155, align 1
  %gep155.1.promoted = load i32, ptr %gep155.1, align 1
  %l_22.promoted = load i32, ptr %l_22, align 1
  br label %while_body42

while_cond236.preheader:                          ; preds = %while_body42
  store i32 %binop158.4, ptr %gep155, align 1
  store i32 %binop158.1.4, ptr %gep155.1, align 1
  store i32 %binop158.2.4, ptr %l_22, align 1
  br label %while_cond242.preheader

while_body42:                                     ; preds = %body, %while_body42
  %binop158.2.4736 = phi i32 [ %l_22.promoted, %body ], [ %binop158.2.4, %while_body42 ]
  %l_22156.1735 = phi i32 [ %gep155.1.promoted, %body ], [ %binop158.1.4, %while_body42 ]
  %l_22156.4734 = phi i32 [ %gep155.promoted, %body ], [ %binop158.4, %while_body42 ]
  %l_3.0716 = phi i32 [ 0, %body ], [ %binop235, %while_body42 ]
  %binop158.4 = xor i32 %l_22156.4734, 18114
  %binop158.1.4 = xor i32 %l_22156.1735, 18114
  %binop158.2.4 = xor i32 %binop158.2.4736, 18114
  %binop235 = add nuw nsw i32 %l_3.0716, 1
  %cmpi41 = icmp samesign ult i32 %l_3.0716, 6
  br i1 %cmpi41, label %while_body42, label %while_cond236.preheader

while_cond242.preheader:                          ; preds = %while_cond236.preheader, %safe_div_func_int32_t_s_s.exit
  %l_18.0722 = phi i32 [ 0, %while_cond236.preheader ], [ %binop436, %safe_div_func_int32_t_s_s.exit ]
  %0 = trunc i32 %l_18.0722 to i16
  %gep251 = getelementptr [7 x i64], ptr %l_2, i16 0, i16 %0
  %l_2252 = load i64, ptr %gep251, align 1
  %cmpi.i611 = icmp sgt i64 %l_2252, 0
  %trunc261 = trunc i64 %l_2252 to i32
  %cmpi5.i579 = icmp sgt i32 %trunc261, 0
  %binop.i580 = sub i32 2147483647, %trunc261
  %extract.t701 = trunc i64 %l_2252 to i32
  %extract.t702 = trunc i64 %l_2252 to i32
  %cmpi37.i = icmp slt i64 %l_2252, 1
  %extract.t700 = trunc i64 %l_2252 to i32
  %1 = icmp slt i64 %l_2252, 0
  %extract.t703 = trunc i64 %l_2252 to i32
  %2 = trunc i64 %l_2252 to i32
  %cmpi22.i = icmp slt i32 %trunc261, 0
  %narrow = sub nsw i32 -2147483648, %trunc261
  br label %while_body245

while_body245:                                    ; preds = %while_cond242.preheader, %safe_mod_func_uint16_t_u_u.exit
  %l_9.4720 = phi i32 [ 2, %while_cond242.preheader ], [ %binop323, %safe_mod_func_uint16_t_u_u.exit ]
  %3 = trunc i32 %l_9.4720 to i16
  %gep254 = getelementptr [3 x i32], ptr %l_22, i16 0, i16 %3
  %l_22255 = load i32, ptr %gep254, align 1
  %sext256 = sext i32 %l_22255 to i64
  %cmpi5.i612 = icmp sgt i32 %l_22255, 0
  %phi.i613 = select i1 %cmpi.i611, i1 %cmpi5.i612, i1 false
  br i1 %phi.i613, label %fullev6.i, label %fullev13.i614

fullev6.i:                                        ; preds = %while_body245
  %binop.i622 = sdiv i64 -9223372036854775808, %sext256
  %cmpi11.i623 = icmp sgt i64 %l_2252, %binop.i622
  br i1 %cmpi11.i623, label %safe_mul_func_int64_t_s_s.exit, label %fullev13.i614

fullev13.i614:                                    ; preds = %fullev6.i, %while_body245
  %cmpi22.i616 = icmp slt i32 %l_22255, 1
  %spec.select.i617 = select i1 %cmpi.i611, i1 %cmpi22.i616, i1 false
  br i1 %spec.select.i617, label %fullev24.i621, label %fullev33.i

fullev24.i621:                                    ; preds = %fullev13.i614
  %binop29.i = sdiv i64 -9223372036854775808, %l_2252
  %cmpi30.i = icmp sgt i64 %binop29.i, %sext256
  br i1 %cmpi30.i, label %safe_mul_func_int64_t_s_s.exit, label %fullev33.i

fullev33.i:                                       ; preds = %fullev24.i621, %fullev13.i614
  %spec.select83.i = select i1 %cmpi37.i, i1 %cmpi5.i612, i1 false
  br i1 %spec.select83.i, label %fullev44.i, label %fullev53.i

fullev44.i:                                       ; preds = %fullev33.i
  %binop49.i = sdiv i64 -9223372036854775808, %sext256
  %cmpi50.i = icmp slt i64 %l_2252, %binop49.i
  br i1 %cmpi50.i, label %safe_mul_func_int64_t_s_s.exit, label %fullev53.i

fullev53.i:                                       ; preds = %fullev44.i, %fullev33.i
  %or.cond.i618 = select i1 %1, i1 %cmpi22.i616, i1 false
  br i1 %or.cond.i618, label %fullev70.i, label %if_cont.i619

fullev70.i:                                       ; preds = %fullev53.i
  %binop75.i = sdiv i64 -9223372036854775808, %l_2252
  %cmpi76.i = icmp sgt i64 %binop75.i, %sext256
  br i1 %cmpi76.i, label %safe_mul_func_int64_t_s_s.exit, label %if_cont.i619

if_cont.i619:                                     ; preds = %fullev70.i, %fullev53.i
  %extract.t699 = mul i32 %l_22255, %2
  br label %safe_mul_func_int64_t_s_s.exit

safe_mul_func_int64_t_s_s.exit:                   ; preds = %fullev6.i, %fullev24.i621, %fullev44.i, %fullev70.i, %if_cont.i619
  %common.ret.op.i620.off0 = phi i32 [ %extract.t699, %if_cont.i619 ], [ %extract.t700, %fullev44.i ], [ %extract.t701, %fullev6.i ], [ %extract.t702, %fullev24.i621 ], [ %extract.t703, %fullev70.i ]
  %cmpi.i578 = icmp sgt i32 %common.ret.op.i620.off0, 0
  %phi.i = and i1 %cmpi5.i579, %cmpi.i578
  %cmpi11.i581 = icmp sgt i32 %common.ret.op.i620.off0, %binop.i580
  %or.cond.i = and i1 %cmpi11.i581, %phi.i
  %extract.t706 = trunc i32 %common.ret.op.i620.off0 to i16
  br i1 %or.cond.i, label %safe_add_func_int32_t_s_s.exit, label %fullev13.i

fullev13.i:                                       ; preds = %safe_mul_func_int64_t_s_s.exit
  %cmpi17.i582 = icmp slt i32 %common.ret.op.i620.off0, 0
  %spec.select.i = and i1 %cmpi22.i, %cmpi17.i582
  %cmpi31.i = icmp sgt i32 %narrow, %common.ret.op.i620.off0
  %extract.t705 = trunc i32 %common.ret.op.i620.off0 to i16
  %or.cond725 = select i1 %spec.select.i, i1 %cmpi31.i, i1 false
  br i1 %or.cond725, label %safe_add_func_int32_t_s_s.exit, label %if_cont.i583

if_cont.i583:                                     ; preds = %fullev13.i
  %binop37.i584 = add i32 %common.ret.op.i620.off0, %trunc261
  %extract.t704 = trunc i32 %binop37.i584 to i16
  br label %safe_add_func_int32_t_s_s.exit

safe_add_func_int32_t_s_s.exit:                   ; preds = %fullev13.i, %safe_mul_func_int64_t_s_s.exit, %if_cont.i583
  %common.ret.op.i585.off0 = phi i16 [ %extract.t704, %if_cont.i583 ], [ %extract.t706, %safe_mul_func_int64_t_s_s.exit ], [ %extract.t705, %fullev13.i ]
  %trunc266 = trunc i32 %l_22255 to i16
  %cmpi.i664 = icmp eq i16 %trunc266, 0
  br i1 %cmpi.i664, label %safe_mod_func_uint16_t_u_u.exit, label %if_cont.i665

if_cont.i665:                                     ; preds = %safe_add_func_int32_t_s_s.exit
  %binop.i666 = urem i16 %common.ret.op.i585.off0, %trunc266
  br label %safe_mod_func_uint16_t_u_u.exit

safe_mod_func_uint16_t_u_u.exit:                  ; preds = %safe_add_func_int32_t_s_s.exit, %if_cont.i665
  %common.ret.op.i667 = phi i16 [ %binop.i666, %if_cont.i665 ], [ %common.ret.op.i585.off0, %safe_add_func_int32_t_s_s.exit ]
  %cmpi269 = icmp ugt i16 %common.ret.op.i667, 7
  %zext270 = zext i1 %cmpi269 to i32
  %gep271 = getelementptr [0 x i32], ptr %l_22, i16 0, i16 %3
  store i32 %zext270, ptr %gep271, align 1
  store i32 0, ptr %l_67.sroa.20, align 1
  store i30 -19624, ptr %l_67.sroa.20, align 1
  store i32 0, ptr %l_67.sroa.20, align 1
  store i30 -19624, ptr %l_67.sroa.20, align 1
  store i32 0, ptr %l_67.sroa.20, align 1
  store i30 -19624, ptr %l_67.sroa.20, align 1
  ...
  store i32 0, ptr %l_67.sroa.20, align 1
  store i30 -19624, ptr %l_67.sroa.20, align 1
  store i32 0, ptr %gep271, align 1
  %binop323 = add nsw i32 %l_9.4720, -1
  %cmpi244.not = icmp eq i32 %l_9.4720, 0
  br i1 %cmpi244.not, label %while_end246, label %while_body245

while_end246:                                     ; preds = %safe_mod_func_uint16_t_u_u.exit
  %4 = trunc i32 %l_18.0722 to i16
  %gep325 = getelementptr [7 x i64], ptr %l_2, i16 0, i16 %4
  %l_2326 = load i64, ptr %gep325, align 1
  %cmpi327.not = icmp eq i64 %l_2326, 0
  br i1 %cmpi327.not, label %if_else363, label %if_then328

if_then328:                                       ; preds = %while_end246
  store i8 -2, ptr %l_72.sroa.0, align 1
  %l_67.sroa.20.0.l_67.sroa.20.8.l_68.f3 = load i30, ptr %l_67.sroa.20, align 1
  %intcast334 = zext i30 %l_67.sroa.20.0.l_67.sroa.20.8.l_68.f3 to i32
  %binop.i680 = sub i64 1, %l_2326
  %binop349 = xor i64 %binop.i680, -1451224267
  %5 = and i64 %l_2326, 4294967232
  %cmpi.i688.not = icmp eq i64 %5, 0
  %intcast.i689 = and i64 %l_2326, 4294967295
  %binop.i690 = select i1 %cmpi.i688.not, i64 %intcast.i689, i64 0
  %common.ret.op.i691 = lshr i64 %binop349, %binop.i690
  %6 = trunc i64 %common.ret.op.i691 to i16
  %trunc355 = xor i16 %6, -10
  %binop.i669 = add i16 %trunc355, 17180
  %or.cond = icmp ugt i16 %binop.i669, 255
  %binop23.i = shl i16 %binop.i669, 7
  %common.ret.op.i = select i1 %or.cond, i16 %binop.i669, i16 %binop23.i
  %sext357 = sext i16 %common.ret.op.i to i32
  %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358 = load ptr, ptr %l_72.sroa.0, align 1
  %l_72.f0 = load i8, ptr %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358, align 1
  %cmpi.i605 = icmp eq i8 %l_72.f0, 0
  br i1 %cmpi.i605, label %safe_div_func_int32_t_s_s.exit, label %fullev.i

fullev.i:                                         ; preds = %if_then328
  %zext360 = zext i8 %l_72.f0 to i32
  %binop.i609 = sdiv i32 %sext357, %zext360
  br label %safe_div_func_int32_t_s_s.exit

safe_div_func_int32_t_s_s.exit:                   ; preds = %if_then328, %fullev.i
  %common.ret.op.i610 = phi i32 [ %binop.i609, %fullev.i ], [ %sext357, %if_then328 ]
  %binop.i670 = add nsw i32 %common.ret.op.i610, 10
  %binop361 = or i32 %binop.i670, %intcast334
  %trunc362 = trunc i32 %binop361 to i30
  store i30 %trunc362, ptr %l_67.sroa.20, align 1
  %binop436 = add nuw nsw i32 %l_18.0722, 1
  %cmpi238 = icmp samesign ult i32 %l_18.0722, 6
  br i1 %cmpi238, label %while_cond242.preheader, label %while_body440

if_else363:                                       ; preds = %while_end246
  %l_67.sroa.20.0.l_67.sroa.20.8.l_68.f3420 = load i30, ptr %l_67.sroa.20, align 1
  %zext421 = zext i30 %l_67.sroa.20.0.l_67.sroa.20.8.l_68.f3420 to i32
  br label %common.ret

common.ret:                                       ; preds = %while_body440, %if_else363
  %common.ret.op = phi i32 [ %zext421, %if_else363 ], [ %trunc517, %while_body440 ]
  ret i32 %common.ret.op

while_body440:                                    ; preds = %safe_div_func_int32_t_s_s.exit
  %l_22444 = load i32, ptr %l_22, align 1
  %binop496 = or i32 %l_22444, 1
  store i32 %binop496, ptr %l_22, align 1
  %l_2507 = load i64, ptr %elem6, align 1
  %trunc517 = trunc i64 %l_2507 to i32
  br label %common.ret
}
...
body:
  ...
  %0 = tail call zeroext addrspace(1) i32 @func_1()
...
attributes #0 = { mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
attributes #1 = { "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
attributes #2 = { alwaysinline mustprogress nofree norecurse nosync nounwind willreturn memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
attributes #3 = { nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
