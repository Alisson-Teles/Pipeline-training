...
attributes #2 = { nofree norecurse noreturn nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
attributes #3 = { noreturn "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
