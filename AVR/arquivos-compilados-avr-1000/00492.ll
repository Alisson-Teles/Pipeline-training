; ModuleID = 'out/00492.rob'
source_filename = "out/00492.rob"
...
define zeroext range(i64 -2, 11) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_body44

while_body44:                                     ; preds = %body, %while_body44
  %l_2.1144 = phi i32 [ -2, %body ], [ %.l_2.1144, %while_body44 ]
  %l_9.0143 = phi i32 [ 7, %body ], [ %binop109, %while_body44 ]
  %cmpi51.not = icmp eq i32 %l_9.0143, 0
  %.l_2.1144 = select i1 %cmpi51.not, i32 10, i32 %l_2.1144
  %binop109 = add nsw i32 %l_9.0143, -1
  %cmpi43.not = icmp eq i32 %l_9.0143, 0
  br i1 %cmpi43.not, label %while_end45, label %while_body44

while_end45:                                      ; preds = %while_body44
  %sext111 = sext i32 %.l_2.1144 to i64
  ret i64 %sext111
}
