; ModuleID = 'out/00366.rob'
source_filename = "out/00366.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 2
  store i32 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 6
...
body:
  ret %S1 { i16 -12504, i32 744148110, i16 7985 }
}
