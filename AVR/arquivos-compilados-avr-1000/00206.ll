; ModuleID = 'out/00206.rob'
source_filename = "out/00206.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
