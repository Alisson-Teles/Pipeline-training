; ModuleID = 'out/01043.rob'
source_filename = "out/01043.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 9)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 1
  store i31 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 5
  store i32 0, ptr %gepf2, align 1
  ret void
}
...
body:
  %l_18.sroa.0 = alloca { i8, i31 }, align 1
  store i8 0, ptr %l_18.sroa.0, align 1
  %l_18.sroa.0.1.sroa_idx175 = getelementptr inbounds nuw i8, ptr %l_18.sroa.0, i16 1
  store i31 0, ptr %l_18.sroa.0.1.sroa_idx175, align 1
  store i8 14, ptr %l_18.sroa.0, align 1
  %l_18.sroa.0.1.sroa_idx176 = getelementptr inbounds nuw i8, ptr %l_18.sroa.0, i16 1
  store i31 10838, ptr %l_18.sroa.0.1.sroa_idx176, align 1
  %l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.deref = load ptr, ptr %l_18.sroa.0, align 1
  %f299 = getelementptr inbounds nuw i8, ptr %l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.deref, i16 5
  %l_18.f2 = load i32, ptr %f299, align 1
  ret i32 %l_18.f2
}
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
