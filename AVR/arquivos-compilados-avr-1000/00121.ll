...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(11) %_this, i8 0, i64 11, i1 false)
  ret void
}
...
body:
  %l_5.sroa.0.sroa.0 = alloca i32, align 1
  %l_3 = alloca [10 x i32], align 1
  %inlineArrayElems = alloca [3 x %S0], align 1
  %l_4 = alloca %S0, align 1
  store i32 0, ptr %l_5.sroa.0.sroa.0, align 1
  store i27 6778, ptr %l_5.sroa.0.sroa.0, align 1
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(40) %l_3, i8 0, i64 40, i1 false)
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(33) %inlineArrayElems, i8 0, i64 33, i1 false)
  %ctorElem28 = getelementptr inbounds nuw i8, ptr %inlineArrayElems, i16 22
  store i32 1, ptr %l_3, align 1
  %gep38.1 = getelementptr inbounds nuw i8, ptr %l_3, i16 4
  store i32 1, ptr %gep38.1, align 1
  %gep38.2 = getelementptr inbounds nuw i8, ptr %l_3, i16 8
  store i32 1, ptr %gep38.2, align 1
  %gep38.3 = getelementptr inbounds nuw i8, ptr %l_3, i16 12
  store i32 1, ptr %gep38.3, align 1
  %gep38.4 = getelementptr inbounds nuw i8, ptr %l_3, i16 16
  store i32 1, ptr %gep38.4, align 1
  %gep38.5 = getelementptr inbounds nuw i8, ptr %l_3, i16 20
  store i32 1, ptr %gep38.5, align 1
  %gep38.6 = getelementptr inbounds nuw i8, ptr %l_3, i16 24
  store i32 1, ptr %gep38.6, align 1
  %gep38.7 = getelementptr inbounds nuw i8, ptr %l_3, i16 28
  store i32 1, ptr %gep38.7, align 1
  %gep38.8 = getelementptr inbounds nuw i8, ptr %l_3, i16 32
  store i32 1, ptr %gep38.8, align 1
  %gep38.9 = getelementptr inbounds nuw i8, ptr %l_3, i16 36
  store i32 1, ptr %gep38.9, align 1
  %f147 = getelementptr inbounds nuw i8, ptr %l_4, i16 4
  %f248 = getelementptr inbounds nuw i8, ptr %l_4, i16 5
  %f349 = getelementptr inbounds nuw i8, ptr %l_4, i16 8
  %l_5.sroa.0.sroa.0.0.l_5.sroa.0.sroa.0.0.l_5.sroa.0.sroa.0.0.l_5.sroa.0.promoted = load ptr, ptr %l_5.sroa.0.sroa.0, align 1
  br label %while_body44

while_body44:                                     ; preds = %body, %if_then89
  %l_2.0539 = phi i8 [ 9, %body ], [ %binop128, %if_then89 ]
  %l_13.sroa.2.0538 = phi ptr [ %ctorElem28, %body ], [ %l_13.sroa.2.1, %if_then89 ]
  %l_5.sroa.0.0.l_5.sroa.0.0.deref85535537 = phi ptr [ %l_5.sroa.0.sroa.0.0.l_5.sroa.0.sroa.0.0.l_5.sroa.0.sroa.0.0.l_5.sroa.0.promoted, %body ], [ %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, %if_then89 ]
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(11) %l_4, i8 0, i64 11, i1 false)
  store i27 8406, ptr %l_4, align 1
  store i6 0, ptr %f147, align 1
  store i17 39, ptr %f248, align 1
  store i24 3909, ptr %f349, align 1
  %0 = zext nneg i8 %l_2.0539 to i16
  %gep51 = getelementptr [10 x i32], ptr %l_3, i16 0, i16 %0
  %l_352 = load i32, ptr %gep51, align 1
  %cmpi53 = icmp ult i32 %l_352, 184
  br i1 %cmpi53, label %if_cont, label %if_else

if_else:                                          ; preds = %while_body44
  %f365 = getelementptr inbounds nuw i8, ptr %l_5.sroa.0.0.l_5.sroa.0.0.deref85535537, i16 8
  %l_5.f3 = load i24, ptr %f365, align 1
  %binop75 = or i24 %l_5.f3, 1
  store i24 %binop75, ptr %f365, align 1
  br label %if_cont

if_cont:                                          ; preds = %while_body44, %if_else
  %l_5.sroa.0.0.l_5.sroa.0.0.deref85536 = phi ptr [ %l_5.sroa.0.0.l_5.sroa.0.0.deref85535537, %if_else ], [ %l_4, %while_body44 ]
  %storemerge = phi i24 [ 0, %if_else ], [ 1, %while_body44 ]
  %l_13.sroa.2.1 = phi ptr [ %l_4, %if_else ], [ %l_13.sroa.2.0538, %while_body44 ]
  store i24 %storemerge, ptr %f349, align 1
  %l_5.f0 = load i27, ptr %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, align 1
  %trunc87 = trunc i27 %l_5.f0 to i8
  %binop.i532 = mul i8 %trunc87, -42
  %cmpi88.not = icmp eq i8 %binop.i532, 0
  br i1 %cmpi88.not, label %if_else116, label %if_then89

if_then89:                                        ; preds = %if_cont
  %l_4.f3 = load i24, ptr %f349, align 1
  %binop108 = xor i24 %l_4.f3, 1
  store i24 %binop108, ptr %f349, align 1
  %binop128 = add nsw i8 %l_2.0539, -1
  %cmpi43.not = icmp eq i8 %l_2.0539, 0
  br i1 %cmpi43.not, label %if_cont165, label %while_body44

common.ret:                                       ; preds = %if_cont165, %if_else116
  %deref119.unpack.pn.in = phi ptr [ %l_13.sroa.2.1, %if_else116 ], [ %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, %if_cont165 ]
  %deref119.unpack492.pn.in = phi ptr [ %deref119.elt491, %if_else116 ], [ %f3177, %if_cont165 ]
  %deref119.unpack492.pn = load i24, ptr %deref119.unpack492.pn.in, align 1
  %deref119.unpack490.pn.in = getelementptr inbounds nuw i8, ptr %deref119.unpack.pn.in, i16 5
  %deref119.unpack490.pn = load i17, ptr %deref119.unpack490.pn.in, align 1
  %deref119.unpack488.pn.in = getelementptr inbounds nuw i8, ptr %deref119.unpack.pn.in, i16 4
  %deref119.unpack488.pn = load i6, ptr %deref119.unpack488.pn.in, align 1
  %deref119.unpack.pn = load i27, ptr %deref119.unpack.pn.in, align 1
  %.pn541 = insertvalue %S0 poison, i27 %deref119.unpack.pn, 0
  %.pn540 = insertvalue %S0 %.pn541, i6 %deref119.unpack488.pn, 1
  %.pn = insertvalue %S0 %.pn540, i17 %deref119.unpack490.pn, 2
  %common.ret.op = insertvalue %S0 %.pn, i24 %deref119.unpack492.pn, 3
  ret %S0 %common.ret.op

if_else116:                                       ; preds = %if_cont
  store ptr %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, ptr %l_5.sroa.0.sroa.0, align 1
  %deref119.elt491 = getelementptr inbounds nuw i8, ptr %l_13.sroa.2.1, i16 8
  br label %common.ret

if_cont165:                                       ; preds = %if_then89
  store ptr %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, ptr %l_5.sroa.0.sroa.0, align 1
  %f3177 = getelementptr inbounds nuw i8, ptr %l_5.sroa.0.0.l_5.sroa.0.0.deref85536, i16 8
  %l_5.f3217 = load i24, ptr %f3177, align 1
  %binop231 = or i24 %l_5.f3217, 4
  store i24 %binop231, ptr %f3177, align 1
  br label %common.ret
}
...
attributes #3 = { nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
