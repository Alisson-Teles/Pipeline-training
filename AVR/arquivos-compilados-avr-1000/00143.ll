; ModuleID = 'out/00143.rob'
source_filename = "out/00143.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 34)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(34) %_this, i8 0, i64 34, i1 false)
  ret void
}
...
body:
  store i16 7, ptr inttoptr (i16 -28849 to ptr), align 1
  %l_7.f2 = load i64, ptr inttoptr (i16 -28839 to ptr), align 1
  %trunc178 = trunc i64 %l_7.f2 to i32
  ret i32 %trunc178
}
