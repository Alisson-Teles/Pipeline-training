; ModuleID = 'out/00016.rob'
source_filename = "out/00016.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 13)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i64 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 12
...
body:
  %l_37.f2 = load i8, ptr inttoptr (i16 12 to ptr), align 4
  %zext167 = zext i8 %l_37.f2 to i32
  ret i32 %zext167
}
