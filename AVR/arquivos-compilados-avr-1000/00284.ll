; ModuleID = 'out/00284.rob'
source_filename = "out/00284.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 10)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i9 0, ptr %gepf1, align 1
