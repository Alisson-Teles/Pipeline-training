...
body:
  %l_5 = alloca [7 x i32], align 1
  %elem4 = getelementptr inbounds nuw i8, ptr %l_5, i16 16
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(28) %l_5, i8 0, i64 28, i1 false)
  store i32 -10, ptr %l_5, align 1
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_5, i16 4
  store i32 -10, ptr %gep.1, align 1
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_5, i16 8
  store i32 -10, ptr %gep.2, align 1
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_5, i16 12
  store i32 -10, ptr %gep.3, align 1
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_5, i16 16
  store i32 -10, ptr %gep.4, align 1
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_5, i16 20
  store i32 -10, ptr %gep.5, align 1
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_5, i16 24
  store i32 -10, ptr %gep.6, align 1
  %gep82 = getelementptr inbounds nuw i8, ptr %l_5, i16 20
  %gep82.1 = getelementptr inbounds nuw i8, ptr %l_5, i16 16
  %gep82.2 = getelementptr inbounds nuw i8, ptr %l_5, i16 12
  %gep82.3 = getelementptr inbounds nuw i8, ptr %l_5, i16 8
  %l_5148416 = load i32, ptr %l_5, align 1
  %gep129.1 = getelementptr inbounds nuw i8, ptr %l_5, i16 4
  %l_5148.1417 = load i32, ptr %gep129.1, align 1
  %gep129.6 = getelementptr inbounds nuw i8, ptr %l_5, i16 24
  %l_5148.6421 = load i32, ptr %gep129.6, align 1
  br label %phiblock

phiblock:                                         ; preds = %body, %phiblock
  %l_3.0413 = phi i64 [ 0, %body ], [ %binop158, %phiblock ]
  %0 = trunc nuw i64 %l_3.0413 to i16
  %gep69 = getelementptr [7 x i32], ptr %l_5, i16 0, i16 %0
  %l_581 = load i32, ptr %gep69, align 1
  store i32 %l_581, ptr %gep82, align 1
  %l_586 = load i32, ptr %gep69, align 1
  store i32 %l_586, ptr %gep82, align 1
  %l_581.1 = load i32, ptr %gep69, align 1
  store i32 %l_581.1, ptr %gep82.1, align 1
  %l_586.1 = load i32, ptr %gep69, align 1
  store i32 %l_586.1, ptr %gep82.1, align 1
  %l_581.2 = load i32, ptr %gep69, align 1
  store i32 %l_581.2, ptr %gep82.2, align 1
  %l_586.2 = load i32, ptr %gep69, align 1
  store i32 %l_586.2, ptr %gep82.2, align 1
  %l_581.3 = load i32, ptr %gep69, align 1
  store i32 %l_581.3, ptr %gep82.3, align 1
  %l_586.3 = load i32, ptr %gep69, align 1
  store i32 %l_586.3, ptr %gep82.3, align 1
  store i32 %l_5148416, ptr %elem4, align 1
  store i32 %l_5148.1417, ptr %elem4, align 1
  store i32 %l_586.3, ptr %elem4, align 1
  store i32 %l_586.2, ptr %elem4, align 1
  store i32 %l_586, ptr %elem4, align 1
  store i32 %l_5148.6421, ptr %elem4, align 1
  %binop158 = add nuw nsw i64 %l_3.0413, 1
  %cmpi54 = icmp samesign ult i64 %l_3.0413, 6
  br i1 %cmpi54, label %phiblock, label %if_cont370
...
body:
  %l_5.i = alloca [7 x i32], align 1
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call addrspace(1) void @llvm.lifetime.start.p0(i64 28, ptr nonnull %l_5.i)
  %elem4.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 16
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(28) %l_5.i, i8 0, i64 28, i1 false)
  store i32 -10, ptr %l_5.i, align 1
  %gep.1.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 4
  store i32 -10, ptr %gep.1.i, align 1
  %gep.2.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 8
  store i32 -10, ptr %gep.2.i, align 1
  %gep.3.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 12
  store i32 -10, ptr %gep.3.i, align 1
  store i32 -10, ptr %elem4.i, align 1
  %gep.5.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 20
  store i32 -10, ptr %gep.5.i, align 1
  %gep.6.i = getelementptr inbounds nuw i8, ptr %l_5.i, i16 24
  store i32 -10, ptr %gep.6.i, align 1
  br label %phiblock.i

phiblock.i:                                       ; preds = %phiblock.i, %body
  %l_3.0413.i = phi i64 [ 0, %body ], [ %binop158.i, %phiblock.i ]
  %0 = trunc nuw i64 %l_3.0413.i to i16
  %gep69.i = getelementptr [7 x i32], ptr %l_5.i, i16 0, i16 %0
  %l_581.i = load i32, ptr %gep69.i, align 1
  store i32 %l_581.i, ptr %gep.5.i, align 1
  %l_586.i = load i32, ptr %gep69.i, align 1
  store i32 %l_586.i, ptr %gep.5.i, align 1
  %l_581.1.i = load i32, ptr %gep69.i, align 1
  store i32 %l_581.1.i, ptr %elem4.i, align 1
  %l_586.1.i = load i32, ptr %gep69.i, align 1
  store i32 %l_586.1.i, ptr %elem4.i, align 1
  %l_581.2.i = load i32, ptr %gep69.i, align 1
  store i32 %l_581.2.i, ptr %gep.3.i, align 1
  %l_586.2.i = load i32, ptr %gep69.i, align 1
  store i32 %l_586.2.i, ptr %gep.3.i, align 1
  %l_581.3.i = load i32, ptr %gep69.i, align 1
  store i32 %l_581.3.i, ptr %gep.2.i, align 1
  %l_586.3.i = load i32, ptr %gep69.i, align 1
  store i32 %l_586.3.i, ptr %gep.2.i, align 1
  store i32 -10, ptr %elem4.i, align 1
  %binop158.i = add nuw nsw i64 %l_3.0413.i, 1
  %cmpi54.i = icmp samesign ult i64 %l_3.0413.i, 6
  br i1 %cmpi54.i, label %phiblock.i, label %func_1.exit

func_1.exit:                                      ; preds = %phiblock.i
  call addrspace(1) void @llvm.lifetime.end.p0(i64 28, ptr nonnull %l_5.i)
