; ModuleID = 'out/01051.rob'
source_filename = "out/01051.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(18) %_this, i8 0, i64 18, i1 false)
  ret void
}
...
define noundef zeroext i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  store i16 0, ptr inttoptr (i16 14 to ptr), align 2
  store i8 26, ptr inttoptr (i16 8 to ptr), align 8
  store i16 0, ptr inttoptr (i16 14 to ptr), align 2
  store i8 26, ptr inttoptr (i16 8 to ptr), align 8
  store i16 0, ptr inttoptr (i16 14 to ptr), align 2
  store i8 26, ptr inttoptr (i16 8 to ptr), align 8
