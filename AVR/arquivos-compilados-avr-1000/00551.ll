; ModuleID = 'out/00551.rob'
source_filename = "out/00551.rob"
...
define noundef range(i32 -32768, 32768) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_8 = alloca [8 x i32], align 1
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %l_8, i8 0, i64 32, i1 false)
  store i32 -714950252, ptr %l_8, align 1
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 -714950252, ptr %gep.1, align 1
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 -714950252, ptr %gep.2, align 1
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 -714950252, ptr %gep.3, align 1
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 -714950252, ptr %gep.4, align 1
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 -714950252, ptr %gep.5, align 1
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 -714950252, ptr %gep.6, align 1
  %gep.7 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 -714950252, ptr %gep.7, align 1
  store i32 1, ptr %l_8, align 1
  br label %while_body26

while_body26:                                     ; preds = %body, %while_body26
  %l_2.0353 = phi i8 [ 7, %body ], [ %binop109, %while_body26 ]
  %0 = zext nneg i8 %l_2.0353 to i16
  %gep29 = getelementptr [0 x i32], ptr %l_8, i16 0, i16 %0
  store i32 888, ptr %gep29, align 1
  %gep68 = getelementptr [8 x i32], ptr %l_8, i16 0, i16 %0
  %l_869 = load i32, ptr %gep68, align 1
  store i32 %l_869, ptr %gep29, align 1
  %l_869.1 = load i32, ptr %gep68, align 1
  store i32 %l_869.1, ptr %gep29, align 1
  %l_869.2 = load i32, ptr %gep68, align 1
  store i32 %l_869.2, ptr %gep29, align 1
  %l_869.3 = load i32, ptr %gep68, align 1
  store i32 %l_869.3, ptr %gep29, align 1
  %l_869.4 = load i32, ptr %gep68, align 1
  store i32 %l_869.4, ptr %gep29, align 1
  %l_869.5 = load i32, ptr %gep68, align 1
  store i32 %l_869.5, ptr %gep29, align 1
  %l_869.6 = load i32, ptr %gep68, align 1
  store i32 %l_869.6, ptr %gep29, align 1
  %binop109 = add nsw i8 %l_2.0353, -1
  %cmpi25 = icmp ugt i8 %l_2.0353, 1
  br i1 %cmpi25, label %while_body26, label %while_body168

while_body168:                                    ; preds = %while_body26
  %elem1 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  %gep183 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183, align 1
  %gep183.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1, align 1
  %gep183.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2, align 1
  %gep183.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3, align 1
  %gep183.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4, align 1
  %gep183.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5, align 1
  %gep183.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6, align 1
  %gep183.1356 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.1356, align 1
  %gep183.1.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.1, align 1
  %gep183.2.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.1, align 1
  %gep183.3.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.1, align 1
  %gep183.4.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.1, align 1
  %gep183.5.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.1, align 1
  %gep183.6.1 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.1, align 1
  %gep183.2357 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.2357, align 1
  %gep183.1.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.2, align 1
  %gep183.2.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.2, align 1
  %gep183.3.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.2, align 1
  %gep183.4.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.2, align 1
  %gep183.5.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.2, align 1
  %gep183.6.2 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.2, align 1
  %gep183.3358 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.3358, align 1
  %gep183.1.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.3, align 1
  %gep183.2.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.3, align 1
  %gep183.3.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.3, align 1
  %gep183.4.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.3, align 1
  %gep183.5.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.3, align 1
  %gep183.6.3 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.3, align 1
  %gep183.4359 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.4359, align 1
  %gep183.1.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.4, align 1
  %gep183.2.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.4, align 1
  %gep183.3.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.4, align 1
  %gep183.4.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.4, align 1
  %gep183.5.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.4, align 1
  %gep183.6.4 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.4, align 1
  %gep183.5360 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.5360, align 1
  %gep183.1.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.5, align 1
  %gep183.2.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.5, align 1
  %gep183.3.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.5, align 1
  %gep183.4.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.5, align 1
  %gep183.5.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.5, align 1
  %gep183.6.5 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.5, align 1
  %gep183.6361 = getelementptr inbounds nuw i8, ptr %l_8, i16 4
  store i32 1, ptr %gep183.6361, align 1
  %gep183.1.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 8
  store i32 1, ptr %gep183.1.6, align 1
  %gep183.2.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 12
  store i32 1, ptr %gep183.2.6, align 1
  %gep183.3.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 16
  store i32 1, ptr %gep183.3.6, align 1
  %gep183.4.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 20
  store i32 1, ptr %gep183.4.6, align 1
  %gep183.5.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 24
  store i32 1, ptr %gep183.5.6, align 1
  %gep183.6.6 = getelementptr inbounds nuw i8, ptr %l_8, i16 28
  store i32 1, ptr %gep183.6.6, align 1
  %l_8252.6 = load i32, ptr %elem1, align 1
  %binop261.6 = or i32 %l_8252.6, 138
  store i32 %binop261.6, ptr %elem1, align 1
  store i32 0, ptr %l_8, align 1
  ret i32 8
}
