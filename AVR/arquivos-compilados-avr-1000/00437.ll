...
body:
  %l_6 = alloca [7 x i64], align 1
  store i64 -944809224, ptr %l_6, align 1
  %elem1 = getelementptr inbounds nuw i8, ptr %l_6, i16 8
  store i64 1477263725, ptr %elem1, align 1
  %elem2 = getelementptr inbounds nuw i8, ptr %l_6, i16 16
  store i64 3350158072, ptr %elem2, align 1
  %elem3 = getelementptr inbounds nuw i8, ptr %l_6, i16 24
  store i64 3350158072, ptr %elem3, align 1
  %elem4 = getelementptr inbounds nuw i8, ptr %l_6, i16 32
  store i64 1477263725, ptr %elem4, align 1
  %elem5 = getelementptr inbounds nuw i8, ptr %l_6, i16 40
  store i64 3350158072, ptr %elem5, align 1
  %elem6 = getelementptr inbounds nuw i8, ptr %l_6, i16 48
  store i64 3350158072, ptr %elem6, align 1
  store i64 -944809224, ptr %l_6, align 1
  br label %while_cond16.preheader

while_cond16.preheader:                           ; preds = %body, %safe_lshift_func_uint16_t_u_s.exit
  %l_5.0156 = phi i64 [ 0, %body ], [ %binop142, %safe_lshift_func_uint16_t_u_s.exit ]
  %0 = trunc i64 %l_5.0156 to i16
  %gep35 = getelementptr [7 x i64], ptr %l_6, i16 0, i16 %0
  br label %while_cond24.preheader

while_end:                                        ; preds = %safe_lshift_func_uint16_t_u_s.exit
  ret i64 7

while_cond24.preheader:                           ; preds = %while_cond16.preheader, %phiblock75.6
  %l_4.0155 = phi i32 [ 6, %while_cond16.preheader ], [ %binop129, %phiblock75.6 ]
  %1 = trunc i32 %l_4.0155 to i16
  %gep71 = getelementptr [7 x i64], ptr %l_6, i16 0, i16 %1
  %gep83 = getelementptr [0 x i64], ptr %l_6, i16 0, i16 %1
  %l_672 = load i64, ptr %gep71, align 1
  %cmpi73.not = icmp eq i64 %l_672, 0
  br i1 %cmpi73.not, label %phiblock75, label %fullev74

while_end20:                                      ; preds = %phiblock75.6
  %2 = trunc i64 %l_5.0156 to i16
  %gep132 = getelementptr [7 x i64], ptr %l_6, i16 0, i16 %2
  %l_6133 = load i64, ptr %gep132, align 1
  %3 = and i64 %l_6133, 4294967280
  %phi.i.not = icmp eq i64 %3, 0
  br i1 %phi.i.not, label %fullev6.i, label %safe_lshift_func_uint16_t_u_s.exit

fullev6.i:                                        ; preds = %while_end20
  ...
  %spec.select = select i1 %cmpi11.i, i16 31861, i16 %binop17.i
  br label %safe_lshift_func_uint16_t_u_s.exit

safe_lshift_func_uint16_t_u_s.exit:               ; preds = %fullev6.i, %while_end20
  %common.ret.op.i = phi i16 [ 31861, %while_end20 ], [ %spec.select, %fullev6.i ]
  %zext135 = zext i16 %common.ret.op.i to i64
  %gep136 = getelementptr [0 x i64], ptr %l_6, i16 0, i16 %2
  store i64 %zext135, ptr %gep136, align 1
  %l_6139 = load i64, ptr %gep132, align 1
  store i64 %l_6139, ptr %l_6, align 1
...
fullev74:                                         ; preds = %while_cond24.preheader
  %l_679 = load i64, ptr %gep35, align 1
...
phiblock75.6:                                     ; preds = %fullev74.6, %phiblock75.5
  ...
  store i64 %zext82.6, ptr %gep83, align 1
  store i64 1, ptr %elem1, align 1
  %binop129 = add nsw i32 %l_4.0155, -1
  %cmpi18 = icmp ugt i32 %l_4.0155, 1
  br i1 %cmpi18, label %while_cond24.preheader, label %while_end20
}
