; ModuleID = 'out/00844.rob'
source_filename = "out/00844.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 7)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 1
  store i32 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 5
  store i16 0, ptr %gepf2, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 1)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S2:init"(ptr nocapture writeonly initializes((0, 2)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S3:init"(ptr nocapture writeonly initializes((0, 10)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i25 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 4
  store i28 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 8
  store i12 0, ptr %gepf2, align 1
  ret void
}
...
define %S1 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret %S1 { i8 -4 }
}
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
