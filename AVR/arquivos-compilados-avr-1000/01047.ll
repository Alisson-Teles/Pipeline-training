; ModuleID = 'out/01047.rob'
source_filename = "out/01047.rob"
...
body:
  br label %while_cond230.preheader

while_cond230.preheader:                          ; preds = %body, %while_cond230.preheader
  %l_2.3328.off0 = phi i8 [ 18, %body ], [ %spec.select.i, %while_cond230.preheader ]
  %cmpi.i = icmp slt i8 %l_2.3328.off0, 0
  %binop.i = add i8 %l_2.3328.off0, -7
  %spec.select.i = select i1 %cmpi.i, i8 %l_2.3328.off0, i8 %binop.i
  %cmpi212.not = icmp eq i8 %spec.select.i, -24
  br i1 %cmpi212.not, label %while_cond230.preheader.1, label %while_cond230.preheader

while_cond230.preheader.1:                        ; preds = %while_cond230.preheader, %while_cond230.preheader.1
  %l_2.3328.off0.1 = phi i8 [ %spec.select.i.1, %while_cond230.preheader.1 ], [ 18, %while_cond230.preheader ]
  %cmpi.i.1 = icmp slt i8 %l_2.3328.off0.1, 0
  %binop.i.1 = add i8 %l_2.3328.off0.1, -7
  %spec.select.i.1 = select i1 %cmpi.i.1, i8 %l_2.3328.off0.1, i8 %binop.i.1
  %cmpi212.not.1 = icmp eq i8 %spec.select.i.1, -24
  br i1 %cmpi212.not.1, label %while_cond230.preheader.2, label %while_cond230.preheader.1

while_cond230.preheader.2:                        ; preds = %while_cond230.preheader.1, %while_cond230.preheader.2
  %l_2.3328.off0.2 = phi i8 [ %spec.select.i.2, %while_cond230.preheader.2 ], [ 18, %while_cond230.preheader.1 ]
  %cmpi.i.2 = icmp slt i8 %l_2.3328.off0.2, 0
  %binop.i.2 = add i8 %l_2.3328.off0.2, -7
  %spec.select.i.2 = select i1 %cmpi.i.2, i8 %l_2.3328.off0.2, i8 %binop.i.2
  %cmpi212.not.2 = icmp eq i8 %spec.select.i.2, -24
  br i1 %cmpi212.not.2, label %while_cond230.preheader.3, label %while_cond230.preheader.2

while_cond230.preheader.3:                        ; preds = %while_cond230.preheader.2, %while_cond230.preheader.3
  %l_2.3328.off0.3 = phi i8 [ %spec.select.i.3, %while_cond230.preheader.3 ], [ 18, %while_cond230.preheader.2 ]
  %cmpi.i.3 = icmp slt i8 %l_2.3328.off0.3, 0
  %binop.i.3 = add i8 %l_2.3328.off0.3, -7
  %spec.select.i.3 = select i1 %cmpi.i.3, i8 %l_2.3328.off0.3, i8 %binop.i.3
  %cmpi212.not.3 = icmp eq i8 %spec.select.i.3, -24
  br i1 %cmpi212.not.3, label %while_cond230.preheader.4, label %while_cond230.preheader.3

while_cond230.preheader.4:                        ; preds = %while_cond230.preheader.3, %while_cond230.preheader.4
  %l_2.3328.off0.4 = phi i8 [ %spec.select.i.4, %while_cond230.preheader.4 ], [ 18, %while_cond230.preheader.3 ]
  %cmpi.i.4 = icmp slt i8 %l_2.3328.off0.4, 0
  %binop.i.4 = add i8 %l_2.3328.off0.4, -7
  %spec.select.i.4 = select i1 %cmpi.i.4, i8 %l_2.3328.off0.4, i8 %binop.i.4
  %cmpi212.not.4 = icmp eq i8 %spec.select.i.4, -24
  br i1 %cmpi212.not.4, label %while_cond230.preheader.5, label %while_cond230.preheader.4

while_cond230.preheader.5:                        ; preds = %while_cond230.preheader.4, %while_cond230.preheader.5
  %l_2.3328.off0.5 = phi i8 [ %spec.select.i.5, %while_cond230.preheader.5 ], [ 18, %while_cond230.preheader.4 ]
  %cmpi.i.5 = icmp slt i8 %l_2.3328.off0.5, 0
  %binop.i.5 = add i8 %l_2.3328.off0.5, -7
  %spec.select.i.5 = select i1 %cmpi.i.5, i8 %l_2.3328.off0.5, i8 %binop.i.5
  %cmpi212.not.5 = icmp eq i8 %spec.select.i.5, -24
  br i1 %cmpi212.not.5, label %while_cond230.preheader.6, label %while_cond230.preheader.5

while_cond230.preheader.6:                        ; preds = %while_cond230.preheader.5, %while_cond230.preheader.6
  %l_2.3328.off0.6 = phi i8 [ %spec.select.i.6, %while_cond230.preheader.6 ], [ 18, %while_cond230.preheader.5 ]
  %cmpi.i.6 = icmp slt i8 %l_2.3328.off0.6, 0
  %binop.i.6 = add i8 %l_2.3328.off0.6, -7
  %spec.select.i.6 = select i1 %cmpi.i.6, i8 %l_2.3328.off0.6, i8 %binop.i.6
  %cmpi212.not.6 = icmp eq i8 %spec.select.i.6, -24
  br i1 %cmpi212.not.6, label %while_cond230.preheader.7, label %while_cond230.preheader.6

while_cond230.preheader.7:                        ; preds = %while_cond230.preheader.6, %while_cond230.preheader.7
  %l_2.3328.off0.7 = phi i8 [ %spec.select.i.7, %while_cond230.preheader.7 ], [ 18, %while_cond230.preheader.6 ]
  %cmpi.i.7 = icmp slt i8 %l_2.3328.off0.7, 0
  %binop.i.7 = add i8 %l_2.3328.off0.7, -7
  %spec.select.i.7 = select i1 %cmpi.i.7, i8 %l_2.3328.off0.7, i8 %binop.i.7
  %cmpi212.not.7 = icmp eq i8 %spec.select.i.7, -24
  br i1 %cmpi212.not.7, label %while_cond230.preheader.8, label %while_cond230.preheader.7

while_cond230.preheader.8:                        ; preds = %while_cond230.preheader.7, %while_cond230.preheader.8
  %l_2.3328.off0.8 = phi i8 [ %spec.select.i.8, %while_cond230.preheader.8 ], [ 18, %while_cond230.preheader.7 ]
  %cmpi.i.8 = icmp slt i8 %l_2.3328.off0.8, 0
  %binop.i.8 = add i8 %l_2.3328.off0.8, -7
  %spec.select.i.8 = select i1 %cmpi.i.8, i8 %l_2.3328.off0.8, i8 %binop.i.8
  %cmpi212.not.8 = icmp eq i8 %spec.select.i.8, -24
  br i1 %cmpi212.not.8, label %while_end214.8, label %while_cond230.preheader.8

while_end214.8:                                   ; preds = %while_cond230.preheader.8
  ret i32 9
}
...
body:
  ...
  br label %while_cond230.preheader.i

while_cond230.preheader.i:                        ; preds = %while_cond230.preheader.i, %body
  %l_2.3328.off0.i = phi i8 [ 18, %body ], [ %spec.select.i.i, %while_cond230.preheader.i ]
  %cmpi.i.i = icmp slt i8 %l_2.3328.off0.i, 0
  %binop.i.i = add i8 %l_2.3328.off0.i, -7
  %spec.select.i.i = select i1 %cmpi.i.i, i8 %l_2.3328.off0.i, i8 %binop.i.i
  %cmpi212.not.i = icmp eq i8 %spec.select.i.i, -24
  br i1 %cmpi212.not.i, label %while_cond230.preheader.i.1, label %while_cond230.preheader.i

while_cond230.preheader.i.1:                      ; preds = %while_cond230.preheader.i, %while_cond230.preheader.i.1
  %l_2.3328.off0.i.1 = phi i8 [ %spec.select.i.i.1, %while_cond230.preheader.i.1 ], [ 18, %while_cond230.preheader.i ]
  %cmpi.i.i.1 = icmp slt i8 %l_2.3328.off0.i.1, 0
  %binop.i.i.1 = add i8 %l_2.3328.off0.i.1, -7
  %spec.select.i.i.1 = select i1 %cmpi.i.i.1, i8 %l_2.3328.off0.i.1, i8 %binop.i.i.1
  %cmpi212.not.i.1 = icmp eq i8 %spec.select.i.i.1, -24
  br i1 %cmpi212.not.i.1, label %while_cond230.preheader.i.2, label %while_cond230.preheader.i.1

while_cond230.preheader.i.2:                      ; preds = %while_cond230.preheader.i.1, %while_cond230.preheader.i.2
  %l_2.3328.off0.i.2 = phi i8 [ %spec.select.i.i.2, %while_cond230.preheader.i.2 ], [ 18, %while_cond230.preheader.i.1 ]
  %cmpi.i.i.2 = icmp slt i8 %l_2.3328.off0.i.2, 0
  %binop.i.i.2 = add i8 %l_2.3328.off0.i.2, -7
  %spec.select.i.i.2 = select i1 %cmpi.i.i.2, i8 %l_2.3328.off0.i.2, i8 %binop.i.i.2
  %cmpi212.not.i.2 = icmp eq i8 %spec.select.i.i.2, -24
  br i1 %cmpi212.not.i.2, label %while_cond230.preheader.i.3, label %while_cond230.preheader.i.2

while_cond230.preheader.i.3:                      ; preds = %while_cond230.preheader.i.2, %while_cond230.preheader.i.3
  %l_2.3328.off0.i.3 = phi i8 [ %spec.select.i.i.3, %while_cond230.preheader.i.3 ], [ 18, %while_cond230.preheader.i.2 ]
  %cmpi.i.i.3 = icmp slt i8 %l_2.3328.off0.i.3, 0
  %binop.i.i.3 = add i8 %l_2.3328.off0.i.3, -7
  %spec.select.i.i.3 = select i1 %cmpi.i.i.3, i8 %l_2.3328.off0.i.3, i8 %binop.i.i.3
  %cmpi212.not.i.3 = icmp eq i8 %spec.select.i.i.3, -24
  br i1 %cmpi212.not.i.3, label %while_cond230.preheader.i.4, label %while_cond230.preheader.i.3

while_cond230.preheader.i.4:                      ; preds = %while_cond230.preheader.i.3, %while_cond230.preheader.i.4
  %l_2.3328.off0.i.4 = phi i8 [ %spec.select.i.i.4, %while_cond230.preheader.i.4 ], [ 18, %while_cond230.preheader.i.3 ]
  %cmpi.i.i.4 = icmp slt i8 %l_2.3328.off0.i.4, 0
  %binop.i.i.4 = add i8 %l_2.3328.off0.i.4, -7
  %spec.select.i.i.4 = select i1 %cmpi.i.i.4, i8 %l_2.3328.off0.i.4, i8 %binop.i.i.4
  %cmpi212.not.i.4 = icmp eq i8 %spec.select.i.i.4, -24
  br i1 %cmpi212.not.i.4, label %while_cond230.preheader.i.5, label %while_cond230.preheader.i.4

while_cond230.preheader.i.5:                      ; preds = %while_cond230.preheader.i.4, %while_cond230.preheader.i.5
  %l_2.3328.off0.i.5 = phi i8 [ %spec.select.i.i.5, %while_cond230.preheader.i.5 ], [ 18, %while_cond230.preheader.i.4 ]
  %cmpi.i.i.5 = icmp slt i8 %l_2.3328.off0.i.5, 0
  %binop.i.i.5 = add i8 %l_2.3328.off0.i.5, -7
  %spec.select.i.i.5 = select i1 %cmpi.i.i.5, i8 %l_2.3328.off0.i.5, i8 %binop.i.i.5
  %cmpi212.not.i.5 = icmp eq i8 %spec.select.i.i.5, -24
  br i1 %cmpi212.not.i.5, label %while_cond230.preheader.i.6, label %while_cond230.preheader.i.5

while_cond230.preheader.i.6:                      ; preds = %while_cond230.preheader.i.5, %while_cond230.preheader.i.6
  %l_2.3328.off0.i.6 = phi i8 [ %spec.select.i.i.6, %while_cond230.preheader.i.6 ], [ 18, %while_cond230.preheader.i.5 ]
  %cmpi.i.i.6 = icmp slt i8 %l_2.3328.off0.i.6, 0
  %binop.i.i.6 = add i8 %l_2.3328.off0.i.6, -7
  %spec.select.i.i.6 = select i1 %cmpi.i.i.6, i8 %l_2.3328.off0.i.6, i8 %binop.i.i.6
  %cmpi212.not.i.6 = icmp eq i8 %spec.select.i.i.6, -24
  br i1 %cmpi212.not.i.6, label %while_cond230.preheader.i.7, label %while_cond230.preheader.i.6

while_cond230.preheader.i.7:                      ; preds = %while_cond230.preheader.i.6, %while_cond230.preheader.i.7
  %l_2.3328.off0.i.7 = phi i8 [ %spec.select.i.i.7, %while_cond230.preheader.i.7 ], [ 18, %while_cond230.preheader.i.6 ]
  %cmpi.i.i.7 = icmp slt i8 %l_2.3328.off0.i.7, 0
  %binop.i.i.7 = add i8 %l_2.3328.off0.i.7, -7
  %spec.select.i.i.7 = select i1 %cmpi.i.i.7, i8 %l_2.3328.off0.i.7, i8 %binop.i.i.7
  %cmpi212.not.i.7 = icmp eq i8 %spec.select.i.i.7, -24
  br i1 %cmpi212.not.i.7, label %while_cond230.preheader.i.8, label %while_cond230.preheader.i.7

while_cond230.preheader.i.8:                      ; preds = %while_cond230.preheader.i.7, %while_cond230.preheader.i.8
  %l_2.3328.off0.i.8 = phi i8 [ %spec.select.i.i.8, %while_cond230.preheader.i.8 ], [ 18, %while_cond230.preheader.i.7 ]
  %cmpi.i.i.8 = icmp slt i8 %l_2.3328.off0.i.8, 0
  %binop.i.i.8 = add i8 %l_2.3328.off0.i.8, -7
  %spec.select.i.i.8 = select i1 %cmpi.i.i.8, i8 %l_2.3328.off0.i.8, i8 %binop.i.i.8
  %cmpi212.not.i.8 = icmp eq i8 %spec.select.i.i.8, -24
  br i1 %cmpi212.not.i.8, label %while_end214.i.8, label %while_cond230.preheader.i.8

while_end214.i.8:                                 ; preds = %while_cond230.preheader.i.8
