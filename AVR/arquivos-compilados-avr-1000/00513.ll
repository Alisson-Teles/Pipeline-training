...
body:
  %l_3 = alloca [9 x i32], align 1
  %elem9 = getelementptr inbounds nuw i8, ptr %l_3, i16 4
  %elem10 = getelementptr inbounds nuw i8, ptr %l_3, i16 8
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(36) %l_3, i8 0, i64 36, i1 false)
  store i32 -1475292643, ptr %l_3, align 1
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_3, i16 4
  store i32 -1475292643, ptr %gep.1, align 1
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_3, i16 8
  store i32 -1475292643, ptr %gep.2, align 1
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_3, i16 12
  store i32 -1475292643, ptr %gep.3, align 1
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_3, i16 16
  store i32 -1475292643, ptr %gep.4, align 1
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_3, i16 20
  store i32 -1475292643, ptr %gep.5, align 1
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_3, i16 24
  store i32 -1475292643, ptr %gep.6, align 1
  %gep.7 = getelementptr inbounds nuw i8, ptr %l_3, i16 28
  store i32 -1475292643, ptr %gep.7, align 1
  %gep.8 = getelementptr inbounds nuw i8, ptr %l_3, i16 32
  store i32 -1475292643, ptr %gep.8, align 1
  store i32 1, ptr %elem9, align 1
  br label %while_cond478.preheader

while_cond478.preheader:                          ; preds = %body, %while_end613
  %l_70.3795 = phi i32 [ 2, %body ], [ %binop36.i, %while_end613 ]
  br label %while_cond485.preheader

while_end477:                                     ; preds = %while_end613
  ret i32 0

while_cond485.preheader:                          ; preds = %while_cond478.preheader, %while_cond485.preheader
  %l_30.3794 = phi i32 [ 0, %while_cond478.preheader ], [ %binop533, %while_cond485.preheader ]
  %0 = trunc nuw i32 %l_30.3794 to i16
  %1 = add nuw nsw i16 %0, 1
  %gep502 = getelementptr [9 x i32], ptr %l_3, i16 0, i16 %1
  %l_3503 = load i32, ptr %gep502, align 1
  %binop504 = or i32 %l_3503, -1525273803
  %binop.i779 = add i32 %binop504, %l_3503
  store i32 %binop.i779, ptr %elem10, align 1
  %l_3503.1 = load i32, ptr %gep502, align 1
  %binop504.1 = or i32 %l_3503.1, %binop504
  %binop.i779.1 = add i32 %binop504.1, %l_3503.1
  store i32 %binop.i779.1, ptr %elem10, align 1
  %l_3503.2 = load i32, ptr %gep502, align 1
  %binop504.2 = or i32 %l_3503.2, %binop504.1
  %binop.i779.2 = add i32 %binop504.2, %l_3503.2
  store i32 %binop.i779.2, ptr %elem10, align 1
  %l_3503.3 = load i32, ptr %gep502, align 1
  %binop504.3 = or i32 %l_3503.3, %binop504.2
  %binop.i779.3 = add i32 %binop504.3, %l_3503.3
  store i32 %binop.i779.3, ptr %elem10, align 1
  %l_3503.4 = load i32, ptr %gep502, align 1
  %binop504.4 = or i32 %l_3503.4, %binop504.3
  %binop.i779.4 = add i32 %binop504.4, %l_3503.4
  store i32 %binop.i779.4, ptr %elem10, align 1
  %l_3503.5 = load i32, ptr %gep502, align 1
  %binop504.5 = or i32 %l_3503.5, %binop504.4
  %binop.i779.5 = add i32 %binop504.5, %l_3503.5
  store i32 %binop.i779.5, ptr %elem10, align 1
  %binop533 = add nuw nsw i32 %l_30.3794, 1
  %cmpi480 = icmp samesign ult i32 %l_30.3794, 7
  br i1 %cmpi480, label %while_cond485.preheader, label %while_end613

while_end613:                                     ; preds = %while_cond485.preheader
  %binop36.i = add nuw nsw i32 %l_70.3795, 3
...
body:
  %l_3.i = alloca [9 x i32], align 1
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call addrspace(1) void @llvm.lifetime.start.p0(i64 36, ptr nonnull %l_3.i)
  %elem9.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 4
  %elem10.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 8
  call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(36) %l_3.i, i8 0, i64 36, i1 false)
  store i32 -1475292643, ptr %l_3.i, align 1
  store i32 -1475292643, ptr %elem9.i, align 1
  store i32 -1475292643, ptr %elem10.i, align 1
  %gep.3.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 12
  store i32 -1475292643, ptr %gep.3.i, align 1
  %gep.4.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 16
  store i32 -1475292643, ptr %gep.4.i, align 1
  %gep.5.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 20
  store i32 -1475292643, ptr %gep.5.i, align 1
  %gep.6.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 24
  store i32 -1475292643, ptr %gep.6.i, align 1
  %gep.7.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 28
  store i32 -1475292643, ptr %gep.7.i, align 1
  %gep.8.i = getelementptr inbounds nuw i8, ptr %l_3.i, i16 32
  store i32 -1475292643, ptr %gep.8.i, align 1
  store i32 1, ptr %elem9.i, align 1
  br label %while_cond478.preheader.i

while_cond478.preheader.i:                        ; preds = %while_end613.i, %body
  %l_70.3795.i = phi i32 [ 2, %body ], [ %binop36.i.i, %while_end613.i ]
  br label %while_cond485.preheader.i

while_cond485.preheader.i:                        ; preds = %while_cond485.preheader.i, %while_cond478.preheader.i
  %l_30.3794.i = phi i32 [ 0, %while_cond478.preheader.i ], [ %binop533.i, %while_cond485.preheader.i ]
  %0 = trunc nuw i32 %l_30.3794.i to i16
  %1 = add nuw nsw i16 %0, 1
  %gep502.i = getelementptr [9 x i32], ptr %l_3.i, i16 0, i16 %1
  %l_3503.i = load i32, ptr %gep502.i, align 1
  %binop504.i = or i32 %l_3503.i, -1525273803
  %binop.i779.i = add i32 %binop504.i, %l_3503.i
  store i32 %binop.i779.i, ptr %elem10.i, align 1
  %l_3503.1.i = load i32, ptr %gep502.i, align 1
  %binop504.1.i = or i32 %l_3503.1.i, %binop504.i
  %binop.i779.1.i = add i32 %binop504.1.i, %l_3503.1.i
  store i32 %binop.i779.1.i, ptr %elem10.i, align 1
  %l_3503.2.i = load i32, ptr %gep502.i, align 1
  %binop504.2.i = or i32 %l_3503.2.i, %binop504.1.i
  %binop.i779.2.i = add i32 %binop504.2.i, %l_3503.2.i
  store i32 %binop.i779.2.i, ptr %elem10.i, align 1
  %l_3503.3.i = load i32, ptr %gep502.i, align 1
  %binop504.3.i = or i32 %l_3503.3.i, %binop504.2.i
  %binop.i779.3.i = add i32 %binop504.3.i, %l_3503.3.i
  store i32 %binop.i779.3.i, ptr %elem10.i, align 1
  %l_3503.4.i = load i32, ptr %gep502.i, align 1
  %binop504.4.i = or i32 %l_3503.4.i, %binop504.3.i
  %binop.i779.4.i = add i32 %binop504.4.i, %l_3503.4.i
  store i32 %binop.i779.4.i, ptr %elem10.i, align 1
  %l_3503.5.i = load i32, ptr %gep502.i, align 1
  %binop504.5.i = or i32 %l_3503.5.i, %binop504.4.i
  %binop.i779.5.i = add i32 %binop504.5.i, %l_3503.5.i
  store i32 %binop.i779.5.i, ptr %elem10.i, align 1
  %binop533.i = add nuw nsw i32 %l_30.3794.i, 1
  %cmpi480.i = icmp samesign ult i32 %l_30.3794.i, 7
  br i1 %cmpi480.i, label %while_cond485.preheader.i, label %while_end613.i

while_end613.i:                                   ; preds = %while_cond485.preheader.i
  %binop36.i.i = add nuw nsw i32 %l_70.3795.i, 3
  %cmpi475.not.i = icmp eq i32 %binop36.i.i, 56
  br i1 %cmpi475.not.i, label %func_1.exit, label %while_cond478.preheader.i

func_1.exit:                                      ; preds = %while_end613.i
  call addrspace(1) void @llvm.lifetime.end.p0(i64 36, ptr nonnull %l_3.i)
...
declare void @llvm.lifetime.start.p0(i64 immarg, ptr nocapture) addrspace(1) #4

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: readwrite)
declare void @llvm.lifetime.end.p0(i64 immarg, ptr nocapture) addrspace(1) #4
