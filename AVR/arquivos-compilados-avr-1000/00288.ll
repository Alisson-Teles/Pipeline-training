...
while_body242:                                    ; preds = %body, %while_body242
  %l_8.3437.off0 = phi i8 [ 3, %body ], [ %spec.select.i, %while_body242 ]
  %cmpi.i = icmp slt i8 %l_8.3437.off0, 0
  %binop.i = add i8 %l_8.3437.off0, -5
  %spec.select.i = select i1 %cmpi.i, i8 %l_8.3437.off0, i8 %binop.i
  %cmpi241 = icmp sgt i8 %spec.select.i, -26
  br i1 %cmpi241, label %while_body242, label %if_cont377

if_cont377:                                       ; preds = %while_body242
  ret i32 0
}
...
while_body242.i:                                  ; preds = %while_body242.i, %body
  %l_8.3437.off0.i = phi i8 [ 3, %body ], [ %spec.select.i.i, %while_body242.i ]
  %cmpi.i.i = icmp slt i8 %l_8.3437.off0.i, 0
  %binop.i.i = add i8 %l_8.3437.off0.i, -5
  %spec.select.i.i = select i1 %cmpi.i.i, i8 %l_8.3437.off0.i, i8 %binop.i.i
  %cmpi241.i = icmp sgt i8 %spec.select.i.i, -26
  br i1 %cmpi241.i, label %while_body242.i, label %func_1.exit

func_1.exit:                                      ; preds = %while_body242.i
