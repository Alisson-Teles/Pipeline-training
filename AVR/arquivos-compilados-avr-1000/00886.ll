...
body:
  %l_33 = alloca [9 x i64], align 1
  store i64 -1169544082, ptr %l_33, align 1
  %elem1 = getelementptr inbounds nuw i8, ptr %l_33, i16 8
  store i64 875278821, ptr %elem1, align 1
  %elem2 = getelementptr inbounds nuw i8, ptr %l_33, i16 16
  store i64 3125423214, ptr %elem2, align 1
  %elem3 = getelementptr inbounds nuw i8, ptr %l_33, i16 24
  store i64 3125423214, ptr %elem3, align 1
  %elem4 = getelementptr inbounds nuw i8, ptr %l_33, i16 32
  store i64 875278821, ptr %elem4, align 1
  %elem5 = getelementptr inbounds nuw i8, ptr %l_33, i16 40
  store i64 3125423214, ptr %elem5, align 1
  %elem6 = getelementptr inbounds nuw i8, ptr %l_33, i16 48
  store i64 3125423214, ptr %elem6, align 1
  %elem7 = getelementptr inbounds nuw i8, ptr %l_33, i16 56
  store i64 875278821, ptr %elem7, align 1
  %elem8 = getelementptr inbounds nuw i8, ptr %l_33, i16 64
  store i64 3125423214, ptr %elem8, align 1
  br label %while_cond12.preheader

while_cond12.preheader:                           ; preds = %body, %while_cond12.preheader
  %l_2.0624.off0 = phi i8 [ 0, %body ], [ %spec.select.i, %while_cond12.preheader ]
  %cmpi.i450 = icmp sgt i8 %l_2.0624.off0, -1
  %binop.i = sext i1 %cmpi.i450 to i8
  %spec.select.i = add i8 %l_2.0624.off0, %binop.i
  %cmpi.not = icmp eq i8 %spec.select.i, -8
  br i1 %cmpi.not, label %while_body183, label %while_cond12.preheader

while_body183:                                    ; preds = %while_cond12.preheader, %if_else376
  %l_2.1630 = phi i32 [ %binop447, %if_else376 ], [ 3, %while_cond12.preheader ]
  %0 = trunc i32 %l_2.1630 to i16
  %gep187 = getelementptr [9 x i64], ptr %l_33, i16 0, i16 %0
...
while_cond196.preheader:                          ; preds = %while_body183, %while_body226
  %l_15.6629 = phi i32 [ 8, %while_body183 ], [ %binop295, %while_body226 ]
  %1 = trunc i32 %l_15.6629 to i16
  %gep206 = getelementptr [9 x i64], ptr %l_33, i16 0, i16 %1
  %gep210 = getelementptr [0 x i64], ptr %l_33, i16 0, i16 %1
  br label %while_body199

while_end195:                                     ; preds = %while_body226
  %l_33298 = load i64, ptr %gep187, align 1
  %2 = and i64 %l_33298, 4294967264
  %cmpi.i605 = icmp ne i64 %2, 0
  %l_33311 = load i64, ptr %elem2, align 1
  %cmpi312.not = icmp eq i64 %l_33311, 0
  %or.cond = select i1 %cmpi.i605, i1 true, i1 %cmpi312.not
  br i1 %or.cond, label %if_else376, label %while_body362

while_body199:                                    ; preds = %while_cond196.preheader, %while_body199
  %l_30.3626 = phi i32 [ 0, %while_cond196.preheader ], [ %binop222, %while_body199 ]
  %l_33204 = load i64, ptr %gep187, align 1
  %l_33207 = load i64, ptr %gep206, align 1
  %cmpi208 = icmp eq i64 %l_33204, %l_33207
  %zext209 = zext i1 %cmpi208 to i64
  store i64 %zext209, ptr %gep210, align 1
  %l_33213 = load i64, ptr %elem1, align 1
  %cmpi214 = icmp sgt i64 %l_33213, 1
  %zext215 = zext i1 %cmpi214 to i64
  store i64 %zext215, ptr %gep210, align 1
  %binop222 = add nuw nsw i32 %l_30.3626, 1
  %cmpi198 = icmp samesign ult i32 %l_30.3626, 8
  br i1 %cmpi198, label %while_body199, label %while_body226

while_body226:                                    ; preds = %while_body199
  %3 = trunc i32 %l_15.6629 to i16
  %gep243 = getelementptr [0 x i64], ptr %l_33, i16 0, i16 %3
  store i64 1774058491, ptr %gep243, align 1
  %binop295 = add nsw i32 %l_15.6629, -1
  %cmpi193.not = icmp eq i32 %l_15.6629, 0
  br i1 %cmpi193.not, label %while_end195, label %while_cond196.preheader

while_body362:                                    ; preds = %while_end195
  %l_33374 = load i64, ptr %elem5, align 1
  %trunc375 = trunc i64 %l_33374 to i16
  br label %common.ret

if_else376:                                       ; preds = %while_end195
  store i64 0, ptr %elem2, align 1
  %binop447 = add nuw nsw i32 %l_2.1630, 1
  %cmpi182 = icmp samesign ult i32 %l_2.1630, 8
  br i1 %cmpi182, label %while_body183, label %common.ret
}
