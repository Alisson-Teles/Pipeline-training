; ModuleID = 'out/00527.rob'
source_filename = "out/00527.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 27)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(27) %_this, i8 0, i64 27, i1 false)
  ret void
}
...
define noundef i16 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  store i8 1, ptr inttoptr (i16 13 to ptr), align 1
  store i32 5, ptr inttoptr (i16 14 to ptr), align 2
  ret i16 7
}
