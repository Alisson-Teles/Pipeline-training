; ModuleID = 'out/00529.rob'
source_filename = "out/00529.rob"
...
body:
  store i7 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 1
  store i2 0, ptr %gepf1, align 1
  ret void
}
...
define zeroext range(i64 0, 2) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_2.sroa.0 = alloca ptr, align 1
  store i7 0, ptr %l_2.sroa.0, align 1
  %l_2.sroa.0.1.sroa_idx11 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0, i16 1
  store i2 0, ptr %l_2.sroa.0.1.sroa_idx11, align 1
  store i7 6, ptr %l_2.sroa.0, align 1
  %l_2.sroa.0.1.sroa_idx12 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0, i16 1
  store i2 0, ptr %l_2.sroa.0.1.sroa_idx12, align 1
  %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref = load ptr, ptr %l_2.sroa.0, align 1
  %f11 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref, i16 1
  %l_2.f0 = load i7, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref, align 1
  %cmpi = icmp eq i7 %l_2.f0, 0
  %zext = zext i1 %cmpi to i2
  store i2 %zext, ptr %f11, align 1
  %zext6 = zext i1 %cmpi to i64
  ret i64 %zext6
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_2.sroa.0.i = alloca ptr, align 1
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call addrspace(1) void @llvm.lifetime.start.p0(i64 2, ptr nonnull %l_2.sroa.0.i)
  store i7 0, ptr %l_2.sroa.0.i, align 1
  %l_2.sroa.0.i.1.sroa_idx = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i, i16 1
  store i2 0, ptr %l_2.sroa.0.i.1.sroa_idx, align 1
  store i7 6, ptr %l_2.sroa.0.i, align 1
  %l_2.sroa.0.i.1.sroa_idx5 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i, i16 1
  store i2 0, ptr %l_2.sroa.0.i.1.sroa_idx5, align 1
  %l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref.i = load ptr, ptr %l_2.sroa.0.i, align 1
  %f11.i = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref.i, i16 1
  %l_2.f0.i = load i7, ptr %l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref.i, align 1
  %cmpi.i = icmp eq i7 %l_2.f0.i, 0
  %zext.i = zext i1 %cmpi.i to i2
  store i2 %zext.i, ptr %f11.i, align 1
  call addrspace(1) void @llvm.lifetime.end.p0(i64 2, ptr nonnull %l_2.sroa.0.i)
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="atmega328p" }
