; ModuleID = 'out/00375.rob'
source_filename = "out/00375.rob"
target datalayout = "e-P1-p:16:8-i8:8-i16:8-i32:8-i64:8-f32:8-f64:8-n8-a:8"
target triple = "avr"

%S2 = type { i13, i4, i25, i2, i12 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S2:init"(ptr nocapture writeonly initializes((0, 10)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(10) %_this, i8 0, i64 10, i1 false)
  ret void
}
...
define %S2 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret %S2 { i13 19, i4 -3, i25 -4153, i2 -1, i12 42 }
}
