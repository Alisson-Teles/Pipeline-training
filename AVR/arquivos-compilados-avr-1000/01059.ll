; ModuleID = 'out/01059.rob'
source_filename = "out/01059.rob"
...
body:
  store i64 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i16 8
  store i16 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i16 10
  store i8 0, ptr %gepf2, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(28) %_this, i8 0, i64 28, i1 false)
  ret void
}
...
define noundef zeroext i8 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i8 0
}
