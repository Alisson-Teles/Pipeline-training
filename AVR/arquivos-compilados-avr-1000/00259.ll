; ModuleID = 'out/00259.rob'
source_filename = "out/00259.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 25)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  tail call addrspace(1) void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(25) %_this, i8 0, i64 25, i1 false)
  ret void
}
