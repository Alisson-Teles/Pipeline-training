...
while_cond156.preheader:                          ; preds = %body, %while_cond156.preheader
  %l_28.0420.off0 = phi i8 [ 0, %body ], [ %spec.select.i, %while_cond156.preheader ]
  %cmpi.i = icmp slt i8 %l_28.0420.off0, 0
  %binop.i = add i8 %l_28.0420.off0, -3
  %spec.select.i = select i1 %cmpi.i, i8 %l_28.0420.off0, i8 %binop.i
  %cmpi148.not = icmp eq i8 %spec.select.i, -15
  br i1 %cmpi148.not, label %safe_mod_func_int32_t_s_s.exit, label %while_cond156.preheader

safe_mod_func_int32_t_s_s.exit:                   ; preds = %while_cond156.preheader
  ret i64 1
}
...
while_cond156.preheader.i:                        ; preds = %while_cond156.preheader.i, %body
  %l_28.0420.off0.i = phi i8 [ 0, %body ], [ %spec.select.i.i, %while_cond156.preheader.i ]
  %cmpi.i.i = icmp slt i8 %l_28.0420.off0.i, 0
  %binop.i.i = add i8 %l_28.0420.off0.i, -3
  %spec.select.i.i = select i1 %cmpi.i.i, i8 %l_28.0420.off0.i, i8 %binop.i.i
  %cmpi148.not.i = icmp eq i8 %spec.select.i.i, -15
  br i1 %cmpi148.not.i, label %func_1.exit, label %while_cond156.preheader.i

func_1.exit:                                      ; preds = %while_cond156.preheader.i
