; ModuleID = 'out/00046.rob'
source_filename = "out/00046.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 19)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
