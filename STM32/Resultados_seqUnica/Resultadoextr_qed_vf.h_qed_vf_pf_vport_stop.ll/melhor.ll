; ModuleID = 'angha-ll-stm32f1/extr_qed_vf.h_qed_vf_pf_vport_stop.ll'
source_filename = "out/extr_qed_vf.h_qed_vf_pf_vport_stop.rob"
...
define i32 @qed_vf_pf_vport_stop(ptr readnone captures(none) %p_hwfn) local_unnamed_addr addrspace(1) #1 {
body:
