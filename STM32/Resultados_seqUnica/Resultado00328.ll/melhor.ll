; ModuleID = 'arquivos-compilados-stm32-1000/00328.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (8, 29)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(21) %gepf1, i8 0, i64 21, i1 false)
  ret void
}
