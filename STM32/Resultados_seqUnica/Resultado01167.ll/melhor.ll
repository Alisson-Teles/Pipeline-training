; ModuleID = 'arquivos-compilados-stm32-1000/01167.ll'
source_filename = "out/01167.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  store i32 0, ptr inttoptr (i32 9 to ptr), align 4
  %l_8.f1 = load i32, ptr inttoptr (i32 5 to ptr), align 4
  ret i32 %l_8.f1
}
