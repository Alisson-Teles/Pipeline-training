; ModuleID = 'arquivos-compilados-stm32-1000/00375.ll'
...
define void @"S2:init"(ptr nocapture writeonly initializes((0, 3), (4, 9), (10, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  store i2 0, ptr %gepf3, align 1
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 10
  store i12 0, ptr %gepf4, align 2
  ret void
}
