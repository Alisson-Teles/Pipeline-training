; ModuleID = 'angha-ll-stm32f1/extr_encode.c_EVP_ENCODE_CTX_num.ll'
source_filename = "out/extr_encode.c_EVP_ENCODE_CTX_num.rob"
...
define i32 @EVP_ENCODE_CTX_num(ptr readonly captures(none) %ctx) local_unnamed_addr addrspace(1) #1 {
body:
  %num2 = load i32, ptr %ctx, align 4
  ret i32 %num2
}
