; ModuleID = 'arquivos-compilados-stm32-1000/00306.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 9), (12, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 17
...
while_cond17:                                     ; preds = %while_cond17, %body
  br label %while_cond17
}
