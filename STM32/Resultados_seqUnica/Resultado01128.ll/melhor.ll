; ModuleID = 'arquivos-compilados-stm32-1000/01128.ll'
source_filename = "out/01128.rob"
...
while_cond52:                                     ; preds = %while_cond52, %body
  br label %while_cond52
}
...
body:
  ...
  br label %while_cond52.i

while_cond52.i:                                   ; preds = %while_cond52.i, %body
  br label %while_cond52.i
}
