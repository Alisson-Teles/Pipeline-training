; ModuleID = 'arquivos-compilados-stm32-1000/00842.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 1), (8, 20), (24, 32)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i64 0, ptr %gepf5, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %gepf1, i8 0, i64 12, i1 false)
  ret void
}
