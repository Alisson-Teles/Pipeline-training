; ModuleID = 'arquivos-compilados-stm32-1000/01052.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 9), (12, 35), (36, 38)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 36
  store i16 0, ptr %gepf8, align 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(23) %gepf3, i8 0, i64 23, i1 false)
  ret void
}
