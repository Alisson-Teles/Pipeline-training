; ModuleID = 'arquivos-compilados-stm32-1000/00650.ll'
source_filename = "out/00650.rob"
...
define noundef zeroext range(i64 -128, 128) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 26
}
