; ModuleID = 'arquivos-compilados-stm32-1000/00003.ll'
source_filename = "out/00003.rob"
...
while_cond15:                                     ; preds = %while_cond15, %body
  br label %while_cond15
}
...
body:
  ...
  br label %while_cond15.i

while_cond15.i:                                   ; preds = %while_cond15.i, %body
  br label %while_cond15.i
}
