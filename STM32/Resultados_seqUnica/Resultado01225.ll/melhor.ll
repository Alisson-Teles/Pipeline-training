; ModuleID = 'arquivos-compilados-stm32-1000/01225.ll'
source_filename = "out/01225.rob"
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S3:init"(ptr nocapture writeonly initializes((0, 4), (8, 20)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
