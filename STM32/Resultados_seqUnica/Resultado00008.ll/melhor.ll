; ModuleID = 'arquivos-compilados-stm32-1000/00008.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i18 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %gepf1, i8 0, i64 24, i1 false)
  ret void
}
