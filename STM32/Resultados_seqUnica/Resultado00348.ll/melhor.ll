; ModuleID = 'arquivos-compilados-stm32-1000/00348.ll'
source_filename = "out/00348.rob"
...
body:
  br label %while_cond156.preheader

while_cond156.preheader:                          ; preds = %while_cond156.preheader.3, %body
  %l_28.0420 = phi i32 [ 0, %body ], [ %sext307.3, %while_cond156.preheader.3 ]
  %cmpi.i = icmp slt i32 %l_28.0420, 0
  %0 = shl nsw i32 %l_28.0420, 24
  %1 = add i32 %0, -50331648
  %2 = ashr exact i32 %1, 24
  %sext307 = select i1 %cmpi.i, i32 %l_28.0420, i32 %2
  %cmpi148.not = icmp eq i32 %sext307, -15
  br i1 %cmpi148.not, label %safe_mod_func_int32_t_s_s.exit, label %while_cond156.preheader.1

while_cond156.preheader.1:                        ; preds = %while_cond156.preheader
  %cmpi.i.1 = icmp slt i32 %sext307, 0
  %3 = shl nsw i32 %sext307, 24
  %4 = add i32 %3, -50331648
  %5 = ashr exact i32 %4, 24
  %sext307.1 = select i1 %cmpi.i.1, i32 %sext307, i32 %5
  %cmpi148.not.1 = icmp eq i32 %sext307.1, -15
  br i1 %cmpi148.not.1, label %safe_mod_func_int32_t_s_s.exit, label %while_cond156.preheader.2

while_cond156.preheader.2:                        ; preds = %while_cond156.preheader.1
  %cmpi.i.2 = icmp slt i32 %sext307.1, 0
  %6 = shl nsw i32 %sext307.1, 24
  %7 = add i32 %6, -50331648
  %8 = ashr exact i32 %7, 24
  %sext307.2 = select i1 %cmpi.i.2, i32 %sext307.1, i32 %8
  %cmpi148.not.2 = icmp eq i32 %sext307.2, -15
  br i1 %cmpi148.not.2, label %safe_mod_func_int32_t_s_s.exit, label %while_cond156.preheader.3

while_cond156.preheader.3:                        ; preds = %while_cond156.preheader.2
  %cmpi.i.3 = icmp slt i32 %sext307.2, 0
  %9 = shl nsw i32 %sext307.2, 24
  %10 = add i32 %9, -50331648
  %11 = ashr exact i32 %10, 24
  %sext307.3 = select i1 %cmpi.i.3, i32 %sext307.2, i32 %11
  %cmpi148.not.3 = icmp eq i32 %sext307.3, -15
  br i1 %cmpi148.not.3, label %safe_mod_func_int32_t_s_s.exit, label %while_cond156.preheader

safe_mod_func_int32_t_s_s.exit:                   ; preds = %while_cond156.preheader.3, %while_cond156.preheader.2, %while_cond156.preheader.1, %while_cond156.preheader
  ret i64 1
}
...
body:
  ...
  br label %while_cond156.preheader.i

while_cond156.preheader.i:                        ; preds = %while_cond156.preheader.i.3, %body
  %l_28.0420.i = phi i32 [ 0, %body ], [ %sext307.i.3, %while_cond156.preheader.i.3 ]
  %cmpi.i.i = icmp slt i32 %l_28.0420.i, 0
  %0 = shl nsw i32 %l_28.0420.i, 24
  %1 = add i32 %0, -50331648
  %2 = ashr exact i32 %1, 24
  %sext307.i = select i1 %cmpi.i.i, i32 %l_28.0420.i, i32 %2
  %cmpi148.not.i = icmp eq i32 %sext307.i, -15
  br i1 %cmpi148.not.i, label %func_1.exit, label %while_cond156.preheader.i.1

while_cond156.preheader.i.1:                      ; preds = %while_cond156.preheader.i
  %cmpi.i.i.1 = icmp slt i32 %sext307.i, 0
  %3 = shl nsw i32 %sext307.i, 24
  %4 = add i32 %3, -50331648
  %5 = ashr exact i32 %4, 24
  %sext307.i.1 = select i1 %cmpi.i.i.1, i32 %sext307.i, i32 %5
  %cmpi148.not.i.1 = icmp eq i32 %sext307.i.1, -15
  br i1 %cmpi148.not.i.1, label %func_1.exit, label %while_cond156.preheader.i.2

while_cond156.preheader.i.2:                      ; preds = %while_cond156.preheader.i.1
  %cmpi.i.i.2 = icmp slt i32 %sext307.i.1, 0
  %6 = shl nsw i32 %sext307.i.1, 24
  %7 = add i32 %6, -50331648
  %8 = ashr exact i32 %7, 24
  %sext307.i.2 = select i1 %cmpi.i.i.2, i32 %sext307.i.1, i32 %8
  %cmpi148.not.i.2 = icmp eq i32 %sext307.i.2, -15
  br i1 %cmpi148.not.i.2, label %func_1.exit, label %while_cond156.preheader.i.3

while_cond156.preheader.i.3:                      ; preds = %while_cond156.preheader.i.2
  %cmpi.i.i.3 = icmp slt i32 %sext307.i.2, 0
  %9 = shl nsw i32 %sext307.i.2, 24
  %10 = add i32 %9, -50331648
  %11 = ashr exact i32 %10, 24
  %sext307.i.3 = select i1 %cmpi.i.i.3, i32 %sext307.i.2, i32 %11
  %cmpi148.not.i.3 = icmp eq i32 %sext307.i.3, -15
  br i1 %cmpi148.not.i.3, label %func_1.exit, label %while_cond156.preheader.i

func_1.exit:                                      ; preds = %while_cond156.preheader.i.3, %while_cond156.preheader.i.2, %while_cond156.preheader.i.1, %while_cond156.preheader.i
