...
/tmp/tmp.m5kMguee5y/saida.o:	file format elf32-littlearm
...
<main>:
               	...
               	asrpl	r0, r2, #0x18
               	adds.w	r2, r0, #0xf
               	beq	0xb74 <main+0x54>       @ imm = #0x2e
               	add.w	r2, r1, r0, lsl #24
               	cmp	r0, #0x0
               	it	pl
               	asrpl	r0, r2, #0x18
               	adds.w	r2, r0, #0xf
               	beq	0xb74 <main+0x54>       @ imm = #0x1e
               	add.w	r2, r1, r0, lsl #24
               	cmp	r0, #0x0
               	it	pl
               	asrpl	r0, r2, #0x18
               	adds.w	r2, r0, #0xf
               	beq	0xb74 <main+0x54>       @ imm = #0xe
               	add.w	r2, r1, r0, lsl #24
               	cmp	r0, #0x0
               	it	pl
               	asrpl	r0, r2, #0x18
               	adds.w	r2, r0, #0xf
               	bne	0xb34 <main+0x14>       @ imm = #-0x42
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
