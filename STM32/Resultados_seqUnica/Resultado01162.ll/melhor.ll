; ModuleID = 'arquivos-compilados-stm32-1000/01162.ll'
source_filename = "out/01162.rob"
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 4), (8, 33)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(25) %gepf1, i8 0, i64 25, i1 false)
  ret void
}
