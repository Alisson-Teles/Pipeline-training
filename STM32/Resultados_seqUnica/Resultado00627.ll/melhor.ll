; ModuleID = 'arquivos-compilados-stm32-1000/00627.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2), (4, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i11 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i27 0, ptr %gepf1, align 4
  ret void
}
...
body:
  %l_17.sroa.0 = alloca ptr, align 4
  store i11 -21, ptr %l_17.sroa.0, align 4
  %l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.deref = load ptr, ptr %l_17.sroa.0, align 4
  %l_17.f0 = load i11, ptr %l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.l_17.sroa.0.0.deref, align 2
