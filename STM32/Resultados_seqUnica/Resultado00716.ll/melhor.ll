; ModuleID = 'arquivos-compilados-stm32-1000/00716.ll'
source_filename = "out/00716.rob"
...
while_cond18:                                     ; preds = %while_cond18, %body
  br label %while_cond18
}
...
body:
  ...
  br label %while_cond18.i

while_cond18.i:                                   ; preds = %while_cond18.i, %body
  br label %while_cond18.i
}
