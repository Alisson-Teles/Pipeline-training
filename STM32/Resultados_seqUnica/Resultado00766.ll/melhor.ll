; ModuleID = 'arquivos-compilados-stm32-1000/00766.ll'
source_filename = "out/00766.rob"
...
body:
  br label %while_cond431

while_cond431:                                    ; preds = %while_cond431, %body
  br label %while_cond431
}
...
body:
  ...
  br label %while_cond431.i

while_cond431.i:                                  ; preds = %while_cond431.i, %body
  br label %while_cond431.i
}
