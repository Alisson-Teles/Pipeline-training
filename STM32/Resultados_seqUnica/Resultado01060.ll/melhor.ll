; ModuleID = 'arquivos-compilados-stm32-1000/01060.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 9), (10, 14)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i5 0, ptr %_this, align 1
