; ModuleID = 'arquivos-compilados-stm32-1000/00288.ll'
source_filename = "out/00288.rob"
...
body:
  br label %while_body242

while_body242:                                    ; preds = %while_body242.3, %body
  %l_8.3434 = phi i32 [ 3, %body ], [ %sext270.3, %while_body242.3 ]
  %cmpi.i = icmp slt i32 %l_8.3434, 0
  %0 = shl nsw i32 %l_8.3434, 24
  %1 = add i32 %0, -83886080
  %2 = ashr exact i32 %1, 24
  %sext270 = select i1 %cmpi.i, i32 %l_8.3434, i32 %2
  %cmpi241 = icmp sgt i32 %sext270, -26
  br i1 %cmpi241, label %while_body242.1, label %if_cont377

while_body242.1:                                  ; preds = %while_body242
  %cmpi.i.1 = icmp slt i32 %sext270, 0
  %3 = shl nsw i32 %sext270, 24
  %4 = add i32 %3, -83886080
  %5 = ashr exact i32 %4, 24
  %sext270.1 = select i1 %cmpi.i.1, i32 %sext270, i32 %5
  %cmpi241.1 = icmp sgt i32 %sext270.1, -26
  br i1 %cmpi241.1, label %while_body242.2, label %if_cont377

while_body242.2:                                  ; preds = %while_body242.1
  %cmpi.i.2 = icmp slt i32 %sext270.1, 0
  %6 = shl nsw i32 %sext270.1, 24
  %7 = add i32 %6, -83886080
  %8 = ashr exact i32 %7, 24
  %sext270.2 = select i1 %cmpi.i.2, i32 %sext270.1, i32 %8
  %cmpi241.2 = icmp sgt i32 %sext270.2, -26
  br i1 %cmpi241.2, label %while_body242.3, label %if_cont377

while_body242.3:                                  ; preds = %while_body242.2
  %cmpi.i.3 = icmp slt i32 %sext270.2, 0
  %9 = shl nsw i32 %sext270.2, 24
  %10 = add i32 %9, -83886080
  %11 = ashr exact i32 %10, 24
  %sext270.3 = select i1 %cmpi.i.3, i32 %sext270.2, i32 %11
  %cmpi241.3 = icmp sgt i32 %sext270.3, -26
  br i1 %cmpi241.3, label %while_body242, label %if_cont377

if_cont377:                                       ; preds = %while_body242.3, %while_body242.2, %while_body242.1, %while_body242
  ret i32 0
}
...
body:
  ...
  br label %while_body242.i

while_body242.i:                                  ; preds = %while_body242.i.3, %body
  %l_8.3434.i = phi i32 [ 3, %body ], [ %sext270.i.3, %while_body242.i.3 ]
  %cmpi.i.i = icmp slt i32 %l_8.3434.i, 0
  %0 = shl nsw i32 %l_8.3434.i, 24
  %1 = add i32 %0, -83886080
  %2 = ashr exact i32 %1, 24
  %sext270.i = select i1 %cmpi.i.i, i32 %l_8.3434.i, i32 %2
  %cmpi241.i = icmp sgt i32 %sext270.i, -26
  br i1 %cmpi241.i, label %while_body242.i.1, label %func_1.exit

while_body242.i.1:                                ; preds = %while_body242.i
  %cmpi.i.i.1 = icmp slt i32 %sext270.i, 0
  %3 = shl nsw i32 %sext270.i, 24
  %4 = add i32 %3, -83886080
  %5 = ashr exact i32 %4, 24
  %sext270.i.1 = select i1 %cmpi.i.i.1, i32 %sext270.i, i32 %5
  %cmpi241.i.1 = icmp sgt i32 %sext270.i.1, -26
  br i1 %cmpi241.i.1, label %while_body242.i.2, label %func_1.exit

while_body242.i.2:                                ; preds = %while_body242.i.1
  %cmpi.i.i.2 = icmp slt i32 %sext270.i.1, 0
  %6 = shl nsw i32 %sext270.i.1, 24
  %7 = add i32 %6, -83886080
  %8 = ashr exact i32 %7, 24
  %sext270.i.2 = select i1 %cmpi.i.i.2, i32 %sext270.i.1, i32 %8
  %cmpi241.i.2 = icmp sgt i32 %sext270.i.2, -26
  br i1 %cmpi241.i.2, label %while_body242.i.3, label %func_1.exit

while_body242.i.3:                                ; preds = %while_body242.i.2
  %cmpi.i.i.3 = icmp slt i32 %sext270.i.2, 0
  %9 = shl nsw i32 %sext270.i.2, 24
  %10 = add i32 %9, -83886080
  %11 = ashr exact i32 %10, 24
  %sext270.i.3 = select i1 %cmpi.i.i.3, i32 %sext270.i.2, i32 %11
  %cmpi241.i.3 = icmp sgt i32 %sext270.i.3, -26
  br i1 %cmpi241.i.3, label %while_body242.i, label %func_1.exit

func_1.exit:                                      ; preds = %while_body242.i.3, %while_body242.i.2, %while_body242.i.1, %while_body242.i
