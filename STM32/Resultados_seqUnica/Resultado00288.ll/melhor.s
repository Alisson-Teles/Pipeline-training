...
/tmp/tmp.XyGxLtWZaI/saida.o:	file format elf32-littlearm
...
<main>:
               	push	{r7, lr}
               	mov	r7, sp
               	bl	0xb20 <main+0x4>        @ imm = #-0x4
               	bl	0xb24 <main+0x8>        @ imm = #-0x4
               	movs	r0, #0x3
               	mov.w	r1, #0xfb000000
               	nop
               	cmp	r0, #0x0
               	...
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb70 <main+0x54>       @ imm = #0x2e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb70 <main+0x54>       @ imm = #0x1e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb70 <main+0x54>       @ imm = #0xe
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x1a
               	bgt	0xb30 <main+0x14>       @ imm = #-0x42
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
               	mvns	r0, r0
               	bl	0xb7e <main+0x62>       @ imm = #-0x4
               	movs	r0, #0x0
               	pop	{r7, pc}
