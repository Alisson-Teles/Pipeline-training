; ModuleID = 'angha-ll-stm32f1/extr_keymap.c_persistant_default_layer_set.ll'
source_filename = "out/extr_keymap.c_persistant_default_layer_set.rob"
...
define void @persistant_default_layer_set(i32 %default_layer) local_unnamed_addr addrspace(1) #0 {
body:
