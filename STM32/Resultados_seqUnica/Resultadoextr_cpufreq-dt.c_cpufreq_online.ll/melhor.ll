; ModuleID = 'angha-ll-stm32f1/extr_cpufreq-dt.c_cpufreq_online.ll'
source_filename = "out/extr_cpufreq-dt.c_cpufreq_online.rob"
...
define noundef i32 @cpufreq_online(ptr readnone captures(none) %policy) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
