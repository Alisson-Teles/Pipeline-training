; ModuleID = 'angha-ll-stm32f1/extr_module.c_module_finalize.ll'
source_filename = "out/extr_module.c_module_finalize.rob"
...
define noundef i32 @module_finalize(i32 %hdr, i32 %sechdrs, ptr readnone captures(none) %me) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
