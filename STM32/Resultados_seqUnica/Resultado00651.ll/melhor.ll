; ModuleID = 'arquivos-compilados-stm32-1000/00651.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (2, 7)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i4 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(5) %gepf1, i8 0, i64 5, i1 false)
  ret void
}
