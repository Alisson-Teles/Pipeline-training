; ModuleID = 'angha-ll-stm32f1/extr_power.h_pm_wakeup_source_sysfs_add.ll'
source_filename = "out/extr_power.h_pm_wakeup_source_sysfs_add.rob"
...
define noundef i32 @pm_wakeup_source_sysfs_add(ptr readnone captures(none) %parent) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
