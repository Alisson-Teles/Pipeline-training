; ModuleID = 'arquivos-compilados-stm32-1000/00206.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 5), (8, 12), (16, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i21 0, ptr %_this, align 4
