; ModuleID = 'arquivos-compilados-stm32-1000/01109.ll'
source_filename = "out/01109.rob"
...
body:
  %l_12.sroa.0 = alloca i8, align 4
  store i8 2, ptr %l_12.sroa.0, align 4
  %l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.deref44 = load ptr, ptr %l_12.sroa.0, align 4
  store i8 0, ptr %l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.l_12.sroa.0.0.deref44, align 1
  ret %S1 zeroinitializer
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_12.sroa.0.i = alloca i8, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %l_12.sroa.0.i)
  store i8 2, ptr %l_12.sroa.0.i, align 4
  %l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.0.l_12.sroa.0.0.deref44.i = load ptr, ptr %l_12.sroa.0.i, align 4
  store i8 0, ptr %l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.i.0.l_12.sroa.0.0.l_12.sroa.0.0.deref44.i, align 1
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %l_12.sroa.0.i)
