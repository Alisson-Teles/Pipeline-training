; ModuleID = 'arquivos-compilados-stm32-1000/01095.ll'
source_filename = "out/01095.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S1 = type { i64, i32, i64, i32, i16, i32, i16, i32 }
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 12), (16, 30), (32, 38), (40, 44)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i64 0, ptr %_this, align 8
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i32 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i64 0, ptr %gepf2, align 8
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i32 0, ptr %gepf3, align 4
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 28
  store i16 0, ptr %gepf4, align 2
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 32
  store i32 0, ptr %gepf5, align 4
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 36
  store i16 0, ptr %gepf6, align 2
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 40
  store i32 0, ptr %gepf7, align 4
  ret void
}
...
body:
  ret %S1 { i64 9223372036854775807, i32 -252740474, i64 9223372036854775807, i32 -3, i16 6682, i32 9, i16 1, i32 -919573970 }
}
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
