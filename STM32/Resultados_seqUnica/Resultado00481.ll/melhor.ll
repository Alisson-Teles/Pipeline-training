; ModuleID = 'arquivos-compilados-stm32-1000/00481.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 14), (16, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(14) %_this, i8 0, i64 14, i1 false)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S2:init"(ptr nocapture writeonly initializes((0, 7), (8, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i28 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i19 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i25 0, ptr %gepf2, align 4
  ret void
}
