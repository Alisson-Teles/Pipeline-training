; ModuleID = 'arquivos-compilados-stm32-1000/00449.ll'
source_filename = "out/00449.rob"
...
while_cond70:                                     ; preds = %while_cond70, %body
  br label %while_cond70
}
...
body:
  ...
  br label %while_cond70.i

while_cond70.i:                                   ; preds = %while_cond70.i, %body
  br label %while_cond70.i
}
