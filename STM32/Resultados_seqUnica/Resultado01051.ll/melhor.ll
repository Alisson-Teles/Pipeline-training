; ModuleID = 'arquivos-compilados-stm32-1000/01051.ll'
...
body:
  store i16 0, ptr inttoptr (i32 16 to ptr), align 16
  store i8 26, ptr inttoptr (i32 8 to ptr), align 8
  ret i32 4
}
