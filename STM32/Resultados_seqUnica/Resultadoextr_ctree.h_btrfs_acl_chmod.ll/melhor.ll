; ModuleID = 'angha-ll-stm32f1/extr_ctree.h_btrfs_acl_chmod.ll'
source_filename = "out/extr_ctree.h_btrfs_acl_chmod.rob"
...
define noundef i32 @btrfs_acl_chmod(ptr readnone captures(none) %inode) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
