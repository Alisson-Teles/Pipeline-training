; ModuleID = 'angha-ll-stm32f1/extr_skeletonfb.c_xxxfb_sync.ll'
source_filename = "out/extr_skeletonfb.c_xxxfb_sync.rob"
...
define noundef i32 @xxxfb_sync(ptr readnone captures(none) %info) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
