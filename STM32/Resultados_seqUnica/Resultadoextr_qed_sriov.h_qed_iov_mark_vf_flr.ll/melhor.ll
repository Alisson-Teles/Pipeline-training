; ModuleID = 'angha-ll-stm32f1/extr_qed_sriov.h_qed_iov_mark_vf_flr.ll'
source_filename = "out/extr_qed_sriov.h_qed_iov_mark_vf_flr.rob"
...
define noundef i32 @qed_iov_mark_vf_flr(ptr readnone captures(none) %p_hwfn, i32 %disabled_vfs) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
