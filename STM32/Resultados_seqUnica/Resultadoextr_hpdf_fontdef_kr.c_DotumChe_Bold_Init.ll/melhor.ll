; ModuleID = 'angha-ll-stm32f1/extr_hpdf_fontdef_kr.c_DotumChe_Bold_Init.ll'
source_filename = "out/extr_hpdf_fontdef_kr.c_DotumChe_Bold_Init.rob"
...
declare i64 @DotumChe_Init(i32) local_unnamed_addr addrspace(1) #0

declare i64 @HPDF_CIDFontDef_ChangeStyle(i32, i32, i32) local_unnamed_addr addrspace(1) #0

define i64 @DotumChe_Bold_Init(i32 %fontdef) local_unnamed_addr addrspace(1) #0 {
body:
  %0 = tail call addrspace(1) i64 @DotumChe_Init(i32 %fontdef)
