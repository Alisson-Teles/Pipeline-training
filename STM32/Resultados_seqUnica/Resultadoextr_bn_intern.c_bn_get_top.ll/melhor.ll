; ModuleID = 'angha-ll-stm32f1/extr_bn_intern.c_bn_get_top.ll'
source_filename = "out/extr_bn_intern.c_bn_get_top.rob"
...
define i32 @bn_get_top(ptr readonly captures(none) %a) local_unnamed_addr addrspace(1) #1 {
body:
  %top2 = load i32, ptr %a, align 4
  ret i32 %top2
}
