; ModuleID = 'arquivos-compilados-stm32-1000/00143.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (8, 40)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %gepf1, i8 0, i64 32, i1 false)
  ret void
}
...
body:
  store i16 7, ptr inttoptr (i32 36687 to ptr), align 2
  %l_7.f2 = load i64, ptr inttoptr (i32 36703 to ptr), align 8
