; ModuleID = 'angha-ll-stm32f1/extr_idmap.h_nfsd_idmap_init.ll'
source_filename = "out/extr_idmap.h_nfsd_idmap_init.rob"
...
define noundef i32 @nfsd_idmap_init(ptr readnone captures(none) %net) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
