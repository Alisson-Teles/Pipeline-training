; ModuleID = 'arquivos-compilados-stm32-1000/00549.ll'
...
define void @"S2:init"(ptr nocapture writeonly initializes((0, 1), (4, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(14) %gepf1, i8 0, i64 14, i1 false)
  ret void
}
