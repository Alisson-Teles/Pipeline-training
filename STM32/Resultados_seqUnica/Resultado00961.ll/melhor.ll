; ModuleID = 'arquivos-compilados-stm32-1000/00961.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 17), (20, 25), (26, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i29 0, ptr %gepf3, align 4
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i8 0, ptr %gepf4, align 1
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 26
  store i16 0, ptr %gepf5, align 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(17) %_this, i8 0, i64 17, i1 false)
  ret void
}
