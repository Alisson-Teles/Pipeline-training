; ModuleID = 'arquivos-compilados-stm32-1000/01138.ll'
source_filename = "out/01138.rob"
...
define noundef zeroext range(i64 -32768, 32768) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 47
}
