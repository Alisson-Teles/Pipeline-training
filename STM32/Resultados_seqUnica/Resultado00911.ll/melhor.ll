; ModuleID = 'arquivos-compilados-stm32-1000/00911.ll'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 4), (8, 20)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 18
