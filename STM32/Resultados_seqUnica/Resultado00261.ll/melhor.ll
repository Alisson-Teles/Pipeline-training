; ModuleID = 'arquivos-compilados-stm32-1000/00261.ll'
source_filename = "out/00261.rob"
...
define noundef zeroext range(i32 0, 256) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i32 0
}
