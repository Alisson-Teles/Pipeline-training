; ModuleID = 'arquivos-compilados-stm32-1000/00844.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 10)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  store i25 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i28 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i12 0, ptr %gepf2, align 2
  ret void
}
