; ModuleID = 'arquivos-compilados-stm32-1000/01198.ll'
source_filename = "out/01198.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S0 = type { i16, i32, i16, i64, i8, i32, i8, i8 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 10), (16, 25), (28, 34)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 33
...
body:
  ret %S0 { i16 1, i32 1306896426, i16 -1724, i64 9223372036854775807, i8 -1, i32 1454924846, i8 -1, i8 119 }
}
