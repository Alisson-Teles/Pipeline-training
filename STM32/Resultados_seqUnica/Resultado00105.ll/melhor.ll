; ModuleID = 'arquivos-compilados-stm32-1000/00105.ll'
source_filename = "out/00105.rob"
...
while_cond189:                                    ; preds = %while_cond189, %body
  br label %while_cond189
}
...
body:
  ...
  br label %while_cond189.i

while_cond189.i:                                  ; preds = %while_cond189.i, %body
  br label %while_cond189.i
}
