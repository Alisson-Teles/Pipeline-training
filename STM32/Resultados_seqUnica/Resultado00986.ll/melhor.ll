; ModuleID = 'arquivos-compilados-stm32-1000/00986.ll'
source_filename = "out/00986.rob"
...
define i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 -134406527
}
...
attributes #2 = { mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
