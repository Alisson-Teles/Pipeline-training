; ModuleID = 'arquivos-compilados-stm32-1000/01017.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 5), (8, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i18 0, ptr %gepf3, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(5) %_this, i8 0, i64 5, i1 false)
  ret void
}
