; ModuleID = 'arquivos-compilados-stm32-1000/01012.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 1), (2, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i7 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  store i13 0, ptr %gepf1, align 2
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i30 0, ptr %gepf2, align 4
