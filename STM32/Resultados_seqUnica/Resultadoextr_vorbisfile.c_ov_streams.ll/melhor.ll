; ModuleID = 'angha-ll-stm32f1/extr_vorbisfile.c_ov_streams.ll'
source_filename = "out/extr_vorbisfile.c_ov_streams.rob"
...
define i64 @ov_streams(ptr readonly captures(none) %vf) local_unnamed_addr addrspace(1) #1 {
body:
  %links2 = load i64, ptr %vf, align 8
  ret i64 %links2
}
