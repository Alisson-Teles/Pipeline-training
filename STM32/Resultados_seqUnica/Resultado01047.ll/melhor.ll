; ModuleID = 'arquivos-compilados-stm32-1000/01047.ll'
...
fullev13:                                         ; preds = %body
  ...
  %spec.select39 = add i8 %binop37, %si1
  br label %common.ret
...
fullev13:                                         ; preds = %body
  ...
  %spec.select39 = add i16 %binop37, %si1
  br label %common.ret
...
fullev13:                                         ; preds = %body
  ...
  %spec.select39 = add i32 %binop37, %si1
  br label %common.ret
...
while_cond230.preheader:                          ; preds = %while_cond230.preheader.3, %body
  %l_2.3327 = phi i32 [ 18, %body ], [ %sext253.3, %while_cond230.preheader.3 ]
