; ModuleID = 'arquivos-compilados-stm32-1000/00043.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (8, 20), (24, 33)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
