; ModuleID = 'arquivos-compilados-stm32-1000/00073.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2), (4, 7)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
