; ModuleID = 'arquivos-compilados-stm32-1000/00437.ll'
...
fullev6:                                          ; preds = %body
  ...
  %cmpi11 = icmp sgt i8 %si1, %binop
  br i1 %cmpi11, label %common.ret, label %if_cont
...
fullev24:                                         ; preds = %fullev13
  ...
  br i1 %cmpi31, label %common.ret, label %if_cont

fullev34:                                         ; preds = %fullev13
...
if_cont:                                          ; preds = %fullev24, %fullev6, %fullev73, %fullev56
...
fullev24:                                         ; preds = %fullev13
  ...
  br i1 %cmpi30, label %common.ret, label %if_cont

fullev33:                                         ; preds = %fullev13
...
common.ret:                                       ; preds = %fullev6, %if_cont, %fullev70, %fullev44, %fullev24
  %common.ret.op = phi i64 [ %binop82, %if_cont ], [ %si1, %fullev44 ], [ %si1, %fullev6 ], [ %si1, %fullev24 ], [ %si1, %fullev70 ]
  ret i64 %common.ret.op

if_cont:                                          ; preds = %fullev24, %fullev70, %fullev53
...
while_cond16.preheader:                           ; preds = %while_end20, %body
...
while_cond24.preheader:                           ; preds = %phiblock75.6.1, %while_cond16.preheader
  ...
  br i1 %cmpi73.not, label %phiblock75.thread, label %phiblock75

phiblock75.thread:                                ; preds = %while_cond24.preheader
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.1.thread

while_end20:                                      ; preds = %phiblock75.6.1
  %l_6133 = load i64, ptr %gep35, align 8
  %1 = and i64 %l_6133, 4294967280
  %phi.i = icmp ne i64 %1, 0
  ...
  %2 = zext i16 %binop17.i to i64
  %zext135 = select i1 %or.cond.i, i64 31861, i64 %2
  store i64 %zext135, ptr %gep35, align 8
  store i64 %zext135, ptr %l_6, align 8
...
phiblock75:                                       ; preds = %while_cond24.preheader
  %l_679 = load i64, ptr %gep35, align 8
  %cmpi80 = icmp ne i64 %l_679, 0
  %zext82 = zext i1 %cmpi80 to i64
  store i64 %zext82, ptr %gep71, align 8
  br i1 %cmpi80, label %phiblock75.1, label %phiblock75.1.thread

phiblock75.1.thread:                              ; preds = %phiblock75, %phiblock75.thread
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.2.thread

phiblock75.1:                                     ; preds = %phiblock75
  %l_679.1 = load i64, ptr %gep35, align 8
  %cmpi80.1 = icmp ne i64 %l_679.1, 0
  %zext82.1 = zext i1 %cmpi80.1 to i64
  store i64 %zext82.1, ptr %gep71, align 8
  br i1 %cmpi80.1, label %phiblock75.2, label %phiblock75.2.thread

phiblock75.2.thread:                              ; preds = %phiblock75.1, %phiblock75.1.thread
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.3.thread

phiblock75.2:                                     ; preds = %phiblock75.1
  %l_679.2 = load i64, ptr %gep35, align 8
  %cmpi80.2 = icmp ne i64 %l_679.2, 0
  %zext82.2 = zext i1 %cmpi80.2 to i64
  store i64 %zext82.2, ptr %gep71, align 8
  br i1 %cmpi80.2, label %phiblock75.3, label %phiblock75.3.thread

phiblock75.3.thread:                              ; preds = %phiblock75.2, %phiblock75.2.thread
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.4.thread

phiblock75.3:                                     ; preds = %phiblock75.2
  %l_679.3 = load i64, ptr %gep35, align 8
  %cmpi80.3 = icmp ne i64 %l_679.3, 0
  %zext82.3 = zext i1 %cmpi80.3 to i64
  store i64 %zext82.3, ptr %gep71, align 8
  br i1 %cmpi80.3, label %phiblock75.4, label %phiblock75.4.thread

phiblock75.4.thread:                              ; preds = %phiblock75.3, %phiblock75.3.thread
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.5.thread

phiblock75.4:                                     ; preds = %phiblock75.3
  %l_679.4 = load i64, ptr %gep35, align 8
  %cmpi80.4 = icmp ne i64 %l_679.4, 0
  %zext82.4 = zext i1 %cmpi80.4 to i64
  store i64 %zext82.4, ptr %gep71, align 8
  br i1 %cmpi80.4, label %phiblock75.5, label %phiblock75.5.thread

phiblock75.5.thread:                              ; preds = %phiblock75.4, %phiblock75.4.thread
  store i64 0, ptr %gep71, align 8
  br label %phiblock75.6

phiblock75.5:                                     ; preds = %phiblock75.4
  %l_679.5 = load i64, ptr %gep35, align 8
  %cmpi80.5 = icmp ne i64 %l_679.5, 0
  %zext82.5 = zext i1 %cmpi80.5 to i64
  store i64 %zext82.5, ptr %gep71, align 8
  br i1 %cmpi80.5, label %fullev74.6, label %phiblock75.6
...
phiblock75.6:                                     ; preds = %phiblock75.5.thread, %fullev74.6, %phiblock75.5
  %phi76.6 = phi i1 [ false, %phiblock75.5 ], [ %cmpi80.6, %fullev74.6 ], [ false, %phiblock75.5.thread ]
  %zext82.6 = zext i1 %phi76.6 to i64
  store i64 %zext82.6, ptr %gep71, align 8
  ...
  br i1 %cmpi73.not.1158, label %phiblock75.1164.thread, label %phiblock75.1164

phiblock75.1164.thread:                           ; preds = %phiblock75.6
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.1.1.thread

phiblock75.1164:                                  ; preds = %phiblock75.6
  %l_679.1159 = load i64, ptr %gep35, align 8
  %cmpi80.1160 = icmp ne i64 %l_679.1159, 0
  %zext82.1163 = zext i1 %cmpi80.1160 to i64
  store i64 %zext82.1163, ptr %gep71.1, align 8
  br i1 %cmpi80.1160, label %phiblock75.1.1, label %phiblock75.1.1.thread

phiblock75.1.1.thread:                            ; preds = %phiblock75.1164, %phiblock75.1164.thread
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.2.1.thread

phiblock75.1.1:                                   ; preds = %phiblock75.1164
  %l_679.1.1 = load i64, ptr %gep35, align 8
  %cmpi80.1.1 = icmp ne i64 %l_679.1.1, 0
  %zext82.1.1 = zext i1 %cmpi80.1.1 to i64
  store i64 %zext82.1.1, ptr %gep71.1, align 8
  br i1 %cmpi80.1.1, label %phiblock75.2.1, label %phiblock75.2.1.thread

phiblock75.2.1.thread:                            ; preds = %phiblock75.1.1, %phiblock75.1.1.thread
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.3.1.thread

phiblock75.2.1:                                   ; preds = %phiblock75.1.1
  %l_679.2.1 = load i64, ptr %gep35, align 8
  %cmpi80.2.1 = icmp ne i64 %l_679.2.1, 0
  %zext82.2.1 = zext i1 %cmpi80.2.1 to i64
  store i64 %zext82.2.1, ptr %gep71.1, align 8
  br i1 %cmpi80.2.1, label %phiblock75.3.1, label %phiblock75.3.1.thread

phiblock75.3.1.thread:                            ; preds = %phiblock75.2.1, %phiblock75.2.1.thread
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.4.1.thread

phiblock75.3.1:                                   ; preds = %phiblock75.2.1
  %l_679.3.1 = load i64, ptr %gep35, align 8
  %cmpi80.3.1 = icmp ne i64 %l_679.3.1, 0
  %zext82.3.1 = zext i1 %cmpi80.3.1 to i64
  store i64 %zext82.3.1, ptr %gep71.1, align 8
  br i1 %cmpi80.3.1, label %phiblock75.4.1, label %phiblock75.4.1.thread

phiblock75.4.1.thread:                            ; preds = %phiblock75.3.1, %phiblock75.3.1.thread
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.5.1.thread

phiblock75.4.1:                                   ; preds = %phiblock75.3.1
  %l_679.4.1 = load i64, ptr %gep35, align 8
  %cmpi80.4.1 = icmp ne i64 %l_679.4.1, 0
  %zext82.4.1 = zext i1 %cmpi80.4.1 to i64
  store i64 %zext82.4.1, ptr %gep71.1, align 8
  br i1 %cmpi80.4.1, label %phiblock75.5.1, label %phiblock75.5.1.thread

phiblock75.5.1.thread:                            ; preds = %phiblock75.4.1, %phiblock75.4.1.thread
  store i64 0, ptr %gep71.1, align 8
  br label %phiblock75.6.1

phiblock75.5.1:                                   ; preds = %phiblock75.4.1
  %l_679.5.1 = load i64, ptr %gep35, align 8
  %cmpi80.5.1 = icmp ne i64 %l_679.5.1, 0
  %zext82.5.1 = zext i1 %cmpi80.5.1 to i64
  store i64 %zext82.5.1, ptr %gep71.1, align 8
  br i1 %cmpi80.5.1, label %fullev74.6.1, label %phiblock75.6.1
...
phiblock75.6.1:                                   ; preds = %phiblock75.5.1.thread, %fullev74.6.1, %phiblock75.5.1
  %phi76.6.1 = phi i1 [ false, %phiblock75.5.1 ], [ %cmpi80.6.1, %fullev74.6.1 ], [ false, %phiblock75.5.1.thread ]
  %zext82.6.1 = zext i1 %phi76.6.1 to i64
  store i64 %zext82.6.1, ptr %gep71.1, align 8
  store i64 1, ptr %elem1, align 8
