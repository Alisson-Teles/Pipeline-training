...
/tmp/tmp.DdcvBjd9jR/saida.o:	file format elf32-littlearm
...
<safe_mul_func_int64_t_s_s>:
               	...
               	sbcs	r0, r1, #0x0
               	mov	r6, r2
               	blt	0x5e8 <safe_mul_func_int64_t_s_s+0x20> @ imm = #0x6
               	subs	r0, r6, #0x1
               	sbcs	r0, r8, #0x0
               	bge	0x65a <safe_mul_func_int64_t_s_s+0x92> @ imm = #0x70
               	subs	r0, r5, #0x1
               	sbcs	r0, r4, #0x0
               	blt	0x5fc <safe_mul_func_int64_t_s_s+0x34> @ imm = #0xa
               	rsbs	r0, r6, #0
               	mov.w	r0, #0x0
               	sbcs.w	r0, r0, r8
               	bge	0x636 <safe_mul_func_int64_t_s_s+0x6e> @ imm = #0x38
               	rsbs	r0, r5, #0
               	mov.w	r0, #0x0
               	sbcs	r0, r4
               	blt	0x624 <safe_mul_func_int64_t_s_s+0x5c> @ imm = #0x1c
               	subs	r0, r6, #0x1
               	sbcs	r0, r8, #0x0
               	blt	0x624 <safe_mul_func_int64_t_s_s+0x5c> @ imm = #0x14
               	movs	r0, #0x0
               	mov.w	r1, #0x80000000
               	mov	r2, r6
               	mov	r3, r8
               	bl	0x618 <safe_mul_func_int64_t_s_s+0x50> @ imm = #-0x4
               	subs	r0, r5, r0
               	sbcs.w	r0, r4, r1
               	blt	0x65a <safe_mul_func_int64_t_s_s+0x92> @ imm = #0x34
               	cmp.w	r4, #0xffffffff
               	bgt	0x64c <safe_mul_func_int64_t_s_s+0x84> @ imm = #0x20
               	rsbs	r0, r6, #0
               	mov.w	r0, #0x0
               	sbcs.w	r0, r0, r8
               	blt	0x64c <safe_mul_func_int64_t_s_s+0x84> @ imm = #0x14
               	movs	r0, #0x0
               	mov.w	r1, #0x80000000
               	mov	r2, r5
               	mov	r3, r4
               	bl	0x640 <safe_mul_func_int64_t_s_s+0x78> @ imm = #-0x4
               	subs	r0, r6, r0
               	sbcs.w	r0, r8, r1
               	blt	0x65a <safe_mul_func_int64_t_s_s+0x92> @ imm = #0xc
               	umull	r0, r1, r6, r5
               	mla	r1, r6, r4, r1
               	mla	r4, r8, r5, r1
               	mov	r5, r0
...
<safe_mod_func_int64_t_s_s>:
               	...
               	orrs.w	r12, r12, r0
               	bne	0x6a0 <safe_mod_func_int64_t_s_s+0x3c> @ imm = #0x24
               	...
               	eor.w	r12, r12, r3
               	orrs.w	r12, r12, lr
               	bne	0x6a0 <safe_mod_func_int64_t_s_s+0x3c> @ imm = #0xa
               	movs	r0, #0x0
               	mov.w	r1, #0x80000000
               	pop.w	{r7, lr}
               	bx	lr
               	bl	0x6a0 <safe_mod_func_int64_t_s_s+0x3c> @ imm = #-0x4
               	mov	r0, r2
               	mov	r1, r3
               	pop.w	{r7, lr}
               	bx	lr
...
<safe_div_func_int64_t_s_s>:
               	...
               	eor	r12, r1, #0x80000000
               	orrs.w	r12, r12, r0
               	bne	0x6ec <safe_div_func_int64_t_s_s+0x3c> @ imm = #0x24
               	mov.w	r12, #0x80000000
               	orn	r12, r12, #0x80000000
               	mov.w	lr, #0xffffffff
               	eor.w	lr, lr, r2
               	eor.w	r12, r12, r3
               	orrs.w	r12, r12, lr
               	bne	0x6ec <safe_div_func_int64_t_s_s+0x3c> @ imm = #0xa
               	movs	r0, #0x0
               	mov.w	r1, #0x80000000
               	pop.w	{r7, lr}
               	bx	lr
               	bl	0x6ec <safe_div_func_int64_t_s_s+0x3c> @ imm = #-0x4
               	pop.w	{r7, lr}
               	bx	lr
               	nop
...
<func_1>:
               	...
               	strd	r1, r0, [sp, #40]
               	strd	r1, r0, [sp, #48]
               	add.w	r5, r10, r9, lsl #3
               	movs	r6, #0x0
               	nop
               	add.w	r4, r10, r6
               	ldrd	r3, r1, [r4, #48]
               	orrs	r1, r3
               	beq	0xbb4 <func_1+0xd4>     @ imm = #0x6e
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #48]
               	beq	0xbb8 <func_1+0xd8>     @ imm = #0x62
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #48]
               	beq	0xbbc <func_1+0xdc>     @ imm = #0x56
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #48]
               	beq	0xbc0 <func_1+0xe0>     @ imm = #0x4a
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #48]
               	beq	0xbc4 <func_1+0xe4>     @ imm = #0x3e
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #48]
               	beq	0xbc8 <func_1+0xe8>     @ imm = #0x32
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	mov.w	r3, #0x0
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r3, [r4, #48]
               	beq	0xbce <func_1+0xee>     @ imm = #0x24
               	ldrd	r1, r3, [r5]
               	orrs	r3, r1
               	it	ne
               	movne	r3, #0x1
               	b	0xbce <func_1+0xee>     @ imm = #0x18
               	strd	r0, r0, [r4, #48]
               	strd	r0, r0, [r4, #48]
               	strd	r0, r0, [r4, #48]
               	strd	r0, r0, [r4, #48]
               	...
               	ldrd	r3, r1, [r4, #40]
               	orrs	r1, r3
               	beq	0xc50 <func_1+0x170>    @ imm = #0x70
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #40]
               	beq	0xc54 <func_1+0x174>    @ imm = #0x64
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #40]
               	beq	0xc58 <func_1+0x178>    @ imm = #0x58
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #40]
               	beq	0xc5c <func_1+0x17c>    @ imm = #0x4c
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #40]
               	beq	0xc60 <func_1+0x180>    @ imm = #0x40
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r0, [r4, #40]
               	beq	0xc64 <func_1+0x184>    @ imm = #0x34
               	ldrd	r1, r3, [r5]
               	orrs	r1, r3
               	mov.w	r3, #0x0
               	it	ne
               	movne	r1, #0x1
               	strd	r1, r3, [r4, #40]
               	beq	0xc6a <func_1+0x18a>    @ imm = #0x26
               	ldrd	r1, r3, [r5]
               	orrs	r3, r1
               	it	ne
               	movne	r3, #0x1
               	b	0xc6a <func_1+0x18a>    @ imm = #0x1a
               	nop
               	strd	r0, r0, [r4, #40]
               	strd	r0, r0, [r4, #40]
               	strd	r0, r0, [r4, #40]
               	...
               	str	r2, [sp, #0x8]
               	str	r0, [sp, #0xc]
               	bne.w	0xb38 <func_1+0x58>     @ imm = #-0x144
               	ldr	r1, [r5]
               	bics	r3, r1, #0xf
               	uxth	r1, r1
               	lsr.w	r4, r12, r1
               	...
               	mov	r9, r1
               	mov	r8, r3
               	blo.w	0xb30 <func_1+0x50>     @ imm = #-0x196
               	movs	r0, #0x7
               	movs	r1, #0x0
               	add	sp, #0x38
               	pop.w	{r8, r9, r10}
...
<main>:
               	push	{r7, lr}
               	mov	r7, sp
               	bl	0xcd8 <main+0x4>        @ imm = #-0x4
               	bl	0xcdc <main+0x8>        @ imm = #-0x4
               	bl	0xce0 <main+0xc>        @ imm = #-0x4
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
               	mvns	r0, r0
               	bl	0xcf2 <main+0x1e>       @ imm = #-0x4
               	movs	r0, #0x0
               	pop	{r7, pc}
