; ModuleID = 'arquivos-compilados-stm32-1000/01005.ll'
source_filename = "out/01005.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 17), (20, 37), (40, 44)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf9 = getelementptr inbounds nuw i8, ptr %_this, i32 40
  store i32 0, ptr %gepf9, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(17) %gepf5, i8 0, i64 17, i1 false)
  ret void
}
...
define noundef zeroext i16 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i16 1
}
