; ModuleID = 'arquivos-compilados-stm32-1000/00513.ll'
...
while_cond478.preheader:                          ; preds = %while_cond609.preheader, %body
...
while_cond485.preheader:                          ; preds = %while_cond485.preheader, %while_cond478.preheader
  %l_30.3792 = phi i32 [ 0, %while_cond478.preheader ], [ %binop501.3, %while_cond485.preheader ]
  %binop501.3 = add nuw nsw i32 %l_30.3792, 4
  %exitcond.not.3 = icmp eq i32 %binop501.3, 8
