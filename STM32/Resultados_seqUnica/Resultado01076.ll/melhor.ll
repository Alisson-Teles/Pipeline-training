; ModuleID = 'arquivos-compilados-stm32-1000/01076.ll'
source_filename = "out/01076.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 14)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(10) %gepf1, i8 0, i64 10, i1 false)
  ret void
}
...
define noundef range(i32 0, 2048) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i32 15
}
