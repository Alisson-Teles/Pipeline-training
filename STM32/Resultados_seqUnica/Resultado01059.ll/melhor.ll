; ModuleID = 'arquivos-compilados-stm32-1000/01059.ll'
...
body:
  ...
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 10
  store i8 0, ptr %gepf2, align 1
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 3), (4, 6), (8, 29), (30, 32)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  store i16 0, ptr %gepf2, align 2
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 30
  store i16 0, ptr %gepf8, align 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(21) %gepf3, i8 0, i64 21, i1 false)
  ret void
}
