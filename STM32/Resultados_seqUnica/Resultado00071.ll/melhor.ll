; ModuleID = 'arquivos-compilados-stm32-1000/00071.ll'
source_filename = "out/00071.rob"
...
body:
  br label %while_cond178.preheader

while_cond178.preheader:                          ; preds = %while_cond178.preheader, %body
  br label %while_cond178.preheader
}
...
body:
  ...
  br label %while_cond178.preheader.i

while_cond178.preheader.i:                        ; preds = %while_cond178.preheader.i, %body
  br label %while_cond178.preheader.i
}
