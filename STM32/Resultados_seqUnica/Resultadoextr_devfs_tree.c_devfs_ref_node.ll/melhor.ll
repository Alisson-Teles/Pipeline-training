; ModuleID = 'angha-ll-stm32f1/extr_devfs_tree.c_devfs_ref_node.ll'
source_filename = "out/extr_devfs_tree.c_devfs_ref_node.rob"
...
define void @devfs_ref_node(ptr captures(none) %dnp) local_unnamed_addr addrspace(1) #1 {
body:
  %loadleftv = load i32, ptr %dnp, align 4
  %binop = add i32 %loadleftv, 1
  store i32 %binop, ptr %dnp, align 4
  ret void
}
