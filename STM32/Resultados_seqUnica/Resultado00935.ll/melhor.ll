; ModuleID = 'arquivos-compilados-stm32-1000/00935.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (8, 25), (26, 29), (32, 40)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i18 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 26
  store i16 0, ptr %gepf4, align 2
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 28
  store i8 0, ptr %gepf5, align 1
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 32
  store i64 0, ptr %gepf6, align 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(17) %gepf1, i8 0, i64 17, i1 false)
  ret void
}
