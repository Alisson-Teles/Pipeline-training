; ModuleID = 'arquivos-compilados-stm32-1000/00016.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4), (8, 17)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  %l_37.f2 = load i8, ptr inttoptr (i32 16 to ptr), align 16
