; ModuleID = 'arquivos-compilados-stm32-1000/01253.ll'
source_filename = "out/01253.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4), (8, 20), (24, 32)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
