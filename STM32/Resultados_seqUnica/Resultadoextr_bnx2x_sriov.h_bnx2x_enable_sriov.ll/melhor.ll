; ModuleID = 'angha-ll-stm32f1/extr_bnx2x_sriov.h_bnx2x_enable_sriov.ll'
source_filename = "out/extr_bnx2x_sriov.h_bnx2x_enable_sriov.rob"
...
define noundef i32 @bnx2x_enable_sriov(ptr readnone captures(none) %bp) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
