; ModuleID = 'arquivos-compilados-stm32-1000/00836.ll'
source_filename = "out/00836.rob"
...
while_cond183:                                    ; preds = %while_cond183, %body
  br label %while_cond183
}
...
body:
  ...
  br label %while_cond183.i

while_cond183.i:                                  ; preds = %while_cond183.i, %body
  br label %while_cond183.i
}
