; ModuleID = 'arquivos-compilados-stm32-1000/00645.ll'
...
body:
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(7) %_this, i8 0, i64 7, i1 false)
  ret void
}
