; ModuleID = 'arquivos-compilados-stm32-1000/00180.ll'
source_filename = "out/00180.rob"
...
body:
  br label %while_cond42.preheader

while_cond42.preheader:                           ; preds = %while_cond42.preheader.3, %body
  %l_2.0227 = phi i32 [ 0, %body ], [ %sext.3, %while_cond42.preheader.3 ]
  %cmpi.i = icmp slt i32 %l_2.0227, 0
  %0 = shl nsw i32 %l_2.0227, 24
  %1 = add i32 %0, -83886080
  %2 = ashr exact i32 %1, 24
  %sext = select i1 %cmpi.i, i32 %l_2.0227, i32 %2
  %cmpi31 = icmp sgt i32 %sext, -26
  br i1 %cmpi31, label %while_cond42.preheader.1, label %while_body129

while_cond42.preheader.1:                         ; preds = %while_cond42.preheader
  %cmpi.i.1 = icmp slt i32 %sext, 0
  %3 = shl nsw i32 %sext, 24
  %4 = add i32 %3, -83886080
  %5 = ashr exact i32 %4, 24
  %sext.1 = select i1 %cmpi.i.1, i32 %sext, i32 %5
  %cmpi31.1 = icmp sgt i32 %sext.1, -26
  br i1 %cmpi31.1, label %while_cond42.preheader.2, label %while_body129

while_cond42.preheader.2:                         ; preds = %while_cond42.preheader.1
  %cmpi.i.2 = icmp slt i32 %sext.1, 0
  %6 = shl nsw i32 %sext.1, 24
  %7 = add i32 %6, -83886080
  %8 = ashr exact i32 %7, 24
  %sext.2 = select i1 %cmpi.i.2, i32 %sext.1, i32 %8
  %cmpi31.2 = icmp sgt i32 %sext.2, -26
  br i1 %cmpi31.2, label %while_cond42.preheader.3, label %while_body129

while_cond42.preheader.3:                         ; preds = %while_cond42.preheader.2
  %cmpi.i.3 = icmp slt i32 %sext.2, 0
  %9 = shl nsw i32 %sext.2, 24
  %10 = add i32 %9, -83886080
  %11 = ashr exact i32 %10, 24
  %sext.3 = select i1 %cmpi.i.3, i32 %sext.2, i32 %11
  %cmpi31.3 = icmp sgt i32 %sext.3, -26
  br i1 %cmpi31.3, label %while_cond42.preheader, label %while_body129

while_body129:                                    ; preds = %while_cond42.preheader.3, %while_cond42.preheader.2, %while_cond42.preheader.1, %while_cond42.preheader
  ret i32 -79
}
...
body:
  ...
  br label %while_cond42.preheader.i

while_cond42.preheader.i:                         ; preds = %while_cond42.preheader.i.3, %body
  %l_2.0227.i = phi i32 [ 0, %body ], [ %sext.i.3, %while_cond42.preheader.i.3 ]
  %cmpi.i.i = icmp slt i32 %l_2.0227.i, 0
  %0 = shl nsw i32 %l_2.0227.i, 24
  %1 = add i32 %0, -83886080
  %2 = ashr exact i32 %1, 24
  %sext.i = select i1 %cmpi.i.i, i32 %l_2.0227.i, i32 %2
  %cmpi31.i = icmp sgt i32 %sext.i, -26
  br i1 %cmpi31.i, label %while_cond42.preheader.i.1, label %func_1.exit

while_cond42.preheader.i.1:                       ; preds = %while_cond42.preheader.i
  %cmpi.i.i.1 = icmp slt i32 %sext.i, 0
  %3 = shl nsw i32 %sext.i, 24
  %4 = add i32 %3, -83886080
  %5 = ashr exact i32 %4, 24
  %sext.i.1 = select i1 %cmpi.i.i.1, i32 %sext.i, i32 %5
  %cmpi31.i.1 = icmp sgt i32 %sext.i.1, -26
  br i1 %cmpi31.i.1, label %while_cond42.preheader.i.2, label %func_1.exit

while_cond42.preheader.i.2:                       ; preds = %while_cond42.preheader.i.1
  %cmpi.i.i.2 = icmp slt i32 %sext.i.1, 0
  %6 = shl nsw i32 %sext.i.1, 24
  %7 = add i32 %6, -83886080
  %8 = ashr exact i32 %7, 24
  %sext.i.2 = select i1 %cmpi.i.i.2, i32 %sext.i.1, i32 %8
  %cmpi31.i.2 = icmp sgt i32 %sext.i.2, -26
  br i1 %cmpi31.i.2, label %while_cond42.preheader.i.3, label %func_1.exit

while_cond42.preheader.i.3:                       ; preds = %while_cond42.preheader.i.2
  %cmpi.i.i.3 = icmp slt i32 %sext.i.2, 0
  %9 = shl nsw i32 %sext.i.2, 24
  %10 = add i32 %9, -83886080
  %11 = ashr exact i32 %10, 24
  %sext.i.3 = select i1 %cmpi.i.i.3, i32 %sext.i.2, i32 %11
  %cmpi31.i.3 = icmp sgt i32 %sext.i.3, -26
  br i1 %cmpi31.i.3, label %while_cond42.preheader.i, label %func_1.exit

func_1.exit:                                      ; preds = %while_cond42.preheader.i.3, %while_cond42.preheader.i.2, %while_cond42.preheader.i.1, %while_cond42.preheader.i
