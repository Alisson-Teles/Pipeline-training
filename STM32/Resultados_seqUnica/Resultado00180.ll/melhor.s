...
/tmp/tmp.xgIWrJRUQO/saida.o:	file format elf32-littlearm
...
<func_1>:
               	...
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb18 <func_1+0x4c>     @ imm = #0x2e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb18 <func_1+0x4c>     @ imm = #0x1e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb18 <func_1+0x4c>     @ imm = #0xe
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x1a
               	bgt	0xad8 <func_1+0xc>      @ imm = #-0x42
               	mvn	r0, #0x4e
               	pop	{r7, pc}
               	nop
...
<main>:
               	...
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb74 <main+0x54>       @ imm = #0x2e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb74 <main+0x54>       @ imm = #0x1e
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x19
               	blt	0xb74 <main+0x54>       @ imm = #0xe
               	cmp	r0, #0x0
               	add.w	r2, r1, r0, lsl #24
               	it	pl
               	asrpl	r0, r2, #0x18
               	cmn.w	r0, #0x1a
               	bgt	0xb34 <main+0x14>       @ imm = #-0x42
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
               	mvns	r0, r0
               	bl	0xb82 <main+0x62>       @ imm = #-0x4
               	movs	r0, #0x0
               	pop	{r7, pc}
