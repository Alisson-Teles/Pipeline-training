; ModuleID = 'arquivos-compilados-stm32-1000/00252.ll'
source_filename = "out/00252.rob"
...
body:
  br label %while_cond85

while_cond85:                                     ; preds = %while_cond85, %body
  br label %while_cond85
}
...
body:
  ...
  br label %while_cond85.i

while_cond85.i:                                   ; preds = %while_cond85.i, %body
  br label %while_cond85.i
}
