; ModuleID = 'arquivos-compilados-stm32-1000/01143.ll'
source_filename = "out/01143.rob"
...
define noundef range(i32 -128, 128) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_cond7

while_cond7:                                      ; preds = %while_cond7, %body
  br label %while_cond7
}
...
body:
  ...
  br label %while_cond7.i

while_cond7.i:                                    ; preds = %while_cond7.i, %body
  br label %while_cond7.i
}
