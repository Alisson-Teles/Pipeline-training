; ModuleID = 'arquivos-compilados-stm32-1000/00945.ll'
source_filename = "out/00945.rob"
...
define noundef zeroext i8 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_cond140

while_cond140:                                    ; preds = %while_cond140, %body
  br label %while_cond140
}
...
body:
  ...
  br label %while_cond140.i

while_cond140.i:                                  ; preds = %while_cond140.i, %body
  br label %while_cond140.i
}
