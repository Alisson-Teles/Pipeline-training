; ModuleID = 'arquivos-compilados-stm32-1000/00808.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (2, 7), (8, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i2 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  store i15 0, ptr %gepf1, align 2
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i21 0, ptr %gepf2, align 4
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i13 0, ptr %gepf3, align 2
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 10
  store i8 0, ptr %gepf4, align 1
  ret void
}
...
body:
  %l_4.sroa.0 = alloca ptr, align 4
  store i2 0, ptr %l_4.sroa.0, align 4
  %l_4.sroa.0.2.sroa_idx2 = getelementptr inbounds nuw i8, ptr %l_4.sroa.0, i32 2
  store i15 0, ptr %l_4.sroa.0.2.sroa_idx2, align 2
  store i2 0, ptr %l_4.sroa.0, align 4
  store i15 36, ptr %l_4.sroa.0.2.sroa_idx2, align 2
  %l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.deref = load ptr, ptr %l_4.sroa.0, align 4
  %f414 = getelementptr inbounds nuw i8, ptr %l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.l_4.sroa.0.0.deref, i32 10
