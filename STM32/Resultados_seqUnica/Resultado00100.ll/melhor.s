...
/tmp/tmp.q47nUnecBF/saida.o:	file format elf32-littlearm
...
<func_1>:
               	...
               	str	r0, [sp, #0xc]
               	str	r1, [sp, #0x8]
               	b	0xb16 <func_1+0x4a>     @ imm = #0xa
               	nop
               	ldr	r0, [sp, #0x4]
               	adds	r0, #0x1
               	cmp	r0, #0x7
               	beq.w	0xc32 <func_1+0x166>    @ imm = #0x11c
               	movw	r12, #0x32f
               	add.w	r11, r10, r0, lsl #3
               	movs	r4, #0x0
               	movt	r12, #0x59a7
               	str	r0, [sp, #0x4]
               	b	0xb78 <func_1+0xac>     @ imm = #0x4e
               	add.w	r0, r10, r4
               	ldr	r1, [r0, #0x4]
               	ldr.w	r2, [r10, r4]
               	movw	r5, #0xb5fb
               	...
               	adds	r4, #0x8
               	cmp	r4, #0x38
               	beq	0xb0c <func_1+0x40>     @ imm = #-0x6e
               	ldr.w	r5, [r11]
               	movs	r0, #0x0
               	cmp	r5, #0x1
               	eor.w	r1, r5, lr
               	...
               	it	gt
               	movgt	r1, #0x1
               	rsbs.w	r6, r5, #0x80000000
               	mov.w	r2, #0xffffffff
               	asr.w	r3, r5, #0x1f
               	sbc.w	r2, r2, r5, asr #31
               	subs	r6, r5, r6
               	sbcs.w	r2, r3, r2
               	mov.w	r2, #0x0
               	it	ge
               	...
               	it	ne
               	andsne	r0, r9, #0x1
               	bne	0xb28 <func_1+0x5c>     @ imm = #-0xde
               	movw	r0, #0xea07
               	movt	r0, #0xca1a
               	orr.w	r0, r0, r9
               	strd	r0, r8, [sp, #8]
...
<main>:
               	push	{r7, lr}
               	mov	r7, sp
               	bl	0xc44 <main+0x4>        @ imm = #-0x4
               	bl	0xc48 <main+0x8>        @ imm = #-0x4
               	bl	0xc4c <main+0xc>        @ imm = #-0x4
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
               	mvns	r0, r0
               	bl	0xc5e <main+0x1e>       @ imm = #-0x4
               	movs	r0, #0x0
               	pop	{r7, pc}
