; ModuleID = 'arquivos-compilados-stm32-1000/00954.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 7)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i11 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i20 0, ptr %gepf1, align 4
  ret void
}
...
body:
  ...
  store i11 29, ptr %l_2.sroa.0, align 4
  %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref58 = load ptr, ptr %l_2.sroa.0, align 4
  %l_2.f0 = load i11, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref58, align 2
