; ModuleID = 'arquivos-compilados-stm32-1000/01262.ll'
source_filename = "out/01262.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S1 = type { i8, i8, i32, i8, i8 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2), (4, 10)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 9
...
body:
  ret %S1 { i8 -2, i8 -103, i32 0, i8 -117, i8 45 }
}
