; ModuleID = 'arquivos-compilados-stm32-1000/00809.ll'
source_filename = "out/00809.rob"
...
while_cond23:                                     ; preds = %while_cond23, %body
  br label %while_cond23
}
...
body:
  ...
  br label %while_cond23.i

while_cond23.i:                                   ; preds = %while_cond23.i, %body
  br label %while_cond23.i
}
