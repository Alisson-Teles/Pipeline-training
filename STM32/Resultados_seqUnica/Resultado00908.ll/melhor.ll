; ModuleID = 'arquivos-compilados-stm32-1000/00908.ll'
source_filename = "out/00908.rob"
...
define noundef zeroext range(i16 -128, 128) i16 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i16 9
}
