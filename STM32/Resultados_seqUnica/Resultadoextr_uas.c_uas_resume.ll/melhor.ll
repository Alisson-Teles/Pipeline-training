; ModuleID = 'angha-ll-stm32f1/extr_uas.c_uas_resume.ll'
source_filename = "out/extr_uas.c_uas_resume.rob"
...
define noundef i32 @uas_resume(ptr readnone captures(none) %intf) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
