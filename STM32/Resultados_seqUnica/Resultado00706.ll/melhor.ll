; ModuleID = 'arquivos-compilados-stm32-1000/00706.ll'
source_filename = "out/00706.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 11), (12, 14), (16, 21), (22, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i15 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  store i8 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i32 0, ptr %gepf2, align 4
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i18 0, ptr %gepf3, align 4
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i15 0, ptr %gepf4, align 2
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i31 0, ptr %gepf5, align 4
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i4 0, ptr %gepf6, align 1
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 22
  store i13 0, ptr %gepf7, align 2
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i10 0, ptr %gepf8, align 2
  %gepf9 = getelementptr inbounds nuw i8, ptr %_this, i32 26
  store i10 0, ptr %gepf9, align 2
  ret void
}
...
define range(i32 0, 16) i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_7.sroa.0 = alloca ptr, align 4
  store i15 0, ptr %l_7.sroa.0, align 4
  %l_7.sroa.0.2.sroa_idx = getelementptr inbounds nuw i8, ptr %l_7.sroa.0, i32 2
  store i8 0, ptr %l_7.sroa.0.2.sroa_idx, align 2
  store i15 -122, ptr %l_7.sroa.0, align 4
  store i8 10, ptr %l_7.sroa.0.2.sroa_idx, align 2
  %l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.deref208 = load ptr, ptr %l_7.sroa.0, align 4
  %f6209 = getelementptr inbounds nuw i8, ptr %l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.l_7.sroa.0.0.deref208, i32 20
  %l_7.f6 = load i4, ptr %f6209, align 1
  %zext210 = zext i4 %l_7.f6 to i32
  ret i32 %zext210
}
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
