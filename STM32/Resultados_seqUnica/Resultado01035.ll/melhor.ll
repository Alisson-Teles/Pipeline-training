; ModuleID = 'arquivos-compilados-stm32-1000/01035.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2), (4, 7), (8, 9), (12, 15), (16, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i22 0, ptr %gepf1, align 4
