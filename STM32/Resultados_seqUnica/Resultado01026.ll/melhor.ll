; ModuleID = 'arquivos-compilados-stm32-1000/01026.ll'
source_filename = "out/01026.rob"
...
define noundef range(i64 0, 4294967296) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 1
}
