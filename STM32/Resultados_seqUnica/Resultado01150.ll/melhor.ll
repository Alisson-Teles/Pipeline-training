; ModuleID = 'arquivos-compilados-stm32-1000/01150.ll'
source_filename = "out/01150.rob"
...
define noundef range(i64 -128, 128) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  ret i64 -26
}
