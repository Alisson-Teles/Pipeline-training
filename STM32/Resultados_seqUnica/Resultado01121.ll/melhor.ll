; ModuleID = 'arquivos-compilados-stm32-1000/01121.ll'
source_filename = "out/01121.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
