; ModuleID = 'arquivos-compilados-stm32-1000/00941.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 11), (12, 14)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i31 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i30 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i22 0, ptr %gepf2, align 4
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i16 0, ptr %gepf3, align 2
  ret void
}
...
body:
  %l_28.sroa.0 = alloca ptr, align 4
  store i31 29832, ptr %l_28.sroa.0, align 4
  %l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103 = load ptr, ptr %l_28.sroa.0, align 4
  %f1104 = getelementptr inbounds nuw i8, ptr %l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103, i32 4
  store i30 -451890476, ptr %f1104, align 4
  ret i32 -20609
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_28.sroa.0.i = alloca ptr, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_28.sroa.0.i)
  store i31 29832, ptr %l_28.sroa.0.i, align 4
  %l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103.i = load ptr, ptr %l_28.sroa.0.i, align 4
  %f1104.i = getelementptr inbounds nuw i8, ptr %l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.i.0.l_28.sroa.0.0.l_28.sroa.0.0.l_28.sroa.0.0.deref103.i, i32 4
  store i30 -451890476, ptr %f1104.i, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_28.sroa.0.i)
