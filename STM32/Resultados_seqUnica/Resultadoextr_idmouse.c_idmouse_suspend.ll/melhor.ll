; ModuleID = 'angha-ll-stm32f1/extr_idmouse.c_idmouse_suspend.ll'
source_filename = "out/extr_idmouse.c_idmouse_suspend.rob"
...
define noundef i32 @idmouse_suspend(ptr readnone captures(none) %intf, i32 %message) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
