; ModuleID = 'arquivos-compilados-stm32-1000/00038.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 18), (20, 28), (32, 41)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i32 0, ptr %gepf3, align 4
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i32 0, ptr %gepf4, align 4
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 32
  store i64 0, ptr %gepf5, align 8
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 40
  store i8 0, ptr %gepf6, align 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(18) %_this, i8 0, i64 18, i1 false)
  ret void
}
