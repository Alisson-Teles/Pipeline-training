...
/tmp/tmp.Fr95HnyaCp/saida.o:	file format elf32-littlearm
...
<func_1>:
               	...
               	cmp	r0, #0x8
               	str	r1, [r2, #0x4]
               	bne	0xb44 <func_1+0x20>     @ imm = #-0xbe
               	ldr	r0, [sp, #0x14]
               	add	sp, #0x20
               	pop	{r7, pc}
               	nop
...
<main>:
               	push	{r7, lr}
               	mov	r7, sp
               	bl	0xc0c <main+0x4>        @ imm = #-0x4
               	bl	0xc10 <main+0x8>        @ imm = #-0x4
               	movs	r0, #0x8
               	nop
               	subs	r0, #0x2
               	bne	0xc18 <main+0x10>       @ imm = #-0x6
               	movw	r0, #0x0
               	movt	r0, #0x0
               	ldm	r0, {r0, r1}
               	movs	r2, #0x0
               	mvns	r0, r0
               	bl	0xc2a <main+0x22>       @ imm = #-0x4
               	movs	r0, #0x0
               	pop	{r7, pc}
