; ModuleID = 'arquivos-compilados-stm32-1000/01103.ll'
...
fullev6:                                          ; preds = %body
  ...
  %cmpi11 = icmp sgt i64 %si1, %binop
  br i1 %cmpi11, label %common.ret, label %fullev13.thread

fullev13.thread:                                  ; preds = %fullev6
  %cmpi221 = icmp slt i64 %si2, 1
  br label %fullev33
...
fullev33:                                         ; preds = %fullev13.thread, %fullev13
  %cmpi223 = phi i1 [ %cmpi221, %fullev13.thread ], [ %cmpi22, %fullev13 ]
...
fullev53:                                         ; preds = %fullev44, %fullev33
  ...
  %or.cond = select i1 %0, i1 %cmpi223, i1 false
...
while_cond56.preheader:                           ; preds = %while_end69, %body
...
body:
  ...
  tail call addrspace(1) void @platform_main_end(i64 zeroext %binop, i32 noundef 0)
  ret i32 0
}
...
attributes #2 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
