; ModuleID = 'arquivos-compilados-stm32-1000/00275.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4), (8, 21), (22, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 22
  store i16 0, ptr %gepf6, align 2
  store i32 0, ptr %_this, align 2
  ret void
}
...
body:
  %l_25.f4 = load i32, ptr inttoptr (i32 33488913 to ptr), align 4
