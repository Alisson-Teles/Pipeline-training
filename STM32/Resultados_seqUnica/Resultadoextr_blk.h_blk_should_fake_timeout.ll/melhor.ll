; ModuleID = 'angha-ll-stm32f1/extr_blk.h_blk_should_fake_timeout.ll'
source_filename = "out/extr_blk.h_blk_should_fake_timeout.rob"
...
define noundef i32 @blk_should_fake_timeout(ptr readnone captures(none) %q) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
