; ModuleID = 'arquivos-compilados-stm32-1000/00421.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (8, 19)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 1
  store i8 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  ...
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 18
