; ModuleID = 'arquivos-compilados-stm32-1000/00185.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 14), (16, 20)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
