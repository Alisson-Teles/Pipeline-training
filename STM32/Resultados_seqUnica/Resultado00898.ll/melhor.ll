; ModuleID = 'arquivos-compilados-stm32-1000/00898.ll'
source_filename = "out/00898.rob"
...
define noundef zeroext range(i64 0, 256) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 11
}
