; ModuleID = 'arquivos-compilados-stm32-1000/00944.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4), (8, 18)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
