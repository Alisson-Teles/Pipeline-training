; ModuleID = 'arquivos-compilados-stm32-1000/01043.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (4, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i31 0, ptr %gepf1, align 4
...
body:
  %l_18.f2 = load i32, ptr inttoptr (i32 22 to ptr), align 4
  ret i32 %l_18.f2
}
