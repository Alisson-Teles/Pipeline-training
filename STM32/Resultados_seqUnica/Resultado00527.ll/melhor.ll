; ModuleID = 'arquivos-compilados-stm32-1000/00527.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 9), (12, 18), (20, 32)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i64 0, ptr %_this, align 8
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i8 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i32 0, ptr %gepf2, align 4
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i8 0, ptr %gepf3, align 1
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 17
  store i8 0, ptr %gepf4, align 1
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %gepf5, i8 0, i64 12, i1 false)
  ret void
}
...
body:
  store i8 1, ptr inttoptr (i32 16 to ptr), align 16
  store i32 5, ptr inttoptr (i32 19 to ptr), align 4
  ret i16 7
}
