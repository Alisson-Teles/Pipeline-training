; ModuleID = 'arquivos-compilados-stm32-1000/01189.ll'
source_filename = "out/01189.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 5)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i17 0, ptr %_this, align 4
