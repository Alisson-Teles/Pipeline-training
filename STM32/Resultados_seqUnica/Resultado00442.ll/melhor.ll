; ModuleID = 'arquivos-compilados-stm32-1000/00442.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 7), (8, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 6
  store i8 0, ptr %gepf3, align 1
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i16 0, ptr %gepf4, align 2
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 10
