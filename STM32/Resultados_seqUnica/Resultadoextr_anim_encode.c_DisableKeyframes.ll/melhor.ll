; ModuleID = 'angha-ll-stm32f1/extr_anim_encode.c_DisableKeyframes.ll'
source_filename = "out/extr_anim_encode.c_DisableKeyframes.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

@INT_MAX = local_unnamed_addr global i64 0
...
define void @DisableKeyframes(ptr writeonly captures(none) initializes((0, 16)) %enc_options) local_unnamed_addr addrspace(1) #1 {
body:
  %INT_MAX = load i64, ptr @INT_MAX, align 8
  store i64 %INT_MAX, ptr %enc_options, align 8
  %kmin = getelementptr inbounds nuw i8, ptr %enc_options, i32 8
  %binop = add i64 %INT_MAX, -1
  store i64 %binop, ptr %kmin, align 8
  ret void
}
