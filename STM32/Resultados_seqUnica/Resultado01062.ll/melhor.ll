; ModuleID = 'arquivos-compilados-stm32-1000/01062.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 7), (8, 9), (16, 25), (28, 37)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i18 0, ptr %gepf1, align 4
  ...
  store i64 0, ptr %gepf3, align 8
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i8 0, ptr %gepf4, align 1
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(9) %gepf5, i8 0, i64 9, i1 false)
  ret void
}
...
while_cond33:                                     ; preds = %while_cond33, %body
  br label %while_cond33
}
...
attributes #3 = { nofree norecurse noreturn nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
attributes #4 = { noreturn "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
