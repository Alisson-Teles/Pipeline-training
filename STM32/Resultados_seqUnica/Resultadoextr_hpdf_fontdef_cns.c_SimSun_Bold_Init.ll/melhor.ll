; ModuleID = 'angha-ll-stm32f1/extr_hpdf_fontdef_cns.c_SimSun_Bold_Init.ll'
source_filename = "out/extr_hpdf_fontdef_cns.c_SimSun_Bold_Init.rob"
...
declare i64 @SimSun_Init(i32) local_unnamed_addr addrspace(1) #0

define i64 @SimSun_Bold_Init(i32 %fontdef) local_unnamed_addr addrspace(1) #0 {
body:
  %0 = tail call addrspace(1) i64 @SimSun_Init(i32 %fontdef)
