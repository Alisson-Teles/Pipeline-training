; ModuleID = 'arquivos-compilados-stm32-1000/00971.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 10), (12, 24)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
