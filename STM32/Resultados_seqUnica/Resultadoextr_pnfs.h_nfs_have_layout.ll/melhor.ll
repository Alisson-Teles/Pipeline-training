; ModuleID = 'angha-ll-stm32f1/extr_pnfs.h_nfs_have_layout.ll'
source_filename = "out/extr_pnfs.h_nfs_have_layout.rob"
...
define noundef i32 @nfs_have_layout(ptr readnone captures(none) %inode) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
