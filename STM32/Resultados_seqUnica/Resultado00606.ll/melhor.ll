; ModuleID = 'arquivos-compilados-stm32-1000/00606.ll'
source_filename = "out/00606.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 9), (10, 15), (16, 18), (20, 26)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i29 0, ptr %_this, align 4
  ...
  store i6 0, ptr %gepf2, align 1
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 10
  store i16 0, ptr %gepf3, align 2
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i21 0, ptr %gepf4, align 4
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i13 0, ptr %gepf5, align 2
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i26 0, ptr %gepf6, align 4
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i11 0, ptr %gepf7, align 2
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 2), (8, 19)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
