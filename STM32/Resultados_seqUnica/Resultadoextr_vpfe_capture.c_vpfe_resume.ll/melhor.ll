; ModuleID = 'angha-ll-stm32f1/extr_vpfe_capture.c_vpfe_resume.ll'
source_filename = "out/extr_vpfe_capture.c_vpfe_resume.rob"
...
define noundef i32 @vpfe_resume(ptr readnone captures(none) %dev) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 -1
}
