; ModuleID = 'arquivos-compilados-stm32-1000/00939.ll'
source_filename = "out/00939.rob"
...
while_cond196:                                    ; preds = %while_cond196, %body
  br label %while_cond196
}
...
body:
  ...
  br label %while_cond196.i

while_cond196.i:                                  ; preds = %while_cond196.i, %body
  br label %while_cond196.i
}
