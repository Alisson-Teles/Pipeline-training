; ModuleID = 'arquivos-compilados-stm32-1000/00830.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 7), (8, 13), (16, 19)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i13 0, ptr %_this, align 2
