; ModuleID = 'arquivos-compilados-stm32-1000/00873.ll'
source_filename = "out/00873.rob"
...
define noundef zeroext i16 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_body74

while_body74:                                     ; preds = %while_body74.3, %body
  %l_8.0886 = phi i32 [ 0, %body ], [ %sext84.3, %while_body74.3 ]
  %cmpi.i705 = icmp sgt i32 %l_8.0886, -1
  %binop.i706 = sext i1 %cmpi.i705 to i32
  %spec.select.i707 = add nsw i32 %l_8.0886, %binop.i706
  %sext = shl i32 %spec.select.i707, 24
  %cmpi73.not = icmp eq i32 %sext, -33554432
  br i1 %cmpi73.not, label %while_body88.preheader, label %while_body74.1

while_body74.1:                                   ; preds = %while_body74
  %cmpi.i705.1 = icmp sgt i32 %sext, -1
  %binop.i706.1 = sext i1 %cmpi.i705.1 to i32
  %spec.select.i707.1 = add nsw i32 %spec.select.i707, %binop.i706.1
  %sext.1 = shl i32 %spec.select.i707.1, 24
  %cmpi73.not.1 = icmp eq i32 %sext.1, -33554432
  br i1 %cmpi73.not.1, label %while_body88.preheader, label %while_body74.2

while_body74.2:                                   ; preds = %while_body74.1
  %cmpi.i705.2 = icmp sgt i32 %sext.1, -1
  %binop.i706.2 = sext i1 %cmpi.i705.2 to i32
  %spec.select.i707.2 = add nsw i32 %spec.select.i707.1, %binop.i706.2
  %sext.2 = shl i32 %spec.select.i707.2, 24
  %cmpi73.not.2 = icmp eq i32 %sext.2, -33554432
  br i1 %cmpi73.not.2, label %while_body88.preheader, label %while_body74.3

while_body74.3:                                   ; preds = %while_body74.2
  %cmpi.i705.3 = icmp sgt i32 %sext.2, -1
  %binop.i706.3 = sext i1 %cmpi.i705.3 to i32
  %spec.select.i707.3 = add nsw i32 %spec.select.i707.2, %binop.i706.3
  %sext.3 = shl i32 %spec.select.i707.3, 24
  %sext84.3 = ashr exact i32 %sext.3, 24
  %cmpi73.not.3 = icmp eq i32 %sext.3, -33554432
  br i1 %cmpi73.not.3, label %while_body88.preheader, label %while_body74

while_body88.preheader:                           ; preds = %while_body74.3, %while_body74.2, %while_body74.1, %while_body74
  ret i16 -7
}
...
body:
  ...
  br label %while_body74.i

while_body74.i:                                   ; preds = %while_body74.i.3, %body
  %l_8.0886.i = phi i32 [ 0, %body ], [ %sext84.i.3, %while_body74.i.3 ]
  %cmpi.i705.i = icmp sgt i32 %l_8.0886.i, -1
  %binop.i706.i = sext i1 %cmpi.i705.i to i32
  %spec.select.i707.i = add nsw i32 %l_8.0886.i, %binop.i706.i
  %sext.i = shl i32 %spec.select.i707.i, 24
  %cmpi73.not.i = icmp eq i32 %sext.i, -33554432
  br i1 %cmpi73.not.i, label %func_1.exit, label %while_body74.i.1

while_body74.i.1:                                 ; preds = %while_body74.i
  %cmpi.i705.i.1 = icmp sgt i32 %sext.i, -1
  %binop.i706.i.1 = sext i1 %cmpi.i705.i.1 to i32
  %spec.select.i707.i.1 = add nsw i32 %spec.select.i707.i, %binop.i706.i.1
  %sext.i.1 = shl i32 %spec.select.i707.i.1, 24
  %cmpi73.not.i.1 = icmp eq i32 %sext.i.1, -33554432
  br i1 %cmpi73.not.i.1, label %func_1.exit, label %while_body74.i.2

while_body74.i.2:                                 ; preds = %while_body74.i.1
  %cmpi.i705.i.2 = icmp sgt i32 %sext.i.1, -1
  %binop.i706.i.2 = sext i1 %cmpi.i705.i.2 to i32
  %spec.select.i707.i.2 = add nsw i32 %spec.select.i707.i.1, %binop.i706.i.2
  %sext.i.2 = shl i32 %spec.select.i707.i.2, 24
  %cmpi73.not.i.2 = icmp eq i32 %sext.i.2, -33554432
  br i1 %cmpi73.not.i.2, label %func_1.exit, label %while_body74.i.3

while_body74.i.3:                                 ; preds = %while_body74.i.2
  %cmpi.i705.i.3 = icmp sgt i32 %sext.i.2, -1
  %binop.i706.i.3 = sext i1 %cmpi.i705.i.3 to i32
  %spec.select.i707.i.3 = add nsw i32 %spec.select.i707.i.2, %binop.i706.i.3
  %sext.i.3 = shl i32 %spec.select.i707.i.3, 24
  %sext84.i.3 = ashr exact i32 %sext.i.3, 24
  %cmpi73.not.i.3 = icmp eq i32 %sext.i.3, -33554432
  br i1 %cmpi73.not.i.3, label %func_1.exit, label %while_body74.i

func_1.exit:                                      ; preds = %while_body74.i.3, %while_body74.i.2, %while_body74.i.1, %while_body74.i
