; ModuleID = 'arquivos-compilados-stm32-1000/00601.ll'
...
body:
  %deref48.unpack = load i8, ptr inttoptr (i32 47202 to ptr), align 2
  %0 = insertvalue %S1 poison, i8 %deref48.unpack, 0
  %deref48.unpack50 = load i8, ptr inttoptr (i32 47203 to ptr), align 1
  %deref4851 = insertvalue %S1 %0, i8 %deref48.unpack50, 1
  ret %S1 %deref4851
}
