; ModuleID = 'arquivos-compilados-stm32-1000/00334.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 15), (16, 21), (22, 26)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i16 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i32 0, ptr %gepf6, align 4
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i8 0, ptr %gepf7, align 1
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 22
  store i16 0, ptr %gepf8, align 2
  %gepf9 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i16 0, ptr %gepf9, align 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(11) %gepf1, i8 0, i64 11, i1 false)
  ret void
}
...
body:
  store i32 1, ptr inttoptr (i32 29191 to ptr), align 4
  %l_4.f7 = load i8, ptr inttoptr (i32 29207 to ptr), align 1
