; ModuleID = 'arquivos-compilados-stm32-1000/00717.ll'
source_filename = "out/00717.rob"
...
while_cond12:                                     ; preds = %while_cond12, %body
  br label %while_cond12
}
...
body:
  ...
  br label %while_cond12.i

while_cond12.i:                                   ; preds = %while_cond12.i, %body
  br label %while_cond12.i
}
