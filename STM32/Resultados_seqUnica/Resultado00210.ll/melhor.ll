; ModuleID = 'arquivos-compilados-stm32-1000/00210.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 6)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i23 0, ptr %_this, align 4
