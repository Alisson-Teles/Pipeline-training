; ModuleID = 'arquivos-compilados-stm32-1000/00610.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 6), (8, 15), (16, 20)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i8 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 5
