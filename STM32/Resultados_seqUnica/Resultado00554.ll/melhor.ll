; ModuleID = 'arquivos-compilados-stm32-1000/00554.ll'
source_filename = "out/00554.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S0 = type { i32, i64, i64, i32, i64, i32, i16, i32, i32, i32 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S0:init"(ptr nocapture writeonly initializes((0, 4), (8, 28), (32, 46), (48, 60)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 32
  store i64 0, ptr %gepf4, align 8
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 40
  store i32 0, ptr %gepf5, align 4
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 44
  store i16 0, ptr %gepf6, align 2
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 48
  store i32 0, ptr %gepf7, align 4
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 52
  store i32 0, ptr %gepf8, align 4
  %gepf9 = getelementptr inbounds nuw i8, ptr %_this, i32 56
  store i32 0, ptr %gepf9, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %gepf1, i8 0, i64 20, i1 false)
  ret void
}
...
body:
  ret %S0 { i32 -1440690256, i64 6575406998443070775, i64 -4, i32 0, i64 -1, i32 254060576, i16 -1, i32 1839419959, i32 -1833905464, i32 -725127104 }
}
