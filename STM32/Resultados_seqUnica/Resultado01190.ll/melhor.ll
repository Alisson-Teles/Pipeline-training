; ModuleID = 'arquivos-compilados-stm32-1000/01190.ll'
source_filename = "out/01190.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S1 = type { i10, i7, i64, i16, i8, i16, i32, i32, i16, i32 }

@crc32_context = local_unnamed_addr global i64 0
@__undefined = local_unnamed_addr global i64 0

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 3), (8, 19), (20, 22), (24, 34), (36, 40)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i10 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  store i7 0, ptr %gepf1, align 1
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i64 0, ptr %gepf2, align 8
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i16 0, ptr %gepf3, align 2
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 18
  store i8 0, ptr %gepf4, align 1
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i16 0, ptr %gepf5, align 2
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i32 0, ptr %gepf6, align 4
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 28
  store i32 0, ptr %gepf7, align 4
  %gepf8 = getelementptr inbounds nuw i8, ptr %_this, i32 32
  store i16 0, ptr %gepf8, align 2
  %gepf9 = getelementptr inbounds nuw i8, ptr %_this, i32 36
  store i32 0, ptr %gepf9, align 4
  ret void
}
...
body:
  ret %S1 { i10 22, i7 1, i64 -1, i16 -15505, i8 90, i16 -1, i32 -1, i32 1663851364, i16 -2, i32 1 }
}
