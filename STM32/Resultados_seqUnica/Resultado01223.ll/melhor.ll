; ModuleID = 'arquivos-compilados-stm32-1000/01223.ll'
source_filename = "out/01223.rob"
...
define void @"S3:init"(ptr nocapture writeonly initializes((0, 6), (8, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
