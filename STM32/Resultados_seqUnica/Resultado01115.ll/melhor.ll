; ModuleID = 'arquivos-compilados-stm32-1000/01115.ll'
source_filename = "out/01115.rob"
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 3), (4, 6), (8, 11), (12, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i19 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i9 0, ptr %gepf1, align 2
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S3:init"(ptr nocapture writeonly initializes((0, 1), (4, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
