; ModuleID = 'arquivos-compilados-stm32-1000/00633.ll'
source_filename = "out/00633.rob"
...
define noundef zeroext range(i16 0, 256) i16 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i16 255
}
