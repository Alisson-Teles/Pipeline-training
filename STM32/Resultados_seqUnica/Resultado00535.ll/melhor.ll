; ModuleID = 'arquivos-compilados-stm32-1000/00535.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 11)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i10 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i25 0, ptr %gepf1, align 4
