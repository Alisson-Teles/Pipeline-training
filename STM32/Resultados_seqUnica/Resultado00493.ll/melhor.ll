; ModuleID = 'arquivos-compilados-stm32-1000/00493.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 3), (4, 7), (8, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i21 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i24 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i27 0, ptr %gepf2, align 4
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i26 0, ptr %gepf3, align 4
  ret void
}
