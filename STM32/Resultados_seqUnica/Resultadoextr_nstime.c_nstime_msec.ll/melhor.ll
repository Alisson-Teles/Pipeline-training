; ModuleID = 'angha-ll-stm32f1/extr_nstime.c_nstime_msec.ll'
source_filename = "out/extr_nstime.c_nstime_msec.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

@MILLION = local_unnamed_addr global i32 0
...
define i32 @nstime_msec(ptr readonly captures(none) %time) local_unnamed_addr addrspace(1) #1 {
body:
  %ns2 = load i32, ptr %time, align 4
  %MILLION = load i32, ptr @MILLION, align 4
  %binop = sdiv i32 %ns2, %MILLION
  ret i32 %binop
}
