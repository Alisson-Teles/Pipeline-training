; ModuleID = 'arquivos-compilados-stm32-1000/00470.ll'
...
common.ret:                                       ; preds = %if_cont, %fullev, %body
  %common.ret.op = phi i8 [ %binop, %if_cont ], [ %si1, %body ], [ -128, %fullev ]
  ret i8 %common.ret.op
...
common.ret:                                       ; preds = %if_cont, %fullev, %body
  %common.ret.op = phi i16 [ %binop, %if_cont ], [ %si1, %body ], [ -32768, %fullev ]
  ret i16 %common.ret.op
...
common.ret:                                       ; preds = %if_cont, %fullev, %body
  %common.ret.op = phi i32 [ %binop, %if_cont ], [ %si1, %body ], [ -2147483648, %fullev ]
  ret i32 %common.ret.op
...
common.ret:                                       ; preds = %if_cont, %fullev, %body
  %common.ret.op = phi i64 [ %binop, %if_cont ], [ %si1, %body ], [ -9223372036854775808, %fullev ]
  ret i64 %common.ret.op
...
body:
  ...
  store i32 50062, ptr %elem1, align 4
  store i32 65535, ptr %elem2, align 4
  store i32 65535, ptr %elem3, align 4
  store i32 50062, ptr %elem4, align 4
  store i32 65535, ptr %elem5, align 4
  store i32 227, ptr %elem6, align 4
  store i32 50062, ptr %elem7, align 4
  store i32 0, ptr %l_13, align 4
  store i32 50062, ptr %elem1, align 4
  store i32 65535, ptr %elem2, align 4
  store i32 65535, ptr %elem3, align 4
  store i32 50062, ptr %elem4, align 4
  ...
  store i32 227, ptr %elem6, align 4
  store i32 50062, ptr %elem7, align 4
  %gep90 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 1
  store i32 0, ptr %gep90, align 4
  %l_1339.1116 = load i32, ptr %elem1, align 4
  %zext58.1117 = and i32 %l_1339.1116, 65535
  store i32 %zext58.1117, ptr %elem1, align 4
  %l_1339.1.1 = load i32, ptr %elem2, align 4
  %zext58.1.1 = and i32 %l_1339.1.1, 65535
  store i32 %zext58.1.1, ptr %elem2, align 4
  %l_1339.2.1 = load i32, ptr %elem3, align 4
  %zext58.2.1 = and i32 %l_1339.2.1, 65535
  store i32 %zext58.2.1, ptr %elem3, align 4
  %l_1339.3.1 = load i32, ptr %elem4, align 4
  %zext58.3.1 = and i32 %l_1339.3.1, 65535
  store i32 %zext58.3.1, ptr %elem4, align 4
  %l_1339.4.1 = load i32, ptr %elem5, align 4
  %zext58.4.1 = and i32 %l_1339.4.1, 65535
  store i32 %zext58.4.1, ptr %elem5, align 4
  %l_1339.5.1 = load i32, ptr %elem6, align 4
  %zext58.5.1 = and i32 %l_1339.5.1, 65535
  store i32 %zext58.5.1, ptr %elem6, align 4
  %l_1339.6.1 = load i32, ptr %elem7, align 4
  %zext58.6.1 = and i32 %l_1339.6.1, 65535
  store i32 %zext58.6.1, ptr %elem7, align 4
  %cmpi87.not.1 = icmp samesign ugt i32 %zext58.5.1, 139
  %sext89.1 = select i1 %cmpi87.not.1, i32 0, i32 512
  %gep90.1 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 2
  store i32 %sext89.1, ptr %gep90.1, align 4
  %l_1339.2119 = load i32, ptr %elem1, align 4
  %zext58.2120 = and i32 %l_1339.2119, 65535
  store i32 %zext58.2120, ptr %elem1, align 4
  %l_1339.1.2 = load i32, ptr %elem2, align 4
  %zext58.1.2 = and i32 %l_1339.1.2, 65535
  store i32 %zext58.1.2, ptr %elem2, align 4
  %l_1339.2.2 = load i32, ptr %elem3, align 4
  %zext58.2.2 = and i32 %l_1339.2.2, 65535
  store i32 %zext58.2.2, ptr %elem3, align 4
  %l_1339.3.2 = load i32, ptr %elem4, align 4
  %zext58.3.2 = and i32 %l_1339.3.2, 65535
  store i32 %zext58.3.2, ptr %elem4, align 4
  %l_1339.4.2 = load i32, ptr %elem5, align 4
  %zext58.4.2 = and i32 %l_1339.4.2, 65535
  store i32 %zext58.4.2, ptr %elem5, align 4
  %l_1339.5.2 = load i32, ptr %elem6, align 4
  %zext58.5.2 = and i32 %l_1339.5.2, 65535
  store i32 %zext58.5.2, ptr %elem6, align 4
  %l_1339.6.2 = load i32, ptr %elem7, align 4
  %zext58.6.2 = and i32 %l_1339.6.2, 65535
  store i32 %zext58.6.2, ptr %elem7, align 4
  %cmpi87.not.2 = icmp samesign ugt i32 %zext58.5.2, 69
  %sext89.2 = select i1 %cmpi87.not.2, i32 0, i32 512
  %gep90.2 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 3
  store i32 %sext89.2, ptr %gep90.2, align 4
  %l_1339.3122 = load i32, ptr %elem1, align 4
  %zext58.3123 = and i32 %l_1339.3122, 65535
  store i32 %zext58.3123, ptr %elem1, align 4
  %l_1339.1.3 = load i32, ptr %elem2, align 4
  %zext58.1.3 = and i32 %l_1339.1.3, 65535
  store i32 %zext58.1.3, ptr %elem2, align 4
  %l_1339.2.3 = load i32, ptr %elem3, align 4
  %zext58.2.3 = and i32 %l_1339.2.3, 65535
  store i32 %zext58.2.3, ptr %elem3, align 4
  %l_1339.3.3 = load i32, ptr %elem4, align 4
  %zext58.3.3 = and i32 %l_1339.3.3, 65535
  store i32 %zext58.3.3, ptr %elem4, align 4
  %l_1339.4.3 = load i32, ptr %elem5, align 4
  %zext58.4.3 = and i32 %l_1339.4.3, 65535
  store i32 %zext58.4.3, ptr %elem5, align 4
  %l_1339.5.3 = load i32, ptr %elem6, align 4
  %zext58.5.3 = and i32 %l_1339.5.3, 65535
  store i32 %zext58.5.3, ptr %elem6, align 4
  %l_1339.6.3 = load i32, ptr %elem7, align 4
  %zext58.6.3 = and i32 %l_1339.6.3, 65535
  store i32 %zext58.6.3, ptr %elem7, align 4
  %cmpi87.not.3 = icmp samesign ugt i32 %zext58.5.3, 162
  %sext89.3 = select i1 %cmpi87.not.3, i32 0, i32 512
  %gep90.3 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 4
  store i32 %sext89.3, ptr %gep90.3, align 4
  %l_1339.pre = load i32, ptr %elem1, align 4
  %l_1339.1.pre = load i32, ptr %elem2, align 4
  %l_1339.2.pre = load i32, ptr %elem3, align 4
  %l_1339.3.pre = load i32, ptr %elem4, align 4
  %l_1339.4.pre = load i32, ptr %elem5, align 4
  %l_1339.5.pre = load i32, ptr %elem6, align 4
  %l_1339.6.pre = load i32, ptr %elem7, align 4
  %zext58.115 = and i32 %l_1339.pre, 65535
  store i32 %zext58.115, ptr %elem1, align 4
  %zext58.1.116 = and i32 %l_1339.1.pre, 65535
  store i32 %zext58.1.116, ptr %elem2, align 4
  %zext58.2.117 = and i32 %l_1339.2.pre, 65535
  store i32 %zext58.2.117, ptr %elem3, align 4
  %zext58.3.118 = and i32 %l_1339.3.pre, 65535
  store i32 %zext58.3.118, ptr %elem4, align 4
  %zext58.4.119 = and i32 %l_1339.4.pre, 65535
  store i32 %zext58.4.119, ptr %elem5, align 4
  %zext58.5.120 = and i32 %l_1339.5.pre, 65535
  store i32 %zext58.5.120, ptr %elem6, align 4
  %zext58.6.121 = and i32 %l_1339.6.pre, 65535
  store i32 %zext58.6.121, ptr %elem7, align 4
  %cmpi87.not.129 = icmp samesign ugt i32 %zext58.5.120, 81
  %sext89.130 = select i1 %cmpi87.not.129, i32 0, i32 512
  %gep90.131 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 5
  store i32 %sext89.130, ptr %gep90.131, align 4
  %l_1339.1116.1 = load i32, ptr %elem1, align 4
  %zext58.1117.1 = and i32 %l_1339.1116.1, 65535
  store i32 %zext58.1117.1, ptr %elem1, align 4
  %l_1339.1.1.1 = load i32, ptr %elem2, align 4
  %zext58.1.1.1 = and i32 %l_1339.1.1.1, 65535
  store i32 %zext58.1.1.1, ptr %elem2, align 4
  %l_1339.2.1.1 = load i32, ptr %elem3, align 4
  %zext58.2.1.1 = and i32 %l_1339.2.1.1, 65535
  store i32 %zext58.2.1.1, ptr %elem3, align 4
  %l_1339.3.1.1 = load i32, ptr %elem4, align 4
  %zext58.3.1.1 = and i32 %l_1339.3.1.1, 65535
  store i32 %zext58.3.1.1, ptr %elem4, align 4
  %l_1339.4.1.1 = load i32, ptr %elem5, align 4
  %zext58.4.1.1 = and i32 %l_1339.4.1.1, 65535
  store i32 %zext58.4.1.1, ptr %elem5, align 4
  %l_1339.5.1.1 = load i32, ptr %elem6, align 4
  %zext58.5.1.1 = and i32 %l_1339.5.1.1, 65535
  store i32 %zext58.5.1.1, ptr %elem6, align 4
  %l_1339.6.1.1 = load i32, ptr %elem7, align 4
  %zext58.6.1.1 = and i32 %l_1339.6.1.1, 65535
  store i32 %zext58.6.1.1, ptr %elem7, align 4
  %cmpi87.not.1.1 = icmp samesign ugt i32 %zext58.5.1.1, 40
  %sext89.1.1 = select i1 %cmpi87.not.1.1, i32 0, i32 512
  %gep90.1.1 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 6
  store i32 %sext89.1.1, ptr %gep90.1.1, align 4
  %l_1339.2119.1 = load i32, ptr %elem1, align 4
  %zext58.2120.1 = and i32 %l_1339.2119.1, 65535
  store i32 %zext58.2120.1, ptr %elem1, align 4
  %l_1339.1.2.1 = load i32, ptr %elem2, align 4
  %zext58.1.2.1 = and i32 %l_1339.1.2.1, 65535
  store i32 %zext58.1.2.1, ptr %elem2, align 4
  %l_1339.2.2.1 = load i32, ptr %elem3, align 4
  %zext58.2.2.1 = and i32 %l_1339.2.2.1, 65535
  store i32 %zext58.2.2.1, ptr %elem3, align 4
  %l_1339.3.2.1 = load i32, ptr %elem4, align 4
  %zext58.3.2.1 = and i32 %l_1339.3.2.1, 65535
  store i32 %zext58.3.2.1, ptr %elem4, align 4
  %l_1339.4.2.1 = load i32, ptr %elem5, align 4
  %zext58.4.2.1 = and i32 %l_1339.4.2.1, 65535
  store i32 %zext58.4.2.1, ptr %elem5, align 4
  %l_1339.5.2.1 = load i32, ptr %elem6, align 4
  %zext58.5.2.1 = and i32 %l_1339.5.2.1, 65535
  store i32 %zext58.5.2.1, ptr %elem6, align 4
  %l_1339.6.2.1 = load i32, ptr %elem7, align 4
  %zext58.6.2.1 = and i32 %l_1339.6.2.1, 65535
  store i32 %zext58.6.2.1, ptr %elem7, align 4
  %cmpi87.not.2.1 = icmp samesign ugt i32 %zext58.5.2.1, 148
  %sext89.2.1 = select i1 %cmpi87.not.2.1, i32 0, i32 512
  %gep90.2.1 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 7
  store i32 %sext89.2.1, ptr %gep90.2.1, align 4
