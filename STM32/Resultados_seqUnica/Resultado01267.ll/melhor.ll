; ModuleID = 'arquivos-compilados-stm32-1000/01267.ll'
source_filename = "out/01267.rob"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv7m-none-eabi"

%S1 = type { i32, i32, i32, i8, i32, i16 }
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @"S1:init"(ptr nocapture writeonly initializes((0, 13), (16, 22)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(13) %_this, i8 0, i64 13, i1 false)
  ret void
}
...
body:
  store i32 0, ptr inttoptr (i32 1327436728 to ptr), align 8
  ret %S1 { i32 5, i32 1558555560, i32 4, i8 89, i32 -1, i16 -1 }
}
