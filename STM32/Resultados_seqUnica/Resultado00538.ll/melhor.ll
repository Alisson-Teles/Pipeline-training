; ModuleID = 'arquivos-compilados-stm32-1000/00538.ll'
...
define void @"S3:init"(ptr nocapture writeonly initializes((0, 5), (8, 12)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
