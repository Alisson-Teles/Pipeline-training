; ModuleID = 'arquivos-compilados-stm32-1000/00985.ll'
source_filename = "out/00985.rob"
...
define noundef zeroext range(i64 0, 2048) i64 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  br label %while_cond
