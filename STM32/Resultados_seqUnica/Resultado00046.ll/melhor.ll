; ModuleID = 'arquivos-compilados-stm32-1000/00046.ll'
...
define void @"S1:init"(ptr nocapture writeonly initializes((0, 15), (16, 20)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i32 0, ptr %gepf5, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(15) %_this, i8 0, i64 15, i1 false)
  ret void
}
