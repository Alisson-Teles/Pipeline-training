; ModuleID = 'arquivos-compilados-stm32-1000/00969.ll'
source_filename = "out/00969.rob"
...
define noundef i8 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_cond79

while_cond79:                                     ; preds = %while_cond79, %body
  br label %while_cond79
}
...
body:
  ...
  br label %while_cond79.i

while_cond79.i:                                   ; preds = %while_cond79.i, %body
  br label %while_cond79.i
}
