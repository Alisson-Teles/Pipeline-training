; ModuleID = 'arquivos-compilados-stm32-1000/01030.ll'
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 6), (8, 26), (28, 32)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i32 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i14 0, ptr %gepf1, align 2
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 28
  store i27 0, ptr %gepf7, align 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(18) %gepf2, i8 0, i64 18, i1 false)
  ret void
}
