; ModuleID = 'arquivos-compilados-stm32-1000/00891.ll'
...
while_body:                                       ; preds = %while_body, %body
  %l_3.0641 = phi i32 [ 8, %body ], [ %binop247.1, %while_body ]
  %binop247.1 = add nsw i32 %l_3.0641, -2
  %cmpi.1.not = icmp eq i32 %l_3.0641, 2
  br i1 %cmpi.1.not, label %if_cont459, label %while_body

if_cont459:                                       ; preds = %while_body
  ret i8 87
}
