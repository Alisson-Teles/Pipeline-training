; ModuleID = 'arquivos-compilados-stm32-1000/00859.ll'
source_filename = "out/00859.rob"
...
define noundef i32 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_5.sroa.0 = alloca i16, align 4
  %l_16.sroa.0 = alloca i16, align 4
  store i16 7, ptr %l_5.sroa.0, align 4
  store i16 -1, ptr %l_16.sroa.0, align 4
  %l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.deref72 = load ptr, ptr %l_5.sroa.0, align 4
  store i16 9, ptr %l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.deref72, align 2
  %l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.deref92 = load ptr, ptr %l_16.sroa.0, align 4
  store i16 0, ptr %l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.deref92, align 2
  ret i32 -1
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_5.sroa.0.i = alloca i16, align 4
  %l_16.sroa.0.i = alloca i16, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %l_5.sroa.0.i)
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %l_16.sroa.0.i)
  store i16 7, ptr %l_5.sroa.0.i, align 4
  store i16 -1, ptr %l_16.sroa.0.i, align 4
  %l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.deref72.i = load ptr, ptr %l_5.sroa.0.i, align 4
  store i16 9, ptr %l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.i.0.l_5.sroa.0.0.l_5.sroa.0.0.l_5.sroa.0.0.deref72.i, align 2
  %l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.deref92.i = load ptr, ptr %l_16.sroa.0.i, align 4
  store i16 0, ptr %l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.i.0.l_16.sroa.0.0.l_16.sroa.0.0.l_16.sroa.0.0.deref92.i, align 2
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %l_5.sroa.0.i)
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %l_16.sroa.0.i)
