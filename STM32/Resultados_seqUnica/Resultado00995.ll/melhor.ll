; ModuleID = 'arquivos-compilados-stm32-1000/00995.ll'
source_filename = "out/00995.rob"
...
define noundef zeroext range(i64 -2147483648, 4294967296) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  ret i64 3028940713
}
