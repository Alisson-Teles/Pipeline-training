; ModuleID = 'arquivos-compilados-stm32-1000/01070.ll'
source_filename = "out/01070.rob"
...
define void @"S3:init"(ptr nocapture writeonly initializes((0, 2)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
