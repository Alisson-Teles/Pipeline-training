; ModuleID = 'angha-ll-stm32f1/extr_p9auth.c_cap_release.ll'
source_filename = "out/extr_p9auth.c_cap_release.rob"
...
define noundef i32 @cap_release(ptr readnone captures(none) %inode, ptr readnone captures(none) %filp) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
