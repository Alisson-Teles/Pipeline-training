; ModuleID = 'angha-ll-stm32f1/extr_falcon_boards.c_ef4_check_lm87.ll'
source_filename = "out/extr_falcon_boards.c_ef4_check_lm87.rob"
...
define noundef i32 @ef4_check_lm87(ptr readnone captures(none) %efx, i32 zeroext %mask) local_unnamed_addr addrspace(1) #1 {
body:
  ret i32 0
}
