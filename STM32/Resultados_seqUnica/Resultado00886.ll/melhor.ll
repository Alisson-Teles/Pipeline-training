; ModuleID = 'arquivos-compilados-stm32-1000/00886.ll'
...
while_cond12.preheader:                           ; preds = %while_cond12.preheader.3, %body
  ...
  br i1 %cmpi.not, label %while_body183, label %while_cond12.preheader.1
...
while_cond12.preheader.1:                         ; preds = %while_cond12.preheader
  ...
  br i1 %cmpi.not.1, label %while_body183, label %while_cond12.preheader.2
...
while_cond12.preheader.2:                         ; preds = %while_cond12.preheader.1
  ...
  br i1 %cmpi.not.2, label %while_body183, label %while_cond12.preheader.3
...
while_cond12.preheader.3:                         ; preds = %while_cond12.preheader.2
  ...
  br i1 %cmpi.not.3, label %while_body183, label %while_cond12.preheader

while_body183:                                    ; preds = %while_cond12.preheader, %while_cond12.preheader.1, %while_cond12.preheader.2, %while_cond12.preheader.3
  br i1 false, label %while_body362, label %if_else376

common.ret:                                       ; preds = %if_else376.4, %while_body362
  ret i16 0

while_body362:                                    ; preds = %if_else376.4, %if_else376.3, %if_else376.2, %if_else376.1, %if_else376, %while_body183
  br label %common.ret

if_else376:                                       ; preds = %while_body183
  br i1 false, label %while_body362, label %if_else376.1

if_else376.1:                                     ; preds = %if_else376
  br i1 false, label %while_body362, label %if_else376.2

if_else376.2:                                     ; preds = %if_else376.1
  br i1 false, label %while_body362, label %if_else376.3

if_else376.3:                                     ; preds = %if_else376.2
  br i1 false, label %while_body362, label %if_else376.4

if_else376.4:                                     ; preds = %if_else376.3
  br i1 false, label %while_body362, label %common.ret
}
