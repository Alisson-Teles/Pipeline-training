...
body:
  %l_19.sroa.0 = alloca ptr, align 4
  %l_18.sroa.0 = alloca [3 x i8], align 4
  store i18 -128, ptr %l_19.sroa.0, align 4
  %l_19.sroa.0.0.l_19.sroa.0.0.l_19.sroa.0.promoted = load ptr, ptr %l_19.sroa.0, align 4
  %l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.l_18.promoted = load i18, ptr %l_18.sroa.0, align 4
  store ptr %l_19.sroa.0.0.l_19.sroa.0.0.l_19.sroa.0.promoted, ptr %l_19.sroa.0, align 4
  store i18 %l_18.sroa.0.0.l_18.sroa.0.0.l_18.sroa.0.0.l_18.promoted, ptr %l_18.sroa.0, align 4
  store i18 0, ptr %l_19.sroa.0.0.l_19.sroa.0.0.l_19.sroa.0.promoted, align 4
  ret i32 0
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_19.sroa.0.i = alloca ptr, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_19.sroa.0.i)
  store i18 -128, ptr %l_19.sroa.0.i, align 4
  %l_19.sroa.0.i.0.l_19.sroa.0.i.0.l_19.sroa.0.i.0.l_19.sroa.0.0.l_19.sroa.0.promoted.i = load ptr, ptr %l_19.sroa.0.i, align 4
  store i18 0, ptr %l_19.sroa.0.i.0.l_19.sroa.0.i.0.l_19.sroa.0.i.0.l_19.sroa.0.0.l_19.sroa.0.promoted.i, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_19.sroa.0.i)
