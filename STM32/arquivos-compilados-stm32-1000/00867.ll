; ModuleID = 'out/00867.rob'
source_filename = "out/00867.rob"
...
define zeroext range(i32 -2, 1) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_body403

common.ret:                                       ; preds = %while_body403
  ret i32 -2

while_body403:                                    ; preds = %while_body403, %body
  %l_59.0950 = phi i32 [ 0, %body ], [ %l_59.2, %while_body403 ]
  %l_65.0949 = phi i32 [ 0, %body ], [ %binop.i902.4, %while_body403 ]
  %cmpi420.not = icmp eq i32 %l_59.0950, 0
  %l_59.2 = select i1 %cmpi420.not, i32 20, i32 %l_59.0950
  %binop.i902.4 = add nuw nsw i32 %l_65.0949, 5
  %cmpi402.not.4 = icmp eq i32 %binop.i902.4, 25
  br i1 %cmpi402.not.4, label %common.ret, label %while_body403
}
