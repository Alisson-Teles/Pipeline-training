...
while_body44:                                     ; preds = %while_end214.2, %body
  %l_11.0328 = phi i32 [ 0, %body ], [ %binop255.2, %while_end214.2 ]
  br label %while_cond230.preheader

while_end45:                                      ; preds = %while_end214.2
  ret i32 9

while_cond230.preheader:                          ; preds = %while_cond230.preheader.3, %while_body44
  %l_2.3327 = phi i32 [ 18, %while_body44 ], [ %sext253.3, %while_cond230.preheader.3 ]
  %cmpi.i = icmp slt i32 %l_2.3327, 0
  %0 = shl nsw i32 %l_2.3327, 24
  %1 = add i32 %0, -117440512
  %2 = ashr exact i32 %1, 24
  %sext253 = select i1 %cmpi.i, i32 %l_2.3327, i32 %2
  %cmpi212.not = icmp eq i32 %sext253, -24
  br i1 %cmpi212.not, label %while_end214, label %while_cond230.preheader.1

while_cond230.preheader.1:                        ; preds = %while_cond230.preheader
  %cmpi.i.1 = icmp slt i32 %sext253, 0
  %3 = shl nsw i32 %sext253, 24
  %4 = add i32 %3, -117440512
  %5 = ashr exact i32 %4, 24
  %sext253.1 = select i1 %cmpi.i.1, i32 %sext253, i32 %5
  %cmpi212.not.1 = icmp eq i32 %sext253.1, -24
  br i1 %cmpi212.not.1, label %while_end214, label %while_cond230.preheader.2

while_cond230.preheader.2:                        ; preds = %while_cond230.preheader.1
  %cmpi.i.2 = icmp slt i32 %sext253.1, 0
  %6 = shl nsw i32 %sext253.1, 24
  %7 = add i32 %6, -117440512
  %8 = ashr exact i32 %7, 24
  %sext253.2 = select i1 %cmpi.i.2, i32 %sext253.1, i32 %8
  %cmpi212.not.2 = icmp eq i32 %sext253.2, -24
  br i1 %cmpi212.not.2, label %while_end214, label %while_cond230.preheader.3

while_cond230.preheader.3:                        ; preds = %while_cond230.preheader.2
  %cmpi.i.3 = icmp slt i32 %sext253.2, 0
  %9 = shl nsw i32 %sext253.2, 24
  %10 = add i32 %9, -117440512
  %11 = ashr exact i32 %10, 24
  %sext253.3 = select i1 %cmpi.i.3, i32 %sext253.2, i32 %11
  %cmpi212.not.3 = icmp eq i32 %sext253.3, -24
  br i1 %cmpi212.not.3, label %while_end214, label %while_cond230.preheader

while_end214:                                     ; preds = %while_cond230.preheader.3, %while_cond230.preheader.2, %while_cond230.preheader.1, %while_cond230.preheader
  br label %while_cond230.preheader.1339

while_cond230.preheader.1339:                     ; preds = %while_cond230.preheader.3.1, %while_end214
  %l_2.3327.1 = phi i32 [ 18, %while_end214 ], [ %sext253.3.1, %while_cond230.preheader.3.1 ]
  %cmpi.i.1336 = icmp slt i32 %l_2.3327.1, 0
  %12 = shl nsw i32 %l_2.3327.1, 24
  %13 = add i32 %12, -117440512
  %14 = ashr exact i32 %13, 24
  %sext253.1337 = select i1 %cmpi.i.1336, i32 %l_2.3327.1, i32 %14
  %cmpi212.not.1338 = icmp eq i32 %sext253.1337, -24
  br i1 %cmpi212.not.1338, label %while_end214.1, label %while_cond230.preheader.1.1

while_cond230.preheader.1.1:                      ; preds = %while_cond230.preheader.1339
  %cmpi.i.1.1 = icmp slt i32 %sext253.1337, 0
  %15 = shl nsw i32 %sext253.1337, 24
  %16 = add i32 %15, -117440512
  %17 = ashr exact i32 %16, 24
  %sext253.1.1 = select i1 %cmpi.i.1.1, i32 %sext253.1337, i32 %17
  %cmpi212.not.1.1 = icmp eq i32 %sext253.1.1, -24
  br i1 %cmpi212.not.1.1, label %while_end214.1, label %while_cond230.preheader.2.1

while_cond230.preheader.2.1:                      ; preds = %while_cond230.preheader.1.1
  %cmpi.i.2.1 = icmp slt i32 %sext253.1.1, 0
  %18 = shl nsw i32 %sext253.1.1, 24
  %19 = add i32 %18, -117440512
  %20 = ashr exact i32 %19, 24
  %sext253.2.1 = select i1 %cmpi.i.2.1, i32 %sext253.1.1, i32 %20
  %cmpi212.not.2.1 = icmp eq i32 %sext253.2.1, -24
  br i1 %cmpi212.not.2.1, label %while_end214.1, label %while_cond230.preheader.3.1

while_cond230.preheader.3.1:                      ; preds = %while_cond230.preheader.2.1
  %cmpi.i.3.1 = icmp slt i32 %sext253.2.1, 0
  %21 = shl nsw i32 %sext253.2.1, 24
  %22 = add i32 %21, -117440512
  %23 = ashr exact i32 %22, 24
  %sext253.3.1 = select i1 %cmpi.i.3.1, i32 %sext253.2.1, i32 %23
  %cmpi212.not.3.1 = icmp eq i32 %sext253.3.1, -24
  br i1 %cmpi212.not.3.1, label %while_end214.1, label %while_cond230.preheader.1339

while_end214.1:                                   ; preds = %while_cond230.preheader.3.1, %while_cond230.preheader.2.1, %while_cond230.preheader.1.1, %while_cond230.preheader.1339
  br label %while_cond230.preheader.2343

while_cond230.preheader.2343:                     ; preds = %while_cond230.preheader.3.2, %while_end214.1
  %l_2.3327.2 = phi i32 [ 18, %while_end214.1 ], [ %sext253.3.2, %while_cond230.preheader.3.2 ]
  %cmpi.i.2340 = icmp slt i32 %l_2.3327.2, 0
  %24 = shl nsw i32 %l_2.3327.2, 24
  %25 = add i32 %24, -117440512
  %26 = ashr exact i32 %25, 24
  %sext253.2341 = select i1 %cmpi.i.2340, i32 %l_2.3327.2, i32 %26
  %cmpi212.not.2342 = icmp eq i32 %sext253.2341, -24
  br i1 %cmpi212.not.2342, label %while_end214.2, label %while_cond230.preheader.1.2

while_cond230.preheader.1.2:                      ; preds = %while_cond230.preheader.2343
  %cmpi.i.1.2 = icmp slt i32 %sext253.2341, 0
  %27 = shl nsw i32 %sext253.2341, 24
  %28 = add i32 %27, -117440512
  %29 = ashr exact i32 %28, 24
  %sext253.1.2 = select i1 %cmpi.i.1.2, i32 %sext253.2341, i32 %29
  %cmpi212.not.1.2 = icmp eq i32 %sext253.1.2, -24
  br i1 %cmpi212.not.1.2, label %while_end214.2, label %while_cond230.preheader.2.2

while_cond230.preheader.2.2:                      ; preds = %while_cond230.preheader.1.2
  %cmpi.i.2.2 = icmp slt i32 %sext253.1.2, 0
  %30 = shl nsw i32 %sext253.1.2, 24
  %31 = add i32 %30, -117440512
  %32 = ashr exact i32 %31, 24
  %sext253.2.2 = select i1 %cmpi.i.2.2, i32 %sext253.1.2, i32 %32
  %cmpi212.not.2.2 = icmp eq i32 %sext253.2.2, -24
  br i1 %cmpi212.not.2.2, label %while_end214.2, label %while_cond230.preheader.3.2

while_cond230.preheader.3.2:                      ; preds = %while_cond230.preheader.2.2
  %cmpi.i.3.2 = icmp slt i32 %sext253.2.2, 0
  %33 = shl nsw i32 %sext253.2.2, 24
  %34 = add i32 %33, -117440512
  %35 = ashr exact i32 %34, 24
  %sext253.3.2 = select i1 %cmpi.i.3.2, i32 %sext253.2.2, i32 %35
  %cmpi212.not.3.2 = icmp eq i32 %sext253.3.2, -24
  br i1 %cmpi212.not.3.2, label %while_end214.2, label %while_cond230.preheader.2343

while_end214.2:                                   ; preds = %while_cond230.preheader.3.2, %while_cond230.preheader.2.2, %while_cond230.preheader.1.2, %while_cond230.preheader.2343
  %binop255.2 = add nuw nsw i32 %l_11.0328, 3
  %exitcond.not.2 = icmp eq i32 %binop255.2, 9
  br i1 %exitcond.not.2, label %while_end45, label %while_body44
}
...
while_cond230.preheader.i:                        ; preds = %while_cond230.preheader.i.3, %body
  %l_2.3327.i = phi i32 [ 18, %body ], [ %sext253.i.3, %while_cond230.preheader.i.3 ]
  %cmpi.i.i = icmp slt i32 %l_2.3327.i, 0
  %0 = shl nsw i32 %l_2.3327.i, 24
  %1 = add i32 %0, -117440512
  %2 = ashr exact i32 %1, 24
  %sext253.i = select i1 %cmpi.i.i, i32 %l_2.3327.i, i32 %2
  %cmpi212.not.i = icmp eq i32 %sext253.i, -24
  br i1 %cmpi212.not.i, label %func_1.exit, label %while_cond230.preheader.i.1

while_cond230.preheader.i.1:                      ; preds = %while_cond230.preheader.i
  %cmpi.i.i.1 = icmp slt i32 %sext253.i, 0
  %3 = shl nsw i32 %sext253.i, 24
  %4 = add i32 %3, -117440512
  %5 = ashr exact i32 %4, 24
  %sext253.i.1 = select i1 %cmpi.i.i.1, i32 %sext253.i, i32 %5
  %cmpi212.not.i.1 = icmp eq i32 %sext253.i.1, -24
  br i1 %cmpi212.not.i.1, label %func_1.exit, label %while_cond230.preheader.i.2

while_cond230.preheader.i.2:                      ; preds = %while_cond230.preheader.i.1
  %cmpi.i.i.2 = icmp slt i32 %sext253.i.1, 0
  %6 = shl nsw i32 %sext253.i.1, 24
  %7 = add i32 %6, -117440512
  %8 = ashr exact i32 %7, 24
  %sext253.i.2 = select i1 %cmpi.i.i.2, i32 %sext253.i.1, i32 %8
  %cmpi212.not.i.2 = icmp eq i32 %sext253.i.2, -24
  br i1 %cmpi212.not.i.2, label %func_1.exit, label %while_cond230.preheader.i.3

while_cond230.preheader.i.3:                      ; preds = %while_cond230.preheader.i.2
  %cmpi.i.i.3 = icmp slt i32 %sext253.i.2, 0
  %9 = shl nsw i32 %sext253.i.2, 24
  %10 = add i32 %9, -117440512
  %11 = ashr exact i32 %10, 24
  %sext253.i.3 = select i1 %cmpi.i.i.3, i32 %sext253.i.2, i32 %11
  %cmpi212.not.i.3 = icmp eq i32 %sext253.i.3, -24
  br i1 %cmpi212.not.i.3, label %func_1.exit, label %while_cond230.preheader.i

func_1.exit:                                      ; preds = %while_cond230.preheader.i.3, %while_cond230.preheader.i.2, %while_cond230.preheader.i.1, %while_cond230.preheader.i
