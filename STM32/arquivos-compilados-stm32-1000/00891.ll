...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 1), (2, 4), (8, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i8 0, ptr %_this, align 1
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 2
  store i16 0, ptr %gepf1, align 2
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i64 0, ptr %gepf2, align 8
  ret void
}
...
body:
  %l_28 = alloca [7 x i32], align 4
  %elem20 = getelementptr inbounds nuw i8, ptr %l_28, i32 4
  %elem21 = getelementptr inbounds nuw i8, ptr %l_28, i32 8
  %elem22 = getelementptr inbounds nuw i8, ptr %l_28, i32 12
  %elem23 = getelementptr inbounds nuw i8, ptr %l_28, i32 16
  %elem24 = getelementptr inbounds nuw i8, ptr %l_28, i32 20
  %elem25 = getelementptr inbounds nuw i8, ptr %l_28, i32 24
  br label %while_body

while_body:                                       ; preds = %body, %while_end169
  %l_3.0641 = phi i32 [ 8, %body ], [ %binop247, %while_end169 ]
  store i32 0, ptr %l_28, align 4
  store i32 -3, ptr %elem20, align 4
  store i32 0, ptr %elem21, align 4
  store i32 0, ptr %elem22, align 4
  store i32 -3, ptr %elem23, align 4
  store i32 0, ptr %elem24, align 4
  store i32 0, ptr %elem25, align 4
  br label %while_body168

while_body168:                                    ; preds = %while_body, %while_body168
  %indvars.iv = phi i32 [ 0, %while_body ], [ %indvars.iv.next, %while_body168 ]
  %gep174 = getelementptr [7 x i32], ptr %l_28, i32 0, i32 %indvars.iv
  %l_28175 = load i32, ptr %gep174, align 4
  %binop176 = and i32 %l_28175, 27293538
  %gep177 = getelementptr [0 x i32], ptr %l_28, i32 0, i32 %indvars.iv
  store i32 %binop176, ptr %gep177, align 4
  %gep174.promoted = load i32, ptr %gep174, align 4
  %binop223 = and i32 %gep174.promoted, -1123853225
  store i32 %binop223, ptr %gep177, align 4
...
while_end169:                                     ; preds = %while_body168
  %binop247 = add nsw i32 %l_3.0641, -1
  %cmpi = icmp ugt i32 %l_3.0641, 1
  br i1 %cmpi, label %while_body, label %if_cont459

if_cont459:                                       ; preds = %while_end169
  ret i8 87
}
...
while_body.i:                                     ; preds = %while_body.i, %body
  %l_3.0641.i = phi i32 [ 8, %body ], [ %binop247.i.1, %while_body.i ]
  %binop247.i.1 = add nsw i32 %l_3.0641.i, -2
  %cmpi.i.1.not = icmp eq i32 %l_3.0641.i, 2
  br i1 %cmpi.i.1.not, label %func_1.exit, label %while_body.i

func_1.exit:                                      ; preds = %while_body.i
...
attributes #3 = { nofree norecurse nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
