; ModuleID = 'out/01103.rob'
source_filename = "out/01103.rob"
...
define noundef zeroext range(i32 -128, 128) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_2 = alloca [9 x i32], align 4
  store i32 -4, ptr %l_2, align 4
  %elem1 = getelementptr inbounds nuw i8, ptr %l_2, i32 4
  store i32 -4, ptr %elem1, align 4
  %elem2 = getelementptr inbounds nuw i8, ptr %l_2, i32 8
  store i32 -4, ptr %elem2, align 4
  %elem3 = getelementptr inbounds nuw i8, ptr %l_2, i32 12
  store i32 -4, ptr %elem3, align 4
  %elem4 = getelementptr inbounds nuw i8, ptr %l_2, i32 16
  store i32 -4, ptr %elem4, align 4
  %elem5 = getelementptr inbounds nuw i8, ptr %l_2, i32 20
  store i32 -4, ptr %elem5, align 4
  %elem6 = getelementptr inbounds nuw i8, ptr %l_2, i32 24
  store i32 -4, ptr %elem6, align 4
  %elem7 = getelementptr inbounds nuw i8, ptr %l_2, i32 28
  store i32 -4, ptr %elem7, align 4
  %elem8 = getelementptr inbounds nuw i8, ptr %l_2, i32 32
  store i32 -4, ptr %elem8, align 4
  store i32 0, ptr %elem6, align 4
  br label %while_cond56.preheader

while_cond56.preheader:                           ; preds = %body, %while_end69
  %l_7.0124 = phi i32 [ 6, %body ], [ %binop112, %while_end69 ]
  %gep79 = getelementptr [9 x i32], ptr %l_2, i32 0, i32 %l_7.0124
  %gep83 = getelementptr [0 x i32], ptr %l_2, i32 0, i32 %l_7.0124
  br label %phiblock

while_end52:                                      ; preds = %while_end69
  ret i32 -2

while_end69:                                      ; preds = %phiblock
  %gep110 = getelementptr [0 x i32], ptr %l_2, i32 0, i32 %l_7.0124
  store i32 1, ptr %gep110, align 4
  %binop112 = add nsw i32 %l_7.0124, -1
  %cmpi50.not = icmp eq i32 %l_7.0124, 0
  br i1 %cmpi50.not, label %while_end52, label %while_cond56.preheader

phiblock:                                         ; preds = %phiblock, %while_cond56.preheader
  %l_13.0123 = phi i32 [ 1, %while_cond56.preheader ], [ %binop107.1, %phiblock ]
  %l_280 = load i32, ptr %gep79, align 4
  %cmpi81 = icmp sgt i32 %l_280, 1
  %zext82 = zext i1 %cmpi81 to i32
  store i32 %zext82, ptr %gep83, align 4
  store i32 -1, ptr %l_2, align 4
  %gep94 = getelementptr [0 x i32], ptr %l_2, i32 0, i32 %l_13.0123
  %l_293 = load i32, ptr %gep79, align 4
  store i32 %l_293, ptr %gep94, align 4
  %l_296 = load i32, ptr %elem6, align 4
  %neg = xor i32 %l_296, -1
  store i32 %neg, ptr %elem8, align 4
  %l_293.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.1, ptr %gep94, align 4
  %l_296.1 = load i32, ptr %elem6, align 4
  %neg.1 = xor i32 %l_296.1, -1
  store i32 %neg.1, ptr %elem8, align 4
  %l_293.2 = load i32, ptr %gep79, align 4
  store i32 %l_293.2, ptr %gep94, align 4
  %l_296.2 = load i32, ptr %elem6, align 4
  %neg.2 = xor i32 %l_296.2, -1
  store i32 %neg.2, ptr %elem8, align 4
  %l_293.3 = load i32, ptr %gep79, align 4
  store i32 %l_293.3, ptr %gep94, align 4
  %l_296.3 = load i32, ptr %elem6, align 4
  %neg.3 = xor i32 %l_296.3, -1
  store i32 %neg.3, ptr %elem8, align 4
  %l_293.4 = load i32, ptr %gep79, align 4
  store i32 %l_293.4, ptr %gep94, align 4
  %l_296.4 = load i32, ptr %elem6, align 4
  %neg.4 = xor i32 %l_296.4, -1
  store i32 %neg.4, ptr %elem8, align 4
  %l_293.5 = load i32, ptr %gep79, align 4
  store i32 %l_293.5, ptr %gep94, align 4
  %l_296.5 = load i32, ptr %elem6, align 4
  %neg.5 = xor i32 %l_296.5, -1
  store i32 %neg.5, ptr %elem8, align 4
  %l_293.6 = load i32, ptr %gep79, align 4
  store i32 %l_293.6, ptr %gep94, align 4
  %l_296.6 = load i32, ptr %elem6, align 4
  %neg.6 = xor i32 %l_296.6, -1
  store i32 %neg.6, ptr %elem8, align 4
  %l_293.7 = load i32, ptr %gep79, align 4
  store i32 %l_293.7, ptr %gep94, align 4
  %l_296.7 = load i32, ptr %elem6, align 4
  %neg.7 = xor i32 %l_296.7, -1
  store i32 %neg.7, ptr %elem8, align 4
  %binop107 = add nuw nsw i32 %l_13.0123, 1
  %l_280.1 = load i32, ptr %gep79, align 4
  %cmpi81.1 = icmp sgt i32 %l_280.1, 1
  %zext82.1 = zext i1 %cmpi81.1 to i32
  store i32 %zext82.1, ptr %gep83, align 4
  store i32 -1, ptr %l_2, align 4
  %gep94.1 = getelementptr [0 x i32], ptr %l_2, i32 0, i32 %binop107
  %l_293.1125 = load i32, ptr %gep79, align 4
  store i32 %l_293.1125, ptr %gep94.1, align 4
  %l_296.1126 = load i32, ptr %elem6, align 4
  %neg.1127 = xor i32 %l_296.1126, -1
  store i32 %neg.1127, ptr %elem8, align 4
  %l_293.1.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.1.1, ptr %gep94.1, align 4
  %l_296.1.1 = load i32, ptr %elem6, align 4
  %neg.1.1 = xor i32 %l_296.1.1, -1
  store i32 %neg.1.1, ptr %elem8, align 4
  %l_293.2.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.2.1, ptr %gep94.1, align 4
  %l_296.2.1 = load i32, ptr %elem6, align 4
  %neg.2.1 = xor i32 %l_296.2.1, -1
  store i32 %neg.2.1, ptr %elem8, align 4
  %l_293.3.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.3.1, ptr %gep94.1, align 4
  %l_296.3.1 = load i32, ptr %elem6, align 4
  %neg.3.1 = xor i32 %l_296.3.1, -1
  store i32 %neg.3.1, ptr %elem8, align 4
  %l_293.4.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.4.1, ptr %gep94.1, align 4
  %l_296.4.1 = load i32, ptr %elem6, align 4
  %neg.4.1 = xor i32 %l_296.4.1, -1
  store i32 %neg.4.1, ptr %elem8, align 4
  %l_293.5.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.5.1, ptr %gep94.1, align 4
  %l_296.5.1 = load i32, ptr %elem6, align 4
  %neg.5.1 = xor i32 %l_296.5.1, -1
  store i32 %neg.5.1, ptr %elem8, align 4
  %l_293.6.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.6.1, ptr %gep94.1, align 4
  %l_296.6.1 = load i32, ptr %elem6, align 4
  %neg.6.1 = xor i32 %l_296.6.1, -1
  store i32 %neg.6.1, ptr %elem8, align 4
  %l_293.7.1 = load i32, ptr %gep79, align 4
  store i32 %l_293.7.1, ptr %gep94.1, align 4
  %l_296.7.1 = load i32, ptr %elem6, align 4
  %neg.7.1 = xor i32 %l_296.7.1, -1
  store i32 %neg.7.1, ptr %elem8, align 4
  %binop107.1 = add nuw nsw i32 %l_13.0123, 2
  %exitcond.not.1 = icmp eq i32 %binop107.1, 9
  br i1 %exitcond.not.1, label %while_end69, label %phiblock
}
