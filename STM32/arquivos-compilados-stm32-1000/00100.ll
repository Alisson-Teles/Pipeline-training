...
body:
  ...
  store i64 -885043386, ptr %l_2, align 8
  %elem1 = getelementptr inbounds nuw i8, ptr %l_2, i32 8
  store i64 0, ptr %elem1, align 8
  %elem2 = getelementptr inbounds nuw i8, ptr %l_2, i32 16
  store i64 3409923910, ptr %elem2, align 8
  %elem3 = getelementptr inbounds nuw i8, ptr %l_2, i32 24
  store i64 3409923910, ptr %elem3, align 8
  %elem4 = getelementptr inbounds nuw i8, ptr %l_2, i32 32
  store i64 0, ptr %elem4, align 8
  %elem5 = getelementptr inbounds nuw i8, ptr %l_2, i32 40
  store i64 3409923910, ptr %elem5, align 8
  %elem6 = getelementptr inbounds nuw i8, ptr %l_2, i32 48
  store i64 3409923910, ptr %elem6, align 8
  store i64 4294967280, ptr %l_2, align 8
  %gep164 = getelementptr inbounds nuw i8, ptr %l_2, i32 8
  %gep164.1 = getelementptr inbounds nuw i8, ptr %l_2, i32 16
  %gep164.2 = getelementptr inbounds nuw i8, ptr %l_2, i32 24
  %gep164.3 = getelementptr inbounds nuw i8, ptr %l_2, i32 32
  %gep164.4 = getelementptr inbounds nuw i8, ptr %l_2, i32 40
  %gep164.5 = getelementptr inbounds nuw i8, ptr %l_2, i32 48
  br label %while_body121

while_body121:                                    ; preds = %body, %while_end139
  %indvars.iv297 = phi i32 [ 0, %body ], [ %indvars.iv.next298, %while_end139 ]
  %gep148 = getelementptr [7 x i64], ptr %l_2, i32 0, i32 %indvars.iv297
...
while_cond140.preheader:                          ; preds = %while_body121, %if_cont
  %indvars.iv = phi i32 [ 0, %while_body121 ], [ %indvars.iv.next, %if_cont ]
  %zext167289.lcssa293294 = phi i32 [ 1504117551, %while_body121 ], [ %zext167.5, %if_cont ]
  %l_2149 = load i64, ptr %gep148, align 8
  ...
  %l_2165 = load i64, ptr %gep164, align 8
  %trunc166 = trunc i64 %l_2165 to i32
  %binop.i279 = add i32 %binop158, %trunc166
  %binop158.1 = or i32 %binop157, %binop.i279
  %l_2165.1 = load i64, ptr %gep164.1, align 8
  %trunc166.1 = trunc i64 %l_2165.1 to i32
  %binop.i279.1 = add i32 %binop158.1, %trunc166.1
  %binop158.2 = or i32 %binop157, %binop.i279.1
  %l_2165.2 = load i64, ptr %gep164.2, align 8
  %trunc166.2 = trunc i64 %l_2165.2 to i32
  %binop.i279.2 = add i32 %binop158.2, %trunc166.2
  %binop158.3 = or i32 %binop157, %binop.i279.2
  %l_2165.3 = load i64, ptr %gep164.3, align 8
  %trunc166.3 = trunc i64 %l_2165.3 to i32
  %binop.i279.3 = add i32 %binop158.3, %trunc166.3
  %binop158.4 = or i32 %binop157, %binop.i279.3
  %l_2165.4 = load i64, ptr %gep164.4, align 8
  %trunc166.4 = trunc i64 %l_2165.4 to i32
  %binop.i279.4 = add i32 %binop158.4, %trunc166.4
  %binop158.5 = or i32 %binop157, %binop.i279.4
  %l_2165.5 = load i64, ptr %gep164.5, align 8
  %trunc166.5 = trunc i64 %l_2165.5 to i32
  %binop.i279.5 = add i32 %binop158.5, %trunc166.5
  %zext167.5 = and i32 %binop.i279.5, 255
  %gep172 = getelementptr [7 x i64], ptr %l_2, i32 0, i32 %indvars.iv
  %cmpi221.not = icmp eq i32 %zext167.5, 0
  %l_2225 = load i64, ptr %l_2, align 8
  %0 = and i64 %l_2225, 1
  %cmpi227.not269 = icmp eq i64 %0, 0
...
while_end139:                                     ; preds = %if_cont
  %indvars.iv.next298 = add nuw nsw i32 %indvars.iv297, 1
  %exitcond299.not = icmp eq i32 %indvars.iv.next298, 7
  br i1 %exitcond299.not, label %while_end122, label %while_body121

if_then:                                          ; preds = %while_cond140.preheader
  %l_2173 = load i64, ptr %gep172, align 8
  %binop7.i = and i64 %l_2173, -9223372036854775808
  %1 = xor i64 %binop7.i, -3885124101
  %2 = add i64 %1, %l_2173
  %binop15.i = and i64 %2, %l_2173
  ...
  %gep234 = getelementptr [0 x i64], ptr %l_2, i32 0, i32 %indvars.iv
  store i64 %spec.select.i278, ptr %gep234, align 8
  store i64 203427846, ptr %l_2, align 8
  br label %if_cont

if_else:                                          ; preds = %while_cond140.preheader
  %binop238 = or i64 %l_2225, 3390761479
  store i64 %binop238, ptr %l_2, align 8
  %l_2243 = load i64, ptr %gep172, align 8
  %binop245 = xor i64 %l_2243, -15591
  %gep246 = getelementptr [0 x i64], ptr %l_2, i32 0, i32 %indvars.iv
  store i64 %binop245, ptr %gep246, align 8
  br label %if_cont

if_cont:                                          ; preds = %if_else, %if_then
  %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1
  %exitcond.not = icmp eq i32 %indvars.iv.next, 7
  br i1 %exitcond.not, label %while_end139, label %while_cond140.preheader
}
