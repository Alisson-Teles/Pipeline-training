...
body:
  ...
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 1
...
body:
  %l_2.sroa.0 = alloca ptr, align 4
  store i7 0, ptr %l_2.sroa.0, align 4
  %l_2.sroa.0.1.sroa_idx11 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0, i32 1
  store i2 0, ptr %l_2.sroa.0.1.sroa_idx11, align 1
  store i7 6, ptr %l_2.sroa.0, align 4
  %l_2.sroa.0.1.sroa_idx12 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0, i32 1
  ...
  %f11 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref, i32 1
...
body:
  %l_2.sroa.0.i = alloca ptr, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_2.sroa.0.i)
  store i7 0, ptr %l_2.sroa.0.i, align 4
  %l_2.sroa.0.i.1.sroa_idx = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i, i32 1
  store i2 0, ptr %l_2.sroa.0.i.1.sroa_idx, align 1
  store i7 6, ptr %l_2.sroa.0.i, align 4
  %l_2.sroa.0.i.1.sroa_idx5 = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i, i32 1
  ...
  %f11.i = getelementptr inbounds nuw i8, ptr %l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.i.0.l_2.sroa.0.0.l_2.sroa.0.0.l_2.sroa.0.0.deref.i, i32 1
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_2.sroa.0.i)
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
