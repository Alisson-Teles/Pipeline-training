; ModuleID = 'out/00470.rob'
source_filename = "out/00470.rob"
...
define range(i64 -2147483648, 2147483648) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_13 = alloca [8 x i32], align 4
  store i32 -1, ptr %l_13, align 4
  %elem1 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  store i32 1685635982, ptr %elem1, align 4
  %elem2 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  store i32 -1, ptr %elem2, align 4
  %elem3 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  store i32 -1, ptr %elem3, align 4
  %elem4 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  store i32 1685635982, ptr %elem4, align 4
  %elem5 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  store i32 -1, ptr %elem5, align 4
  %elem6 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  store i32 -1, ptr %elem6, align 4
  %elem7 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  store i32 1685635982, ptr %elem7, align 4
  store i32 227, ptr %elem6, align 4
  %gep38 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  %l_1339.peel = load i32, ptr %gep38, align 4
  %zext58.peel = and i32 %l_1339.peel, 65535
  %gep63.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  store i32 %zext58.peel, ptr %gep63.peel, align 4
  %gep38.1.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %l_1339.1.peel = load i32, ptr %gep38.1.peel, align 4
  %zext58.1.peel = and i32 %l_1339.1.peel, 65535
  %gep63.1.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  store i32 %zext58.1.peel, ptr %gep63.1.peel, align 4
  %gep38.2.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %l_1339.2.peel = load i32, ptr %gep38.2.peel, align 4
  %zext58.2.peel = and i32 %l_1339.2.peel, 65535
  %gep63.2.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  store i32 %zext58.2.peel, ptr %gep63.2.peel, align 4
  %gep38.3.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %l_1339.3.peel = load i32, ptr %gep38.3.peel, align 4
  %zext58.3.peel = and i32 %l_1339.3.peel, 65535
  %gep63.3.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  store i32 %zext58.3.peel, ptr %gep63.3.peel, align 4
  %gep38.4.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %l_1339.4.peel = load i32, ptr %gep38.4.peel, align 4
  %zext58.4.peel = and i32 %l_1339.4.peel, 65535
  %gep63.4.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  store i32 %zext58.4.peel, ptr %gep63.4.peel, align 4
  %gep38.5.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %l_1339.5.peel = load i32, ptr %gep38.5.peel, align 4
  %zext58.5.peel = and i32 %l_1339.5.peel, 65535
  %gep63.5.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  store i32 %zext58.5.peel, ptr %gep63.5.peel, align 4
  %gep38.6.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %l_1339.6.peel = load i32, ptr %gep38.6.peel, align 4
  %zext58.6.peel = and i32 %l_1339.6.peel, 65535
  %gep63.6.peel = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  store i32 %zext58.6.peel, ptr %gep63.6.peel, align 4
  %l_1369.peel = load i32, ptr %l_13, align 4
  %l_1369.peel.fr = freeze i32 %l_1369.peel
  %cmpi70.peel = icmp slt i32 %l_1369.peel.fr, 7
  %intcast84.peel = select i1 %cmpi70.peel, i32 45, i32 44
  %l_1386.peel = load i32, ptr %elem6, align 4
  %cmpi87.not.peel = icmp sgt i32 %l_1386.peel, %intcast84.peel
  %sext89.peel = select i1 %cmpi87.not.peel, i32 0, i32 512
  store i32 %sext89.peel, ptr %l_13, align 4
  %gep63 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  %gep38.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep63.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep38.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep63.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep38.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep63.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep38.4 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep63.4 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep38.5 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep63.5 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep38.6 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.6 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.1118 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  %gep38.1.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep63.1.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep38.2.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep63.2.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep38.3.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep63.3.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep38.4.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep63.4.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep38.5.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep63.5.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep38.6.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.6.1 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.2121 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  %gep38.1.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep63.1.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep38.2.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep63.2.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep38.3.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep63.3.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep38.4.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep63.4.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep38.5.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep63.5.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep38.6.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.6.2 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.3124 = getelementptr inbounds nuw i8, ptr %l_13, i32 4
  %gep38.1.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep63.1.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 8
  %gep38.2.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep63.2.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 12
  %gep38.3.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep63.3.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 16
  %gep38.4.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep63.4.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 20
  %gep38.5.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep63.5.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 24
  %gep38.6.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  %gep63.6.3 = getelementptr inbounds nuw i8, ptr %l_13, i32 28
  br label %while_cond31.preheader

while_cond31.preheader:                           ; preds = %while_cond31.preheader.3, %body
  %l_3.1114 = phi i32 [ 1, %body ], [ %binop92.3, %while_cond31.preheader.3 ]
  %l_1339 = load i32, ptr %gep38, align 4
  %zext58 = and i32 %l_1339, 65535
  store i32 %zext58, ptr %gep63, align 4
  %l_1339.1 = load i32, ptr %gep38.1, align 4
  %zext58.1 = and i32 %l_1339.1, 65535
  store i32 %zext58.1, ptr %gep63.1, align 4
  %l_1339.2 = load i32, ptr %gep38.2, align 4
  %zext58.2 = and i32 %l_1339.2, 65535
  store i32 %zext58.2, ptr %gep63.2, align 4
  %l_1339.3 = load i32, ptr %gep38.3, align 4
  %zext58.3 = and i32 %l_1339.3, 65535
  store i32 %zext58.3, ptr %gep63.3, align 4
  %l_1339.4 = load i32, ptr %gep38.4, align 4
  %zext58.4 = and i32 %l_1339.4, 65535
  store i32 %zext58.4, ptr %gep63.4, align 4
  %l_1339.5 = load i32, ptr %gep38.5, align 4
  %zext58.5 = and i32 %l_1339.5, 65535
  store i32 %zext58.5, ptr %gep63.5, align 4
  %l_1339.6 = load i32, ptr %gep38.6, align 4
  %zext58.6 = and i32 %l_1339.6, 65535
  store i32 %zext58.6, ptr %gep63.6, align 4
  %binop.i108 = zext nneg i32 %l_3.1114 to i64
  %common.ret.op.i109 = lshr i64 2188154355121277485, %binop.i108
  %common.ret.op.i109.fr = freeze i64 %common.ret.op.i109
  %trunc83 = trunc i64 %common.ret.op.i109.fr to i8
  %.not = icmp eq i8 %trunc83, -1
  %binop.i98 = select i1 %.not, i8 0, i8 %trunc83
  %intcast84 = zext i8 %binop.i98 to i32
  %l_1386 = load i32, ptr %elem6, align 4
  %cmpi87.not = icmp sgt i32 %l_1386, %intcast84
  %sext89 = select i1 %cmpi87.not, i32 0, i32 512
  %gep90 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 %l_3.1114
  store i32 %sext89, ptr %gep90, align 4
  %binop92 = add nuw nsw i32 %l_3.1114, 1
  %l_1339.1116 = load i32, ptr %gep38, align 4
  %zext58.1117 = and i32 %l_1339.1116, 65535
  store i32 %zext58.1117, ptr %gep63.1118, align 4
  %l_1339.1.1 = load i32, ptr %gep38.1.1, align 4
  %zext58.1.1 = and i32 %l_1339.1.1, 65535
  store i32 %zext58.1.1, ptr %gep63.1.1, align 4
  %l_1339.2.1 = load i32, ptr %gep38.2.1, align 4
  %zext58.2.1 = and i32 %l_1339.2.1, 65535
  store i32 %zext58.2.1, ptr %gep63.2.1, align 4
  %l_1339.3.1 = load i32, ptr %gep38.3.1, align 4
  %zext58.3.1 = and i32 %l_1339.3.1, 65535
  store i32 %zext58.3.1, ptr %gep63.3.1, align 4
  %l_1339.4.1 = load i32, ptr %gep38.4.1, align 4
  %zext58.4.1 = and i32 %l_1339.4.1, 65535
  store i32 %zext58.4.1, ptr %gep63.4.1, align 4
  %l_1339.5.1 = load i32, ptr %gep38.5.1, align 4
  %zext58.5.1 = and i32 %l_1339.5.1, 65535
  store i32 %zext58.5.1, ptr %gep63.5.1, align 4
  %l_1339.6.1 = load i32, ptr %gep38.6.1, align 4
  %zext58.6.1 = and i32 %l_1339.6.1, 65535
  store i32 %zext58.6.1, ptr %gep63.6.1, align 4
  %binop.i108.1 = zext nneg i32 %binop92 to i64
  %common.ret.op.i109.1 = lshr i64 2188154355121277485, %binop.i108.1
  %common.ret.op.i109.fr.1 = freeze i64 %common.ret.op.i109.1
  %trunc83.1 = trunc i64 %common.ret.op.i109.fr.1 to i8
  %.not.1 = icmp eq i8 %trunc83.1, -1
  %binop.i98.1 = select i1 %.not.1, i8 0, i8 %trunc83.1
  %intcast84.1 = zext i8 %binop.i98.1 to i32
  %l_1386.1 = load i32, ptr %elem6, align 4
  %cmpi87.not.1 = icmp sgt i32 %l_1386.1, %intcast84.1
  %sext89.1 = select i1 %cmpi87.not.1, i32 0, i32 512
  %gep90.1 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 %binop92
  store i32 %sext89.1, ptr %gep90.1, align 4
  %binop92.1 = add nuw nsw i32 %l_3.1114, 2
  %l_1339.2119 = load i32, ptr %gep38, align 4
  %zext58.2120 = and i32 %l_1339.2119, 65535
  store i32 %zext58.2120, ptr %gep63.2121, align 4
  %l_1339.1.2 = load i32, ptr %gep38.1.2, align 4
  %zext58.1.2 = and i32 %l_1339.1.2, 65535
  store i32 %zext58.1.2, ptr %gep63.1.2, align 4
  %l_1339.2.2 = load i32, ptr %gep38.2.2, align 4
  %zext58.2.2 = and i32 %l_1339.2.2, 65535
  store i32 %zext58.2.2, ptr %gep63.2.2, align 4
  %l_1339.3.2 = load i32, ptr %gep38.3.2, align 4
  %zext58.3.2 = and i32 %l_1339.3.2, 65535
  store i32 %zext58.3.2, ptr %gep63.3.2, align 4
  %l_1339.4.2 = load i32, ptr %gep38.4.2, align 4
  %zext58.4.2 = and i32 %l_1339.4.2, 65535
  store i32 %zext58.4.2, ptr %gep63.4.2, align 4
  %l_1339.5.2 = load i32, ptr %gep38.5.2, align 4
  %zext58.5.2 = and i32 %l_1339.5.2, 65535
  store i32 %zext58.5.2, ptr %gep63.5.2, align 4
  %l_1339.6.2 = load i32, ptr %gep38.6.2, align 4
  %zext58.6.2 = and i32 %l_1339.6.2, 65535
  store i32 %zext58.6.2, ptr %gep63.6.2, align 4
  %binop.i108.2 = zext nneg i32 %binop92.1 to i64
  %common.ret.op.i109.2 = lshr i64 2188154355121277485, %binop.i108.2
  %common.ret.op.i109.fr.2 = freeze i64 %common.ret.op.i109.2
  %trunc83.2 = trunc i64 %common.ret.op.i109.fr.2 to i8
  %.not.2 = icmp eq i8 %trunc83.2, -1
  %binop.i98.2 = select i1 %.not.2, i8 0, i8 %trunc83.2
  %intcast84.2 = zext i8 %binop.i98.2 to i32
  %l_1386.2 = load i32, ptr %elem6, align 4
  %cmpi87.not.2 = icmp sgt i32 %l_1386.2, %intcast84.2
  %sext89.2 = select i1 %cmpi87.not.2, i32 0, i32 512
  %gep90.2 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 %binop92.1
  store i32 %sext89.2, ptr %gep90.2, align 4
  %binop92.2 = add nuw nsw i32 %l_3.1114, 3
  %exitcond.not.2 = icmp eq i32 %binop92.2, 8
  br i1 %exitcond.not.2, label %while_end30, label %while_cond31.preheader.3, !llvm.loop !1

while_cond31.preheader.3:                         ; preds = %while_cond31.preheader
  %l_1339.3122 = load i32, ptr %gep38, align 4
  %zext58.3123 = and i32 %l_1339.3122, 65535
  store i32 %zext58.3123, ptr %gep63.3124, align 4
  %l_1339.1.3 = load i32, ptr %gep38.1.3, align 4
  %zext58.1.3 = and i32 %l_1339.1.3, 65535
  store i32 %zext58.1.3, ptr %gep63.1.3, align 4
  %l_1339.2.3 = load i32, ptr %gep38.2.3, align 4
  %zext58.2.3 = and i32 %l_1339.2.3, 65535
  store i32 %zext58.2.3, ptr %gep63.2.3, align 4
  %l_1339.3.3 = load i32, ptr %gep38.3.3, align 4
  %zext58.3.3 = and i32 %l_1339.3.3, 65535
  store i32 %zext58.3.3, ptr %gep63.3.3, align 4
  %l_1339.4.3 = load i32, ptr %gep38.4.3, align 4
  %zext58.4.3 = and i32 %l_1339.4.3, 65535
  store i32 %zext58.4.3, ptr %gep63.4.3, align 4
  %l_1339.5.3 = load i32, ptr %gep38.5.3, align 4
  %zext58.5.3 = and i32 %l_1339.5.3, 65535
  store i32 %zext58.5.3, ptr %gep63.5.3, align 4
  %l_1339.6.3 = load i32, ptr %gep38.6.3, align 4
  %zext58.6.3 = and i32 %l_1339.6.3, 65535
  store i32 %zext58.6.3, ptr %gep63.6.3, align 4
  %binop.i108.3 = zext nneg i32 %binop92.2 to i64
  %common.ret.op.i109.3 = lshr i64 2188154355121277485, %binop.i108.3
  %common.ret.op.i109.fr.3 = freeze i64 %common.ret.op.i109.3
  %trunc83.3 = trunc i64 %common.ret.op.i109.fr.3 to i8
  %.not.3 = icmp eq i8 %trunc83.3, -1
  %binop.i98.3 = select i1 %.not.3, i8 0, i8 %trunc83.3
  %intcast84.3 = zext i8 %binop.i98.3 to i32
  %l_1386.3 = load i32, ptr %elem6, align 4
  %cmpi87.not.3 = icmp sgt i32 %l_1386.3, %intcast84.3
  %sext89.3 = select i1 %cmpi87.not.3, i32 0, i32 512
  %gep90.3 = getelementptr [0 x i32], ptr %l_13, i32 0, i32 %binop92.2
  store i32 %sext89.3, ptr %gep90.3, align 4
  %binop92.3 = add nuw nsw i32 %l_3.1114, 4
  br label %while_cond31.preheader

while_end30:                                      ; preds = %while_cond31.preheader
  %l_1394 = load i32, ptr %elem2, align 4
  %sext95 = sext i32 %l_1394 to i64
  ret i64 %sext95
}
