...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 10), (12, 19), (20, 23), (24, 25), (26, 28)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i9 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i28 0, ptr %gepf1, align 4
  %gepf2 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i15 0, ptr %gepf2, align 2
  %gepf3 = getelementptr inbounds nuw i8, ptr %_this, i32 12
  store i30 0, ptr %gepf3, align 4
  %gepf4 = getelementptr inbounds nuw i8, ptr %_this, i32 16
  store i23 0, ptr %gepf4, align 4
  %gepf5 = getelementptr inbounds nuw i8, ptr %_this, i32 20
  store i20 0, ptr %gepf5, align 4
  %gepf6 = getelementptr inbounds nuw i8, ptr %_this, i32 24
  store i3 0, ptr %gepf6, align 1
  %gepf7 = getelementptr inbounds nuw i8, ptr %_this, i32 26
  store i10 0, ptr %gepf7, align 2
  ret void
}
...
body:
  store i26 0, ptr %_this, align 4
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 4
  store i29 0, ptr %gepf1, align 4
  ret void
}
...
body:
  %l_2 = alloca [7 x i64], align 8
  %l_72.sroa.0 = alloca i8, align 4
  %elem6 = getelementptr inbounds nuw i8, ptr %l_2, i32 48
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %l_2, i8 0, i64 56, i1 false)
  store i64 -9, ptr %l_2, align 8
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_2, i32 8
  store i64 -9, ptr %gep.1, align 8
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_2, i32 16
  store i64 -9, ptr %gep.2, align 8
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_2, i32 24
  store i64 -9, ptr %gep.3, align 8
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_2, i32 32
  store i64 -9, ptr %gep.4, align 8
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_2, i32 40
  store i64 -9, ptr %gep.5, align 8
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_2, i32 48
  store i64 -9, ptr %gep.6, align 8
  br label %while_cond242.preheader

while_cond242.preheader:                          ; preds = %if_then328.1, %body
  %l_18.0740 = phi i32 [ 0, %body ], [ %binop436.1, %if_then328.1 ]
  %gep325 = getelementptr [7 x i64], ptr %l_2, i32 0, i32 %l_18.0740
  %l_2326 = load i64, ptr %gep325, align 8
  %cmpi327.not = icmp eq i64 %l_2326, 0
  br i1 %cmpi327.not, label %common.ret, label %if_then328

if_then328:                                       ; preds = %while_cond242.preheader
  store i8 -2, ptr %l_72.sroa.0, align 4
  %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358 = load ptr, ptr %l_72.sroa.0, align 4
  %l_72.f0 = load i8, ptr %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358, align 1
  %cmpi.i604 = icmp eq i8 %l_72.f0, 0
  %exitcond751.not = icmp eq i32 %l_18.0740, 6
  br i1 %exitcond751.not, label %while_body440, label %while_cond242.preheader.1

while_cond242.preheader.1:                        ; preds = %if_then328
  %binop436 = or disjoint i32 %l_18.0740, 1
  %gep325.1 = getelementptr [7 x i64], ptr %l_2, i32 0, i32 %binop436
  %l_2326.1 = load i64, ptr %gep325.1, align 8
  %cmpi327.not.1 = icmp eq i64 %l_2326.1, 0
  br i1 %cmpi327.not.1, label %common.ret, label %if_then328.1

if_then328.1:                                     ; preds = %while_cond242.preheader.1
  store i8 -2, ptr %l_72.sroa.0, align 4
  %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358.1 = load ptr, ptr %l_72.sroa.0, align 4
  %l_72.f0.1 = load i8, ptr %l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.l_72.sroa.0.0.deref358.1, align 1
  %cmpi.i604.1 = icmp eq i8 %l_72.f0.1, 0
  %binop436.1 = add nuw nsw i32 %l_18.0740, 2
  br label %while_cond242.preheader

common.ret:                                       ; preds = %while_cond242.preheader, %while_cond242.preheader.1, %while_body440
  %common.ret.op = phi i32 [ %trunc517, %while_body440 ], [ 1073722200, %while_cond242.preheader.1 ], [ 1073722200, %while_cond242.preheader ]
  ret i32 %common.ret.op

while_body440:                                    ; preds = %if_then328
  %l_2507 = load i64, ptr %elem6, align 8
