; ModuleID = 'out/01248.rob'
source_filename = "out/01248.rob"
...
define noundef zeroext range(i64 -2147483648, 2147483648) i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_7 = alloca [10 x i32], align 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(40) %l_7, i8 0, i64 40, i1 false)
  store i32 -556367804, ptr %l_7, align 4
  %gep56.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 4
  store i32 -556367804, ptr %gep56.1, align 4
  %gep56.2 = getelementptr inbounds nuw i8, ptr %l_7, i32 8
  store i32 -556367804, ptr %gep56.2, align 4
  %gep56.3 = getelementptr inbounds nuw i8, ptr %l_7, i32 12
  store i32 -556367804, ptr %gep56.3, align 4
  %gep56.4 = getelementptr inbounds nuw i8, ptr %l_7, i32 16
  store i32 -556367804, ptr %gep56.4, align 4
  %gep56.5 = getelementptr inbounds nuw i8, ptr %l_7, i32 20
  store i32 -556367804, ptr %gep56.5, align 4
  %gep56.6 = getelementptr inbounds nuw i8, ptr %l_7, i32 24
  store i32 -556367804, ptr %gep56.6, align 4
  %gep56.7 = getelementptr inbounds nuw i8, ptr %l_7, i32 28
  store i32 -556367804, ptr %gep56.7, align 4
  %gep56.8 = getelementptr inbounds nuw i8, ptr %l_7, i32 32
  store i32 -556367804, ptr %gep56.8, align 4
  %gep56.9 = getelementptr inbounds nuw i8, ptr %l_7, i32 36
  store i32 -556367804, ptr %gep56.9, align 4
  %gep157.9 = getelementptr inbounds nuw i8, ptr %l_7, i32 36
  %gep157.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 4
  %gep157.2 = getelementptr inbounds nuw i8, ptr %l_7, i32 8
  %gep157.3 = getelementptr inbounds nuw i8, ptr %l_7, i32 12
  %gep157.4 = getelementptr inbounds nuw i8, ptr %l_7, i32 16
  %gep157.5 = getelementptr inbounds nuw i8, ptr %l_7, i32 20
  %gep157.6 = getelementptr inbounds nuw i8, ptr %l_7, i32 24
  %gep157.7 = getelementptr inbounds nuw i8, ptr %l_7, i32 28
  %gep157.8 = getelementptr inbounds nuw i8, ptr %l_7, i32 32
  %gep157.1.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 4
  %gep157.2.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 8
  %gep157.3.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 12
  %gep157.4.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 16
  %gep157.5.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 20
  %gep157.6.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 24
  %gep157.7.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 28
  %gep157.8.1 = getelementptr inbounds nuw i8, ptr %l_7, i32 32
  br label %while_cond78.preheader

while_cond78.preheader:                           ; preds = %while_cond78.preheader, %body
  %l_6.0656 = phi i32 [ 0, %body ], [ %binop177.1, %while_cond78.preheader ]
  %gep89 = getelementptr [10 x i32], ptr %l_7, i32 0, i32 %l_6.0656
  %gep166 = getelementptr [0 x i32], ptr %l_7, i32 0, i32 %l_6.0656
  store i32 0, ptr %l_7, align 4
  %l_7161 = load i32, ptr %gep89, align 4
  %binop165 = or i32 %l_7161, 1
  store i32 %binop165, ptr %gep166, align 4
  store i32 0, ptr %gep157.1, align 4
  %l_7161.1 = load i32, ptr %gep89, align 4
  %binop165.1 = or i32 %l_7161.1, 1
  store i32 %binop165.1, ptr %gep166, align 4
  store i32 0, ptr %gep157.2, align 4
  %l_7161.2 = load i32, ptr %gep89, align 4
  %binop165.2 = or i32 %l_7161.2, 1
  store i32 %binop165.2, ptr %gep166, align 4
  store i32 0, ptr %gep157.3, align 4
  %l_7161.3 = load i32, ptr %gep89, align 4
  %binop165.3 = or i32 %l_7161.3, 1
  store i32 %binop165.3, ptr %gep166, align 4
  store i32 0, ptr %gep157.4, align 4
  %l_7161.4 = load i32, ptr %gep89, align 4
  %binop165.4 = or i32 %l_7161.4, 1
  store i32 %binop165.4, ptr %gep166, align 4
  store i32 0, ptr %gep157.5, align 4
  %l_7161.5 = load i32, ptr %gep89, align 4
  %binop165.5 = or i32 %l_7161.5, 1
  store i32 %binop165.5, ptr %gep166, align 4
  store i32 0, ptr %gep157.6, align 4
  %l_7161.6 = load i32, ptr %gep89, align 4
  %binop165.6 = or i32 %l_7161.6, 1
  store i32 %binop165.6, ptr %gep166, align 4
  store i32 0, ptr %gep157.7, align 4
  %l_7161.7 = load i32, ptr %gep89, align 4
  %binop165.7 = or i32 %l_7161.7, 1
  store i32 %binop165.7, ptr %gep166, align 4
  store i32 0, ptr %gep157.8, align 4
  %l_7161.8 = load i32, ptr %gep89, align 4
  %binop165.8 = or i32 %l_7161.8, 1
  store i32 %binop165.8, ptr %gep166, align 4
  store i32 0, ptr %gep157.9, align 4
  %l_7161.9 = load i32, ptr %gep89, align 4
  %binop165.9 = or i32 %l_7161.9, 1
  store i32 %binop165.9, ptr %gep166, align 4
  %binop177 = or disjoint i32 %l_6.0656, 1
  %gep89.1 = getelementptr [10 x i32], ptr %l_7, i32 0, i32 %binop177
  %gep166.1 = getelementptr [0 x i32], ptr %l_7, i32 0, i32 %binop177
  store i32 0, ptr %l_7, align 4
  %l_7161.1657 = load i32, ptr %gep89.1, align 4
  %binop165.1658 = or i32 %l_7161.1657, 1
  store i32 %binop165.1658, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.1.1, align 4
  %l_7161.1.1 = load i32, ptr %gep89.1, align 4
  %binop165.1.1 = or i32 %l_7161.1.1, 1
  store i32 %binop165.1.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.2.1, align 4
  %l_7161.2.1 = load i32, ptr %gep89.1, align 4
  %binop165.2.1 = or i32 %l_7161.2.1, 1
  store i32 %binop165.2.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.3.1, align 4
  %l_7161.3.1 = load i32, ptr %gep89.1, align 4
  %binop165.3.1 = or i32 %l_7161.3.1, 1
  store i32 %binop165.3.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.4.1, align 4
  %l_7161.4.1 = load i32, ptr %gep89.1, align 4
  %binop165.4.1 = or i32 %l_7161.4.1, 1
  store i32 %binop165.4.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.5.1, align 4
  %l_7161.5.1 = load i32, ptr %gep89.1, align 4
  %binop165.5.1 = or i32 %l_7161.5.1, 1
  store i32 %binop165.5.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.6.1, align 4
  %l_7161.6.1 = load i32, ptr %gep89.1, align 4
  %binop165.6.1 = or i32 %l_7161.6.1, 1
  store i32 %binop165.6.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.7.1, align 4
  %l_7161.7.1 = load i32, ptr %gep89.1, align 4
  %binop165.7.1 = or i32 %l_7161.7.1, 1
  store i32 %binop165.7.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.8.1, align 4
  %l_7161.8.1 = load i32, ptr %gep89.1, align 4
  %binop165.8.1 = or i32 %l_7161.8.1, 1
  store i32 %binop165.8.1, ptr %gep166.1, align 4
  store i32 0, ptr %gep157.9, align 4
  %l_7161.9.1 = load i32, ptr %gep89.1, align 4
  %binop165.9.1 = or i32 %l_7161.9.1, 1
  store i32 %binop165.9.1, ptr %gep166.1, align 4
  %binop177.1 = add nuw nsw i32 %l_6.0656, 2
  %exitcond.not.1 = icmp eq i32 %binop177.1, 10
  br i1 %exitcond.not.1, label %while_end63, label %while_cond78.preheader

while_end63:                                      ; preds = %while_cond78.preheader
  %elem29 = getelementptr inbounds nuw i8, ptr %l_7, i32 24
  %l_7221 = load i32, ptr %elem29, align 4
  %trunc227 = or i32 %l_7221, -8
  store i32 %trunc227, ptr %elem29, align 4
  ret i64 -4
}
...
body:
  ...
  %0 = tail call zeroext addrspace(1) i64 @func_1()
