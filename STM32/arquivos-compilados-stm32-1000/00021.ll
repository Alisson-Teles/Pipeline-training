...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (4, 8)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
...
body:
  %l_74 = alloca %S0, align 4
  %l_10.sroa.0 = alloca ptr, align 4
  %l_9.sroa.0 = alloca ptr, align 4
  store i9 0, ptr %l_74, align 4
  %gepf1.i = getelementptr inbounds nuw i8, ptr %l_74, i32 4
  store i28 0, ptr %gepf1.i, align 4
  store i9 9, ptr %l_74, align 4
  store i28 11835, ptr %gepf1.i, align 4
  store i9 8, ptr %l_10.sroa.0, align 4
  store i9 7, ptr %l_9.sroa.0, align 4
  %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref = load ptr, ptr %l_9.sroa.0, align 4
  store ptr %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref, ptr %l_10.sroa.0, align 4
  store ptr %l_74, ptr %l_10.sroa.0, align 4
  store i9 8, ptr %l_10.sroa.0, align 4
  store i9 7, ptr %l_9.sroa.0, align 4
  %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.1 = load ptr, ptr %l_9.sroa.0, align 4
  store ptr %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.1, ptr %l_10.sroa.0, align 4
  store ptr %l_74, ptr %l_10.sroa.0, align 4
  store i9 8, ptr %l_10.sroa.0, align 4
  store i9 7, ptr %l_9.sroa.0, align 4
  %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.2 = load ptr, ptr %l_9.sroa.0, align 4
  store ptr %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.2, ptr %l_10.sroa.0, align 4
  store ptr %l_74, ptr %l_10.sroa.0, align 4
  store i9 8, ptr %l_10.sroa.0, align 4
  store i9 7, ptr %l_9.sroa.0, align 4
  %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.3 = load ptr, ptr %l_9.sroa.0, align 4
  store ptr %l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.l_9.sroa.0.0.deref.3, ptr %l_10.sroa.0, align 4
  store ptr %l_74, ptr %l_10.sroa.0, align 4
  store i9 8, ptr %l_10.sroa.0, align 4
  %l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.deref123.4 = load ptr, ptr %l_10.sroa.0, align 4
  %f1125.4 = getelementptr inbounds nuw i8, ptr %l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.deref123.4, i32 4
  store i28 220, ptr %f1125.4, align 4
  store ptr %l_74, ptr %l_10.sroa.0, align 4
  %deref218.fca.1.load = load i28, ptr %gepf1.i, align 4
  %deref218.fca.1.insert = insertvalue %S0 { i9 9, i28 poison }, i28 %deref218.fca.1.load, 1
  ret %S0 %deref218.fca.1.insert
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_74.i = alloca %S0, align 4
  %l_10.sroa.0.i = alloca ptr, align 4
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %l_74.i)
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_10.sroa.0.i)
  store i9 0, ptr %l_74.i, align 4
  %gepf1.i.i = getelementptr inbounds nuw i8, ptr %l_74.i, i32 4
  store i28 0, ptr %gepf1.i.i, align 4
  store i9 9, ptr %l_74.i, align 4
  store i28 11835, ptr %gepf1.i.i, align 4
  store i9 8, ptr %l_10.sroa.0.i, align 4
  store ptr %l_74.i, ptr %l_10.sroa.0.i, align 4
  store i9 8, ptr %l_10.sroa.0.i, align 4
  store ptr %l_74.i, ptr %l_10.sroa.0.i, align 4
  store i9 8, ptr %l_10.sroa.0.i, align 4
  store ptr %l_74.i, ptr %l_10.sroa.0.i, align 4
  ...
  store ptr %l_74.i, ptr %l_10.sroa.0.i, align 4
  store i9 8, ptr %l_10.sroa.0.i, align 4
  %l_10.sroa.0.i.0.l_10.sroa.0.i.0.l_10.sroa.0.i.0.l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.deref123.i.4 = load ptr, ptr %l_10.sroa.0.i, align 4
  %f1125.i.4 = getelementptr inbounds nuw i8, ptr %l_10.sroa.0.i.0.l_10.sroa.0.i.0.l_10.sroa.0.i.0.l_10.sroa.0.0.l_10.sroa.0.0.l_10.sroa.0.0.deref123.i.4, i32 4
  store i28 220, ptr %f1125.i.4, align 4
  store ptr %l_74.i, ptr %l_10.sroa.0.i, align 4
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %l_74.i)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_10.sroa.0.i)
...
attributes #3 = { nofree norecurse nosync nounwind memory(write, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
