...
safe_mul_func_int8_t_s_s.exit:                    ; preds = %fullev24.i, %fullev73.i, %if_cont.i
...
while_cond419.preheader.preheader:                ; preds = %safe_mul_func_int8_t_s_s.exit
  ...
  %gep426.3 = getelementptr inbounds nuw i8, ptr %l_26, i32 8
  ...
  %gep426.3.1 = getelementptr inbounds nuw i8, ptr %l_26, i32 8
  br label %while_cond419.preheader

common.ret:                                       ; preds = %safe_mul_func_int8_t_s_s.exit, %while_end397
...
if_then429:                                       ; preds = %while_cond419.preheader
  ...
  %l_26439 = load i64, ptr %gep426, align 8
  %binop444 = and i64 %l_26439, %1
  store i64 %binop444, ptr %elem1, align 8
  br label %if_cont475

if_cont475:                                       ; preds = %while_cond419.preheader, %if_then429
  %l_26477 = load i64, ptr %elem1, align 8
  %binop481 = or i64 %l_26477, 1
  store i64 %binop481, ptr %elem1, align 8
...
if_then429.1:                                     ; preds = %if_cont475
  store i64 255, ptr %gep435, align 8
  %l_26439.1 = load i64, ptr %gep426.1, align 8
  %binop444.1 = and i64 %l_26439.1, %1
  store i64 %binop444.1, ptr %elem1, align 8
  br label %if_cont475.1

if_cont475.1:                                     ; preds = %if_then429.1, %if_cont475
  %l_26477.1 = load i64, ptr %elem1, align 8
  %binop481.1 = or i64 %l_26477.1, 1
  store i64 %binop481.1, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
...
if_then429.2:                                     ; preds = %if_cont475.1
  store i64 255, ptr %gep435, align 8
  %l_26439.2 = load i64, ptr %gep426.2, align 8
  %binop444.2 = and i64 %l_26439.2, %1
  store i64 %binop444.2, ptr %elem1, align 8
  br label %if_cont475.2

if_cont475.2:                                     ; preds = %if_then429.2, %if_cont475.1
  %l_26477.2 = load i64, ptr %elem1, align 8
  %binop481.2 = or i64 %l_26477.2, 1
  store i64 %binop481.2, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
  store i64 255, ptr %gep435, align 8
  %l_26439.3 = load i64, ptr %gep426.3, align 8
  %binop444.3 = and i64 %l_26439.3, %1
  %binop481.3 = or i64 %binop444.3, 1
  store i64 %binop481.3, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
  store i64 255, ptr %gep435, align 8
...
if_then429.1651:                                  ; preds = %while_cond419.preheader.1
  ...
  %l_26439.1649 = load i64, ptr %gep426.1646, align 8
  %binop444.1650 = and i64 %l_26439.1649, %5
  store i64 %binop444.1650, ptr %elem1, align 8
  br label %if_cont475.1654

if_cont475.1654:                                  ; preds = %if_then429.1651, %while_cond419.preheader.1
  %l_26477.1652 = load i64, ptr %elem1, align 8
  %binop481.1653 = or i64 %l_26477.1652, 1
  store i64 %binop481.1653, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
...
if_then429.1.1:                                   ; preds = %if_cont475.1654
  store i64 255, ptr %gep435.1, align 8
  %l_26439.1.1 = load i64, ptr %gep426.1.1, align 8
  %binop444.1.1 = and i64 %l_26439.1.1, %5
  store i64 %binop444.1.1, ptr %elem1, align 8
  br label %if_cont475.1.1

if_cont475.1.1:                                   ; preds = %if_then429.1.1, %if_cont475.1654
  %l_26477.1.1 = load i64, ptr %elem1, align 8
  %binop481.1.1 = or i64 %l_26477.1.1, 1
  store i64 %binop481.1.1, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
...
if_then429.2.1:                                   ; preds = %if_cont475.1.1
  store i64 255, ptr %gep435.1, align 8
  %l_26439.2.1 = load i64, ptr %gep426.2.1, align 8
  %binop444.2.1 = and i64 %l_26439.2.1, %5
  store i64 %binop444.2.1, ptr %elem1, align 8
  br label %if_cont475.2.1

if_cont475.2.1:                                   ; preds = %if_then429.2.1, %if_cont475.1.1
  %l_26477.2.1 = load i64, ptr %elem1, align 8
  %binop481.2.1 = or i64 %l_26477.2.1, 1
  store i64 %binop481.2.1, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
  store i64 255, ptr %gep435.1, align 8
  %l_26439.3.1 = load i64, ptr %gep426.3.1, align 8
  %binop444.3.1 = and i64 %l_26439.3.1, %5
  %binop481.3.1 = or disjoint i64 %binop444.3.1, 1
  store i64 %binop481.3.1, ptr %elem1, align 8
  store i64 9223372036854775807, ptr %l_26, align 8
  store i64 255, ptr %gep435.1, align 8
