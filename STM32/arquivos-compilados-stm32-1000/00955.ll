; ModuleID = 'out/00955.rob'
source_filename = "out/00955.rob"
...
define noundef zeroext range(i32 0, 65536) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_cond

while_cond:                                       ; preds = %while_cond, %body
  %l_2.0 = phi i32 [ 0, %body ], [ %zext114.3, %while_cond ]
  %binop.i124.3 = add nuw nsw i32 %l_2.0, 65532
  %zext114.3 = and i32 %binop.i124.3, 65535
  br label %while_cond
}
