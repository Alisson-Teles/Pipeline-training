; ModuleID = 'out/00982.rob'
source_filename = "out/00982.rob"
...
define noundef i16 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_9 = alloca [8 x i32], align 4
  %elem40 = getelementptr inbounds nuw i8, ptr %l_9, i32 28
  %gep82 = getelementptr inbounds nuw i8, ptr %l_9, i32 28
  %gep82.1 = getelementptr inbounds nuw i8, ptr %l_9, i32 24
  %gep82.2 = getelementptr inbounds nuw i8, ptr %l_9, i32 20
  %gep82.3 = getelementptr inbounds nuw i8, ptr %l_9, i32 16
  %gep82.4 = getelementptr inbounds nuw i8, ptr %l_9, i32 12
  %gep82.5 = getelementptr inbounds nuw i8, ptr %l_9, i32 8
  %gep82.6 = getelementptr inbounds nuw i8, ptr %l_9, i32 4
  br label %while_body31

while_body31:                                     ; preds = %body, %while_body31
  %indvars.iv = phi i32 [ 0, %body ], [ %indvars.iv.next, %while_body31 ]
  %0 = trunc nuw nsw i32 %indvars.iv to i8
  %binop7.i = xor i8 %0, -2
  %binop10.i = and i8 %binop7.i, -128
  %1 = trunc nuw nsw i32 %indvars.iv to i8
  %binop12.i = sub i8 %binop10.i, %1
  %2 = trunc nuw nsw i32 %indvars.iv to i8
  %3 = xor i8 %binop12.i, %2
  %binop15.i = xor i8 %3, -1
  %binop18.i = and i8 %binop7.i, %binop15.i
  %cmpi.i537 = icmp slt i8 %binop18.i, 0
  %4 = shl i32 %indvars.iv, 24
  %5 = sub i32 -33554432, %4
  %6 = ashr exact i32 %5, 24
  %sext64 = select i1 %cmpi.i537, i32 -2, i32 %6
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %l_9, i8 0, i64 32, i1 false)
  store i32 %sext64, ptr %elem40, align 4
  %7 = add nuw nsw i32 %indvars.iv, 2
  %gep79 = getelementptr [8 x i32], ptr %l_9, i32 0, i32 %7
  %gep86 = getelementptr [0 x i32], ptr %l_9, i32 0, i32 %indvars.iv
  %l_980 = load i32, ptr %gep79, align 4
  %cmpi84 = icmp slt i32 %l_980, %sext64
  %zext85 = zext i1 %cmpi84 to i32
  store i32 %zext85, ptr %gep86, align 4
  %l_983.1 = load i32, ptr %gep82, align 4
  %cmpi84.1 = icmp slt i32 %l_980, %l_983.1
  %zext85.1 = zext i1 %cmpi84.1 to i32
  store i32 %zext85.1, ptr %gep86, align 4
  %l_980.2 = load i32, ptr %gep79, align 4
  %l_983.2 = load i32, ptr %gep82, align 4
  %cmpi84.2 = icmp slt i32 %l_980.2, %l_983.2
  %zext85.2 = zext i1 %cmpi84.2 to i32
  store i32 %zext85.2, ptr %gep86, align 4
  %l_983.1743 = load i32, ptr %gep82.1, align 4
  %cmpi84.1744 = icmp slt i32 %l_980.2, %l_983.1743
  %zext85.1745 = zext i1 %cmpi84.1744 to i32
  store i32 %zext85.1745, ptr %gep86, align 4
  %l_983.1.1 = load i32, ptr %gep82.1, align 4
  %cmpi84.1.1 = icmp slt i32 %l_980.2, %l_983.1.1
  %zext85.1.1 = zext i1 %cmpi84.1.1 to i32
  store i32 %zext85.1.1, ptr %gep86, align 4
  %l_980.2.1 = load i32, ptr %gep79, align 4
  %l_983.2.1 = load i32, ptr %gep82.1, align 4
  %cmpi84.2.1 = icmp slt i32 %l_980.2.1, %l_983.2.1
  %zext85.2.1 = zext i1 %cmpi84.2.1 to i32
  store i32 %zext85.2.1, ptr %gep86, align 4
  %l_983.2747 = load i32, ptr %gep82.2, align 4
  %cmpi84.2748 = icmp slt i32 %l_980.2.1, %l_983.2747
  %zext85.2749 = zext i1 %cmpi84.2748 to i32
  store i32 %zext85.2749, ptr %gep86, align 4
  %l_983.1.2 = load i32, ptr %gep82.2, align 4
  %cmpi84.1.2 = icmp slt i32 %l_980.2.1, %l_983.1.2
  %zext85.1.2 = zext i1 %cmpi84.1.2 to i32
  store i32 %zext85.1.2, ptr %gep86, align 4
  %l_980.2.2 = load i32, ptr %gep79, align 4
  %l_983.2.2 = load i32, ptr %gep82.2, align 4
  %cmpi84.2.2 = icmp slt i32 %l_980.2.2, %l_983.2.2
  %zext85.2.2 = zext i1 %cmpi84.2.2 to i32
  store i32 %zext85.2.2, ptr %gep86, align 4
  %l_983.3 = load i32, ptr %gep82.3, align 4
  %cmpi84.3 = icmp slt i32 %l_980.2.2, %l_983.3
  %zext85.3 = zext i1 %cmpi84.3 to i32
  store i32 %zext85.3, ptr %gep86, align 4
  %l_983.1.3 = load i32, ptr %gep82.3, align 4
  %cmpi84.1.3 = icmp slt i32 %l_980.2.2, %l_983.1.3
  %zext85.1.3 = zext i1 %cmpi84.1.3 to i32
  store i32 %zext85.1.3, ptr %gep86, align 4
  %l_980.2.3 = load i32, ptr %gep79, align 4
  %l_983.2.3 = load i32, ptr %gep82.3, align 4
  %cmpi84.2.3 = icmp slt i32 %l_980.2.3, %l_983.2.3
  %zext85.2.3 = zext i1 %cmpi84.2.3 to i32
  store i32 %zext85.2.3, ptr %gep86, align 4
  %l_983.4 = load i32, ptr %gep82.4, align 4
  %cmpi84.4 = icmp slt i32 %l_980.2.3, %l_983.4
  %zext85.4 = zext i1 %cmpi84.4 to i32
  store i32 %zext85.4, ptr %gep86, align 4
  %l_983.1.4 = load i32, ptr %gep82.4, align 4
  %cmpi84.1.4 = icmp slt i32 %l_980.2.3, %l_983.1.4
  %zext85.1.4 = zext i1 %cmpi84.1.4 to i32
  store i32 %zext85.1.4, ptr %gep86, align 4
  %l_980.2.4 = load i32, ptr %gep79, align 4
  %l_983.2.4 = load i32, ptr %gep82.4, align 4
  %cmpi84.2.4 = icmp slt i32 %l_980.2.4, %l_983.2.4
  %zext85.2.4 = zext i1 %cmpi84.2.4 to i32
  store i32 %zext85.2.4, ptr %gep86, align 4
  %l_983.5 = load i32, ptr %gep82.5, align 4
  %cmpi84.5 = icmp slt i32 %l_980.2.4, %l_983.5
  %zext85.5 = zext i1 %cmpi84.5 to i32
  store i32 %zext85.5, ptr %gep86, align 4
  %l_983.1.5 = load i32, ptr %gep82.5, align 4
  %cmpi84.1.5 = icmp slt i32 %l_980.2.4, %l_983.1.5
  %zext85.1.5 = zext i1 %cmpi84.1.5 to i32
  store i32 %zext85.1.5, ptr %gep86, align 4
  %l_980.2.5 = load i32, ptr %gep79, align 4
  %l_983.2.5 = load i32, ptr %gep82.5, align 4
  %cmpi84.2.5 = icmp slt i32 %l_980.2.5, %l_983.2.5
  %zext85.2.5 = zext i1 %cmpi84.2.5 to i32
  store i32 %zext85.2.5, ptr %gep86, align 4
  %l_983.6 = load i32, ptr %gep82.6, align 4
  %cmpi84.6 = icmp slt i32 %l_980.2.5, %l_983.6
  %zext85.6 = zext i1 %cmpi84.6 to i32
  store i32 %zext85.6, ptr %gep86, align 4
  %l_983.1.6 = load i32, ptr %gep82.6, align 4
  %cmpi84.1.6 = icmp slt i32 %l_980.2.5, %l_983.1.6
  %zext85.1.6 = zext i1 %cmpi84.1.6 to i32
  store i32 %zext85.1.6, ptr %gep86, align 4
  %l_980.2.6 = load i32, ptr %gep79, align 4
  %l_983.2.6 = load i32, ptr %gep82.6, align 4
  %cmpi84.2.6 = icmp slt i32 %l_980.2.6, %l_983.2.6
  %zext85.2.6 = zext i1 %cmpi84.2.6 to i32
  store i32 %zext85.2.6, ptr %gep86, align 4
  %l_983.7 = load i32, ptr %l_9, align 4
  %cmpi84.7 = icmp slt i32 %l_980.2.6, %l_983.7
  %zext85.7 = zext i1 %cmpi84.7 to i32
  store i32 %zext85.7, ptr %gep86, align 4
  %l_983.1.7 = load i32, ptr %l_9, align 4
  %cmpi84.1.7 = icmp slt i32 %l_980.2.6, %l_983.1.7
  %zext85.1.7 = zext i1 %cmpi84.1.7 to i32
  store i32 %zext85.1.7, ptr %gep86, align 4
  %l_980.2.7 = load i32, ptr %gep79, align 4
  %l_983.2.7 = load i32, ptr %l_9, align 4
  %cmpi84.2.7 = icmp slt i32 %l_980.2.7, %l_983.2.7
  %zext85.2.7 = zext i1 %cmpi84.2.7 to i32
  store i32 %zext85.2.7, ptr %gep86, align 4
  %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1
  %exitcond.not = icmp eq i32 %indvars.iv.next, 3
  br i1 %exitcond.not, label %while_body513, label %while_body31

while_body513:                                    ; preds = %while_body31
  ret i16 0
}
...
body:
  ...
  %0 = tail call addrspace(1) i16 @func_1()
