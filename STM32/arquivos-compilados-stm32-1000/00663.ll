; ModuleID = 'out/00663.rob'
source_filename = "out/00663.rob"
...
define noundef zeroext i64 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  %l_5 = alloca [7 x i32], align 4
  %elem4 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(28) %l_5, i8 0, i64 28, i1 false)
  store i32 -10, ptr %l_5, align 4
  %gep.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 4
  store i32 -10, ptr %gep.1, align 4
  %gep.2 = getelementptr inbounds nuw i8, ptr %l_5, i32 8
  store i32 -10, ptr %gep.2, align 4
  %gep.3 = getelementptr inbounds nuw i8, ptr %l_5, i32 12
  store i32 -10, ptr %gep.3, align 4
  %gep.4 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  store i32 -10, ptr %gep.4, align 4
  %gep.5 = getelementptr inbounds nuw i8, ptr %l_5, i32 20
  store i32 -10, ptr %gep.5, align 4
  %gep.6 = getelementptr inbounds nuw i8, ptr %l_5, i32 24
  store i32 -10, ptr %gep.6, align 4
  %gep82 = getelementptr inbounds nuw i8, ptr %l_5, i32 20
  %gep82.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  %gep82.2 = getelementptr inbounds nuw i8, ptr %l_5, i32 12
  %gep82.3 = getelementptr inbounds nuw i8, ptr %l_5, i32 8
  %l_5120416 = load i32, ptr %l_5, align 4
  %gep119.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 4
  %l_5120.1417 = load i32, ptr %gep119.1, align 4
  %gep119.6 = getelementptr inbounds nuw i8, ptr %l_5, i32 24
  %l_5120.6421 = load i32, ptr %gep119.6, align 4
  %gep82.1423 = getelementptr inbounds nuw i8, ptr %l_5, i32 20
  %gep82.1.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  %gep82.2.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 12
  %gep82.3.1 = getelementptr inbounds nuw i8, ptr %l_5, i32 8
  %gep82.2426 = getelementptr inbounds nuw i8, ptr %l_5, i32 20
  %gep82.1.2 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  %gep82.2.2 = getelementptr inbounds nuw i8, ptr %l_5, i32 12
  %gep82.3.2 = getelementptr inbounds nuw i8, ptr %l_5, i32 8
  %gep82.3429 = getelementptr inbounds nuw i8, ptr %l_5, i32 20
  %gep82.1.3 = getelementptr inbounds nuw i8, ptr %l_5, i32 16
  %gep82.2.3 = getelementptr inbounds nuw i8, ptr %l_5, i32 12
  %gep82.3.3 = getelementptr inbounds nuw i8, ptr %l_5, i32 8
  br label %phiblock

phiblock:                                         ; preds = %phiblock.3, %body
  %l_3.0413 = phi i64 [ 0, %body ], [ %binop158.3, %phiblock.3 ]
  %0 = trunc nuw i64 %l_3.0413 to i32
  %gep69 = getelementptr [7 x i32], ptr %l_5, i32 0, i32 %0
  %l_581 = load i32, ptr %gep69, align 4
  store i32 %l_581, ptr %gep82, align 4
  %l_586 = load i32, ptr %gep69, align 4
  store i32 %l_586, ptr %gep82, align 4
  %l_581.1 = load i32, ptr %gep69, align 4
  store i32 %l_581.1, ptr %gep82.1, align 4
  %l_586.1 = load i32, ptr %gep69, align 4
  store i32 %l_586.1, ptr %gep82.1, align 4
  %l_581.2 = load i32, ptr %gep69, align 4
  store i32 %l_581.2, ptr %gep82.2, align 4
  %l_586.2 = load i32, ptr %gep69, align 4
  store i32 %l_586.2, ptr %gep82.2, align 4
  %l_581.3 = load i32, ptr %gep69, align 4
  store i32 %l_581.3, ptr %gep82.3, align 4
  %l_586.3 = load i32, ptr %gep69, align 4
  store i32 %l_586.3, ptr %gep82.3, align 4
  store i32 %l_5120416, ptr %elem4, align 4
  store i32 %l_5120.1417, ptr %elem4, align 4
  store i32 %l_586.3, ptr %elem4, align 4
  store i32 %l_586.2, ptr %elem4, align 4
  store i32 %l_586, ptr %elem4, align 4
  store i32 %l_5120.6421, ptr %elem4, align 4
  %1 = trunc i64 %l_3.0413 to i32
  %2 = or disjoint i32 %1, 1
  %gep69.1 = getelementptr [7 x i32], ptr %l_5, i32 0, i32 %2
  %l_581.1422 = load i32, ptr %gep69.1, align 4
  store i32 %l_581.1422, ptr %gep82.1423, align 4
  %l_586.1424 = load i32, ptr %gep69.1, align 4
  store i32 %l_586.1424, ptr %gep82.1423, align 4
  %l_581.1.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_581.1.1, ptr %gep82.1.1, align 4
  %l_586.1.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_586.1.1, ptr %gep82.1.1, align 4
  %l_581.2.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_581.2.1, ptr %gep82.2.1, align 4
  %l_586.2.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_586.2.1, ptr %gep82.2.1, align 4
  %l_581.3.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_581.3.1, ptr %gep82.3.1, align 4
  %l_586.3.1 = load i32, ptr %gep69.1, align 4
  store i32 %l_586.3.1, ptr %gep82.3.1, align 4
  store i32 %l_5120.6421, ptr %elem4, align 4
  %binop158.1 = or disjoint i64 %l_3.0413, 2
  %3 = trunc nuw i64 %binop158.1 to i32
  %gep69.2 = getelementptr [7 x i32], ptr %l_5, i32 0, i32 %3
  %l_581.2425 = load i32, ptr %gep69.2, align 4
  store i32 %l_581.2425, ptr %gep82.2426, align 4
  %l_586.2427 = load i32, ptr %gep69.2, align 4
  store i32 %l_586.2427, ptr %gep82.2426, align 4
  %l_581.1.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_581.1.2, ptr %gep82.1.2, align 4
  %l_586.1.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_586.1.2, ptr %gep82.1.2, align 4
  %l_581.2.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_581.2.2, ptr %gep82.2.2, align 4
  %l_586.2.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_586.2.2, ptr %gep82.2.2, align 4
  %l_581.3.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_581.3.2, ptr %gep82.3.2, align 4
  %l_586.3.2 = load i32, ptr %gep69.2, align 4
  store i32 %l_586.3.2, ptr %gep82.3.2, align 4
  store i32 %l_5120.6421, ptr %elem4, align 4
  %cmpi54.2 = icmp samesign ult i64 %binop158.1, 6
  br i1 %cmpi54.2, label %phiblock.3, label %if_cont370

phiblock.3:                                       ; preds = %phiblock
  %4 = trunc nuw i64 %l_3.0413 to i32
  %5 = or disjoint i32 %4, 3
  %gep69.3 = getelementptr [7 x i32], ptr %l_5, i32 0, i32 %5
  %l_581.3428 = load i32, ptr %gep69.3, align 4
  store i32 %l_581.3428, ptr %gep82.3429, align 4
  %l_586.3430 = load i32, ptr %gep69.3, align 4
  store i32 %l_586.3430, ptr %gep82.3429, align 4
  %l_581.1.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_581.1.3, ptr %gep82.1.3, align 4
  %l_586.1.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_586.1.3, ptr %gep82.1.3, align 4
  %l_581.2.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_581.2.3, ptr %gep82.2.3, align 4
  %l_586.2.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_586.2.3, ptr %gep82.2.3, align 4
  %l_581.3.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_581.3.3, ptr %gep82.3.3, align 4
  %l_586.3.3 = load i32, ptr %gep69.3, align 4
  store i32 %l_586.3.3, ptr %gep82.3.3, align 4
  store i32 %l_5120.6421, ptr %elem4, align 4
  %binop158.3 = add nuw nsw i64 %l_3.0413, 4
  br label %phiblock

if_cont370:                                       ; preds = %phiblock
  ret i64 1
}
