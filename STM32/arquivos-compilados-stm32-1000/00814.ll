; ModuleID = 'out/00814.rob'
source_filename = "out/00814.rob"
...
define noundef range(i32 -32768, 65536) i32 @func_1() local_unnamed_addr addrspace(1) #2 {
body:
  br label %while_cond41

while_cond41:                                     ; preds = %while_cond41, %body
  %l_5.0 = phi i32 [ -24, %body ], [ %zext319.3, %while_cond41 ]
  %binop.i782.3 = add nsw i32 %l_5.0, 65508
  %zext319.3 = and i32 %binop.i782.3, 65535
  br label %while_cond41
}

; Function Attrs: noreturn
define noundef i32 @main() local_unnamed_addr addrspace(1) #3 {
body:
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  br label %while_cond41.i

while_cond41.i:                                   ; preds = %while_cond41.i, %body
  br label %while_cond41.i
}
...
attributes #2 = { nofree norecurse noreturn nosync nounwind memory(none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
attributes #3 = { noreturn "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
