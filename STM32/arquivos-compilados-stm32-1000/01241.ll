; ModuleID = 'out/01241.rob'
source_filename = "out/01241.rob"
...
define void @"S0:init"(ptr nocapture writeonly initializes((0, 2), (8, 16)) %_this) local_unnamed_addr addrspace(1) #0 {
body:
  store i11 0, ptr %_this, align 2
  %gepf1 = getelementptr inbounds nuw i8, ptr %_this, i32 8
  store i64 0, ptr %gepf1, align 8
  ret void
}
...
define noundef i8 @func_1() local_unnamed_addr addrspace(1) #3 {
body:
  %l_14.sroa.0 = alloca ptr, align 8
  %inlineArrayElems = alloca [2 x %S0], align 8
  store i11 30, ptr %l_14.sroa.0, align 8
  %l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.deref = load ptr, ptr %l_14.sroa.0, align 8
  %f136 = getelementptr inbounds nuw i8, ptr %l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.deref, i32 8
  store i64 5, ptr %f136, align 8
  store i11 0, ptr %inlineArrayElems, align 8
  %gepf1.i270 = getelementptr inbounds nuw i8, ptr %inlineArrayElems, i32 8
  store i64 0, ptr %gepf1.i270, align 8
  %ctorElem132 = getelementptr inbounds nuw i8, ptr %inlineArrayElems, i32 16
  store i11 0, ptr %ctorElem132, align 8
  %gepf1.i271 = getelementptr inbounds nuw i8, ptr %inlineArrayElems, i32 24
  store i64 0, ptr %gepf1.i271, align 8
  %l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.promoted = load ptr, ptr %l_14.sroa.0, align 8
  store i11 1, ptr %l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.promoted, align 2
  store i11 0, ptr %ctorElem132, align 8
  store ptr %ctorElem132, ptr %l_14.sroa.0, align 8
  store i11 736, ptr %ctorElem132, align 8
  ret i8 9
}

define noundef i32 @main() local_unnamed_addr addrspace(1) #1 {
body:
  %l_14.sroa.0.i = alloca ptr, align 8
  %inlineArrayElems.i = alloca [2 x %S0], align 8
  tail call addrspace(1) void @platform_main_begin()
  tail call addrspace(1) void @crc32_gentab()
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %l_14.sroa.0.i)
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %inlineArrayElems.i)
  store i11 30, ptr %l_14.sroa.0.i, align 8
  %l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.deref.i = load ptr, ptr %l_14.sroa.0.i, align 8
  %f136.i = getelementptr inbounds nuw i8, ptr %l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.deref.i, i32 8
  store i64 5, ptr %f136.i, align 8
  store i11 0, ptr %inlineArrayElems.i, align 8
  %gepf1.i270.i = getelementptr inbounds nuw i8, ptr %inlineArrayElems.i, i32 8
  store i64 0, ptr %gepf1.i270.i, align 8
  %ctorElem132.i = getelementptr inbounds nuw i8, ptr %inlineArrayElems.i, i32 16
  store i11 0, ptr %ctorElem132.i, align 8
  %gepf1.i271.i = getelementptr inbounds nuw i8, ptr %inlineArrayElems.i, i32 24
  store i64 0, ptr %gepf1.i271.i, align 8
  store i11 1, ptr %l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.i.0.l_14.sroa.0.0.l_14.sroa.0.0.l_14.sroa.0.0.deref.i, align 2
  store i11 0, ptr %ctorElem132.i, align 8
  store ptr %ctorElem132.i, ptr %l_14.sroa.0.i, align 8
  store i11 736, ptr %ctorElem132.i, align 8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %l_14.sroa.0.i)
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %inlineArrayElems.i)
...
attributes #3 = { mustprogress nofree norecurse nosync nounwind willreturn memory(write, inaccessiblemem: none) "frame-pointer"="all" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m3" }
